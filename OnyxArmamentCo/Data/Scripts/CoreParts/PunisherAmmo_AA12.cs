...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef AryxBurstAmmoWC => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "70mmPunisherMag", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "AP 70mm", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            BaseDamage = 8500f, // Direct damage; one steel plate is worth 100.
            Mass = 10f, // In kilograms; how much force the impact will apply to the target.
            Health = 0, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 25f, // Recoil. This is applied to the Parent Grid.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                SpeedVariance = Random(start: 0, end: 5), // subtracts value from DesiredSpeed. Be warned, you can make your projectile go backwards.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ColorVariance = Random(start: 0f, end: 20f), // multiply the color by random values within range.
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 12f, //
                        Width = 0.25f, //
                        Color = Color(red: 25, green: 10f, blue: 1f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 5, green: 5, blue: 7, alpha: 1),
                        Back = false,
                        CustomWidth = 0.2f,
