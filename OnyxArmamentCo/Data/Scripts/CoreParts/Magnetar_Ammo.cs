...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef AryxMagnetarAmmo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "AryxMagnetarAmmoMag", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
        ...
        private AmmoDef AryxMagnetarAmmoOverload => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "BadMagnetarAmmoMag", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
