    ...
    partial class Parts {
        ...
        WeaponDefinition AryxRailgun => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXRailgun", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Artemis Railgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                AryxRailgunAmmo, AryxRailgunAmmoFrag,
                AryxRailgunAmmo_Mag,
                AryxRailgunAmmoFrag_Mag,
                AryxRailgunAmmo_Mag_Ping,// Must list all primary, shrapnel, and pattern ammos.
            },
