    ...
    partial class Parts {
        ...
        WeaponDefinition AryxGaussCannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXGaussCannon", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "emitter_3", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            {
                PartName = "Ares Superheavy Gauss Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RateOfFire = 36, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "AresRailcannonShotSound", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "AresRailcannonReloadSound", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
            ...
            Ammos = new[] {
                AryxGaussAmmoWC,
                AryxGaussAmmoBONK,
                AryxGaussAmmoDamage, // Must list all primary, shrapnel, and pattern ammos.
            },
