...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxPlasmaCannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXPlasmaPulser", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Helios Plasma Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RateOfFire = 260, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
            ...
            Ammos = new[] {
                ...
                Helios_Zap_Plasma_Stage1,
                Helios_Zap_Plasma_Stage2,
                Helios_Zap_Plasma_Stage3,
                Helios_Zap_Plasma_Stage4,
                AryxPlasmaCannonAmmoWC,
                AryxPlasmaCannonAmmoWC_Stage2,
                AryxPlasmaCannonAmmoWC_Stage3,
                AryxPlasmaCannonAmmoWC_Stage4,
