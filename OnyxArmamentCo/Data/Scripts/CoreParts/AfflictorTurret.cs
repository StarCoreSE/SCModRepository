...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SC_AR_Afflictor => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        ...
                        ElevationPartId = "afflictorbarrels",// Your Elevating Subpart, that bit that moves up
                        DurabilityMod = 0.25f, // GeneralDamageMultiplier, 0.25f = 25% damage taken.
                        IconName = "TestIcon.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },
                  new MountPointDef {
                        SubtypeId = "SC_AR_AfflictorSlanted", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "afflictorbarrels", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "afflictortop", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "afflictorbarrels",// Your Elevating Subpart, that bit that moves up
            ...
            {
                PartName = "Afflictor Burst Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
