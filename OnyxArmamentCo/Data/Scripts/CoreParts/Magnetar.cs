...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxMagnetarTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXMagnetarCannon", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Magnetar", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "ArcWepShipARYXMagnetar_Fire", // Audio for firing.
