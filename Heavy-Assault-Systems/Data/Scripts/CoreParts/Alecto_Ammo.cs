...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef HAS_Alecto_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "AlectoAmmoMag", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Alecto Beam", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                AmmoRound = "Alecto Beam2", // AmmoRound field of the ammo to spawn.
                Fragments = 1, // Number of projectiles to spawn.
                Degrees = 0, // Cone in which to randomize direction of spawned projectiles.
                Reverse = false, // Spawn projectiles backward instead of forward.
                DropVelocity = false, // fragments will not inherit velocity from parent.
                Offset = -120f, // Offsets the fragment spawn by this amount, in meters (positive forward, negative for backwards), value is read from parent ammo type.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                {
                    Modifier = 11f, // Multiplier for damage against shields.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 5, green: 2, blue: 50, alpha: 1),
                        Back = false,
                        CustomWidth = 0,
        ...
        private AmmoDef HAS_Alecto_Stage2_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Alecto Beam2", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
