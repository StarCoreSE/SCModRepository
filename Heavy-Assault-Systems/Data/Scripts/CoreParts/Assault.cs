...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HAS_Assault => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "HAS_Assault", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Assault", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                HAS_Assault_Ammo,  // Must list all primary, shrapnel, and pattern ammos.
            },
