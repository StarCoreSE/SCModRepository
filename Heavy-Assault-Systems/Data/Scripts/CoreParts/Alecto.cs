...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HAS_Alecto => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "HAS_Alecto", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Alecto", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    ShotsInBurst = 45, // Use this if you don't want the weapon to fire an entire physical magazine in one go. Should not be more than your magazine capacity.
                ...
                {
                    PreFiringSound = "HAS_Thanatos_Charge", // Audio for warmup effect.
                    FiringSound = "HAS_Assault_ReleaseLow", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    Effect1 = new ParticleDef
                    {
                        ...
                        Offset = Vector(x: 0, y: -1, z: -5), // Offsets the effect from the muzzle empty.
            ...
            Ammos = new[] {
                HAS_Alecto_Ammo,
                HAS_Alecto_Stage2_Ammo,// Must list all primary, shrapnel, and pattern ammos.
            },
