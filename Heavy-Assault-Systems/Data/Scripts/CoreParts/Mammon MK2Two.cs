...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HAS_MammonMK22 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                ...
                Muzzles = new[] {
                    "MammonBarrel2", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "MammonBarrel2", // Where line of sight checks are performed from. Must be clear of block collision.
            },
