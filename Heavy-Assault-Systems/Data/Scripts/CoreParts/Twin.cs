...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HAS_Twin => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "HAS_Twin", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "muzzle_01",
                    "muzzle_02", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "muzzle_1", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "Twin Hex Artillery", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                HAS_Twin_Ammo,
                HAS_Twin_Stage2_Ammo,// Must list all primary, shrapnel, and pattern ammos.
            },
