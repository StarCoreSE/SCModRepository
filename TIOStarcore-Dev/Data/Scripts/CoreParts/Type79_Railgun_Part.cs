...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Type79_Railgun_Block => new WeaponDefinition
        {
            ...
            {
                Threats = new[] {
                    Grids, Meteors, // Types of threat to engage: Grids, Projectiles, Characters, Meteors, Neutrals, ScanRoid, ScanPlanet, ScanFriendlyCharacter, ScanFriendlyGrid, ScanEnemyCharacter, ScanEnemyGrid, ScanNeutralCharacter, ScanNeutralGrid, ScanUnOwnedGrid, ScanOwnersGrid
                },
                SubSystems = new[] {
            ...
            {
                PartName = "Type 79 Railgun Turret", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 9.6f, // Inventory capacity in kL.
                ...
                {
                    RateOfFire = 24, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                    ...
                    DelayUntilFire = 110, // How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
            ...
            Animations = Type79Railgun_AdvancedAnimation,
