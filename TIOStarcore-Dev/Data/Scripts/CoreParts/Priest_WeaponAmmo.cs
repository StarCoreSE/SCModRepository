...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Priest_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Priest_MagazineLarge", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Priest_Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = true,
                    ParticleScale = 1,
                    CustomParticle = "Iron_Maiden_Muzzle_Flash_MediumCalibre", // Particle SubtypeID, from your Particle SBC
