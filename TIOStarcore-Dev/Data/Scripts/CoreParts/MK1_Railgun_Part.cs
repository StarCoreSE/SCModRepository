...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition MK1Railgun_Block => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "MK1Railgun_Block", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Type 18 Railgun Turret", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
