...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition MK2_Railgun_Block => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "MK2_Railgun_Block", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Type 21 Heavy Railgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 2.2f, // Inventory capacity in kL.
                    IdlePower = 7.5f, // Constant base power draw in MW.
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 430, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
