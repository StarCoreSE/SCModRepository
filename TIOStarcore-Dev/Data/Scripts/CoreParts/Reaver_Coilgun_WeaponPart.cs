...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Reaver_Coilgun_Block => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Reaver_Coilgun_Block", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Reaver Coilgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "CoilGunFiring", // Audio for firing.
