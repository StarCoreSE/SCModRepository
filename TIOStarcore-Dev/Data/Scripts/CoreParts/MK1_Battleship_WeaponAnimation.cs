...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AnimationDef MK1BattleshipGun_AdvancedAnimation => new AnimationDef
        {
            /*
            Emissives = new[]
            {
            ...
            */
            ...
            AnimationSets = new[]
            {
                ...
                {
                    SubpartId = Names("MK1BattleshipBarrel"),
                    BarrelId = "muzzle_projectile_1.002", //only used for firing events, use "Any" for all muzzles, muzzle triggers only this animation if not Any
