...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Depleted_Uranium_Slugs_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "CoilgunMk2_MagazineLarge", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Reaver Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            BackKickForce = 20f, // Recoil. This is applied to the Parent Grid.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 1800, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). Please have a value for this, It stops Bad things.
                ...
                // Note: if your not using approaches, you should delete this entry
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 4f, //
                        Width = 0.1f, //
                        Color = Color(red: 8, green: 72, blue: 56, alpha: 6), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 2, green: 20, blue: 60, alpha: 5),
                        FactionColor = DontUse, // DontUse, Foreground, Background.
                        Back = false,
                        CustomWidth = 0f,
            ...
            AmmoAudio = new AmmoAudioDef
            {
                ...
                PlayerHitSound = "MaidenHitSound",
                VoxelHitSound = "MaidenHitSound",
                FloatingHitSound = "",
                HitPlayChance = 0.5f,
                HitPlayShield = true,
            },
