...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition DualPulseLaserTurret => new WeaponDefinition
        {
            ...
            {
                PartName = "Pulse Laser Turret", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    PreFiringSound = "coilgunsound", // Audio for warmup effect.
                    FiringSound = "coilgunsound2", // Audio for firing.
            ...
            Ammos = new[] {
                RedLaser,GreenLaser,YellowLaser, 
