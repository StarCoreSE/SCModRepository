...
namespace Scripts
{
    partial class Parts
    {
        private AmmoDef RedLaser => new AmmoDef //Longest range, lowest dmg.
        {
            AmmoMagazine = "Energy",
            AmmoRound = "Scorch",
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 10f,
                        Width = .4f,
                        Color = Color(red: 25, green: 3f, blue: 3, alpha: 1f),
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 50,
                        Color = Color(red: 55, green: 15f, blue: 15, alpha: 1f),
                        Back = true,
                        CustomWidth = 0,
        ...
        private AmmoDef YellowLaser => new AmmoDef //Longest range, lowest dmg.
        {
            AmmoMagazine = "Energy",
            AmmoRound = "Multi-Frequency",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
        ...
        private AmmoDef GreenLaser => new AmmoDef //Longest range, lowest dmg.
        {
            AmmoMagazine = "Energy",
            AmmoRound = "Microwave",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 10f,
                        Width = .4f,
                        Color = Color(red: 3, green: 25f, blue: 3, alpha: 1f),
                        VisualFadeStart = 1000, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 600, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "WeaponLaser",
                        },
                        TextureMode = Normal, // Normal, Cycle, Chaos, Wave
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 50,
                        Color = Color(red: 15, green: 55f, blue: 15, alpha: 1f),
                        Back = true,
                        CustomWidth = 0,
                        UseWidthVariance = true,
                        UseColorFade = true,
