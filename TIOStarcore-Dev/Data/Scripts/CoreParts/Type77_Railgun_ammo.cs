...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Type77_Railgun_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Type77_Railgun_MagazineLarge", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Type77 Round", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Armor = new ArmorDef
                {
                    ...
                    Heavy = 1.65f, // Multiplier for damage against heavy armor.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    Damage = 12500f,
                    Depth = 3.1f, // Max depth of AOE effect, in meters. 0=disabled, and AOE effect will reach to a depth of the radius value
                    MaxAbsorb = 0f, // Soft cutoff for damage, except for pooled falloff.  If pooled falloff, limits max damage per block.
                    ...
                    NoSound = false,
                    ParticleScale = 1,
                    CustomParticle = "Avalanche_Explosion", // Particle SubtypeID, from your Particle SBC
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 500, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). time begins at 0 and time must EXCEED this value to trigger "time > maxValue". Please have a value for this, It stops Bad things.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 48f, //
                        Width = 0.45f, //
                        Color = Color(red: 24f, green: 16f, blue: 24f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
            ...
            Ejection = new EjectionDef // Optional Component, allows generation of Particle or Item (Typically magazine), on firing, to simulate Tank shell ejection
            {
                ...
                {
                    ItemName = "AmmoCasing", //InventoryComponent name
