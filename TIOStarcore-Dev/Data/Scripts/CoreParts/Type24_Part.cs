...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Type24_Artillery_Block => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Type24_Artillery_Block", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "Mk3_Barrels", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "Mk3_AZ", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "Mk3_Elevation",// Your Elevating Subpart, that bit that moves up.
            ...
            {
                PartName = "Type 24 Heavy Turret", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 580, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
            ...
            Ammos = new[] {
                Type24_Artillery_Ammo, 
                 // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = Type24_Artillery_AdvancedAnimation,
