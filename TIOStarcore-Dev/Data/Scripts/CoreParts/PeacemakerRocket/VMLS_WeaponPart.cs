...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HeavyFixedRockets => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Fixed_Rockets", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Heavy Bombardment Rockets", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0.80f, // Projectile inaccuracy in degrees.
            ...
            Ammos = new[] {
                UnguidedHeavyRockets,
                // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = VMLSAdvancedAnimation,
