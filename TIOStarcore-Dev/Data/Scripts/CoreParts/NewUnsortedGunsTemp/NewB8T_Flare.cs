...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition B8T_Flare => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "B8T_Flare", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Flares", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Other = new OtherDef
                {
                    ...
                    RestrictionRadius = 35, // Prevents other blocks of this type from being placed within this distance of the centre of the block.
                    CheckInflatedBox = false, // If true, the above distance check is performed from the edge of the block instead of the centre.
                    CheckForAnyWeapon = false, // If true, the check will fail if ANY weapon is present, not just weapons of the same subtype.
                },
                Loading = new LoadingDef
                {
                    RateOfFire = 606, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                    BarrelsPerShot = 10, // How many muzzles will fire a projectile per fire event.
            ...
            Ammos = new[] {
                ...
                Starcore_Flare_Launch,
                Starcore_Flare_Acceleration,
                Starcore_Flare_Detonation// Must list all primary, shrapnel, and pattern ammos.
            },
