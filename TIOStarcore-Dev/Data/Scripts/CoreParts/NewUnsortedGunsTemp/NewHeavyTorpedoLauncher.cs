...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HeavyLanceBattery => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "HeavyLanceBattery", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "heavytorpelev", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "heavytorpazim", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "heavytorpelev",// Your Elevating Subpart, that bit that moves up.
            ...
            {
                PartName = "Quad-Barrel Artillery", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Other = new OtherDef
                {
                    ...
                    RestrictionRadius = 30, // Prevents other blocks of this type from being placed within this distance of the centre of the block.
                ...
                Loading = new LoadingDef
                {
                    ...
                    ShotsInBurst = 7, // Use this if you don't want the weapon to fire an entire physical magazine in one go. Should not be more than your magazine capacity.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "airblast", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "AryxAWE_AvalancheMuzzleBlast", // SubtypeId of muzzle particle effect.
