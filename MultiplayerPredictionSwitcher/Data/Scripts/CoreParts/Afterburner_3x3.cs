...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition MA_Afterburner_Large => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "MA_Afterburner_Large",
            ...
            Ammos = new[] {
                Afterburner_ammo_1,                // Must list all primary, shrapnel, and pattern ammos.
            },
