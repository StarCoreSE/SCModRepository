...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef MS1 => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "MetalStormProjectileFuckEnergyWeaponsJFCDarkstar", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "MetalStormProj1", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 5f, //
                        Width = 0.1f, //
                        Color = Color(red: 25, green: 2, blue: 0f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
