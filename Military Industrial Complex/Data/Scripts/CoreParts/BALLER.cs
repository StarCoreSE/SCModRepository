...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition BALLER => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "BALLER", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "BALLER", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "CLBXFire", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "pleasedonotthanks", // SubtypeId of muzzle particle effect.
