...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Starcore_Drone => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Starcore_Drone_Launcher", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            Targeting = new TargetingDef
            {
                ...
                SubSystems = new[] {
                    Power, Utility, Thrust, Offense, Production, Any, // Subsystem targeting priority: Offense, Utility, Power, Production, Thrust, Jumping, Steering, Any
                },
            ...
            {
                PartName = "Morrigan Drone", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 30f, // Projectile inaccuracy in degrees.
                ...
                {
                    RotateRate = 20f, // Max traversal speed of azimuth subpart in radians per tick (0.1 is approximately 360 degrees per second).
                    ElevateRate = 20f, // Max traversal speed of elevation subpart in radians per tick.
                    MinAzimuth = -180,
                    MaxAzimuth = 180,
                    MinElevation = -90,
                    MaxElevation = 90,
                ...
                Other = new OtherDef
                {
                    ConstructPartCap = 5, // Maximum number of blocks with this weapon on a grid; 0 = unlimited.
                ...
                Loading = new LoadingDef
                {
                    ...
                    MaxActiveProjectiles = 6, // Maximum number of projectiles in flight
            ...
            Ammos = new[] {
                Starcore_Drone_Lauch,
                Starcore_Drone_Base,
                Starcore_Drone_PDC,
                Starcore_Drone_Secondary_Right,
                Starcore_Drone_Secondary_Left,
                Starcore_Drone_SSRM_Launch,
                Starcore_Drone_SSRM_Acceleration,
                Starcore_Drone_SSRM_Detonation,
