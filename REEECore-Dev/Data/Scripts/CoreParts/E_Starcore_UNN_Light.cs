...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition E_Starcore_UNN_Light => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "UNN_Light_Torpedo",
            ...
            {
                PartName = "UNN Light Torpedo", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                E_Starcore_UNN_Light_Torpedo_Launch,
                E_Starcore_UNN_Light_Torpedo_Acceleration,
                E_Starcore_UNN_Light_Torpedo_Detonation,
                E_Starcore_UNN_Light_Torpedo_Detonation_Frag,
