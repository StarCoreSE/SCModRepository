...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition E_Starcore_UNN_Heavy => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "UNN_Heavy_Torpedo",
            ...
            {
                PartName = "UNN Heavy Torpedo", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
