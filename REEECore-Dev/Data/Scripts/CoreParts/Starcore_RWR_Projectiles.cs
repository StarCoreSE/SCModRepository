...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Starcore_RWR_Projectiles => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Starcore_RWR_Projectiles", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "RecieverBarrels", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "RecieverBase1", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "RecieverBarrels",// Your Elevating Subpart, that bit that moves up.
                ...
                Muzzles = new[] {
                    "barrel_reciever", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            Targeting = new TargetingDef
            {
                ...
                TopTargets = 5, // Maximum number of targets to randomize between; 0 = unlimited.
                ...
                MaxTrackingTime = 104, // After this time has been reached the weapon will stop tracking existing target and scan for a new one
            ...
            {
                PartName = "RWR Scanner", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "RWR_Beeps", // Audio for firing.
        ...
        WeaponDefinition Starcore_RWR_Asteroids => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Starcore_RWR_Asteroids", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "RecieverBarrels", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "RecieverBase1", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "RecieverBarrels",// Your Elevating Subpart, that bit that moves up.
            ...
            {
                Threats = new[] {
                    ScanRoid, // Types of threat to engage: Grids, Projectiles, Characters, Meteors, Neutrals, ScanRoid, ScanPlanet, ScanFriendlyCharacter, ScanFriendlyGrid, ScanEnemyCharacter, ScanEnemyGrid, ScanNeutralCharacter, ScanNeutralGrid, ScanUnOwnedGrid, ScanOwnersGrid
                },
                SubSystems = new[] {
                    Any, // Subsystem targeting priority: Offense, Utility, Power, Production, Thrust, Jumping, Steering, Any
                },
            ...
            HardPoint = new HardPointDef
            {
                PartName = "RWR Asteroid Scanner", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0f, // Projectile inaccuracy in degrees.
                AimingTolerance = 90f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                AimLeadingPrediction = Accurate, // Level of turret aim prediction; Off, Basic, Accurate, Advanced
                DelayCeaseFire = 0, // Measured in game ticks (6 = 100ms, 60 = 1 second, etc..). Length of time the weapon continues firing after trigger is released - while a target is available.
