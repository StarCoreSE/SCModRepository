...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Starcore_FCC => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Starcore_Fixed_Coil_Cannon", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Fixed Coil Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "Starcore_FCC_Muzzleflash", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                Starcore_HeavyGauss_Ammo,
                Starcore_HeavyGauss_Ammo_Shrap,
                Starcore_HG_VFX1,
                Starcore_HG_VFX2,
                Starcore_HG_VFX3,
