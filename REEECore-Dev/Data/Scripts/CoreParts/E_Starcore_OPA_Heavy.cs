...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition E_Starcore_OPA_Heavy => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "OPA_Heavy_Torpedo",
            ...
            {
                PartName = "OPA H Torpedo", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                E_Starcore_OPA_Torpedo_Launch,
                E_Starcore_OPA_Torpedo_Acceleration,
                E_Starcore_OPA_Torpedo_Detonation,
                E_Starcore_OPA_Torpedo_Detonation_Frag,
