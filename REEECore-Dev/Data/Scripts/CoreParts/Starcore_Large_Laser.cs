...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition Starcore_L_Laser => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Starcore_L_Laser_Block", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Large Laser", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "LrgLaserFire", // Audio for firing.
            ...
            Ammos = new[] {
                Starcore_L_Laser_Ammo,
                Starcore_L_Laser_Ammo_Fake,
