...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef E_Starcore_OPA_Light_Missile_Launch => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "OPALIGHTMAG", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "OPA Light Missile Launch", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 3200, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). time begins at 0 and time must EXCEED this value to trigger "time > maxValue". Please have a value for this, It stops Bad things.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 2f, //
                        Width = 0.25f, //
                        Color = Color(red: 30, green: 30, blue: 90f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
