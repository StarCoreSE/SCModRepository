...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Starcore_AMS_II => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Starcore_AMS_II_Block", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "SC_AMS_II_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "SC_AMS_II_Rot", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "SC_AMS_II_Ele",// Your Elevating Subpart, that bit that moves up
                ...
                Muzzles = new[] {
                    "SC_AMS_II_barrel_01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                    "SC_AMS_II_barrel_02",
                    "SC_AMS_II_barrel_03",
                    "SC_AMS_II_barrel_04",
            ...
            {   
                ...
                HardWare = new HardwareDef
                {
                    ...
                    ElevateRate = 0.063f, // Max traversal speed of elevation subpart in radians per tick.
                    MinAzimuth = -180,
                    MaxAzimuth = 180,
                    MinElevation = -5,
                    MaxElevation = 105,
                    ...
                    CriticalReaction = new CriticalDef
                    {
                        ...
                        AmmoRound = "Starcore_AMS_I_BallBulletBase", // Optional. If specified, the warhead will always use this ammo on detonation rather than the currently selected ammo.
                    },
                },
                Other = new OtherDef
                {
