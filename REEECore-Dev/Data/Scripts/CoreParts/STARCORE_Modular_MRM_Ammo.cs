...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef Starcore_MRM_Launch_Mod => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            Mass = 110f, // In kilograms; how much force the impact will apply to the target.
            Health = 125, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            ...
            {
                AmmoRound = "MRM_2ndStage", // AmmoRound field of the ammo to spawn.
                ...
                TimedSpawns = new TimedSpawnDef // disables FragOnEnd in favor of info specified below, unless ArmWhenHit or Eol ArmOnlyOnHit is set to true then both kinds of frags are active
                {
                    ...
                    StartTime = 50, // Time delay to start spawning fragments, in ticks, of total projectile life
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                Smarts = new SmartsDef
                {
                    ...
                    Aggressiveness = 1, // controls how responsive tracking is, recommended value 3-5.
                    ...
                    OffsetMinRange = 990, // The range from target at which offsets are no longer active
                    ...
                    MinTurnSpeed = 150, // set this to a reasonable value to avoid projectiles from spinning in place or being too aggressive turing at slow speeds 
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 1, green: 1, blue: 8, alpha: 1),
                        FactionColor = DontUse, // DontUse, Foreground, Background.
                        Back = false,
                        CustomWidth = 0.8f,
        ...
        private AmmoDef Starcore_MRM_Acceleration_Mod => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            AmmoRound = "MRM_2ndStage", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                Smarts = new SmartsDef
                {
                    SteeringLimit = 4f, // 0 means no limit, value is in degrees, good starting is 150.  This enable advanced smart "control", cost of 3 on a scale of 1-5, 0 being basic smart.
                    Inaccuracy = 5f, // 0 is perfect, hit accuracy will be a random num of meters between 0 and this value.
                    ...
                    Roam = false, // Roam current area after target loss
                    KeepAliveAfterTargetLoss = true, // Whether to stop early death of projectile on target loss
                    OffsetRatio = 0.01875f, // The ratio to offset the random direction (0 to 1) 
                    ...
                    ScanRange = 4000, // 0 disables projectile screening, the max range that this projectile will be seen at by defending grids (adds this projectile to defenders lookup database). 
                    NoSteering = false, // this disables target follow and instead travel straight ahead (but will respect offsets).
                    MinTurnSpeed = 1000, // set this to a reasonable value to avoid projectiles from spinning in place or being too aggressive turing at slow speeds 
                    NoTargetApproach = false, // If true approaches can begin prior to the projectile ever having had a target.
                    AltNavigation = false, // If true this will swap the default navigation algorithm from ProNav to ZeroEffort Miss.  Zero effort is more direct/precise but less cinematic 
                },
                Mines = new MinesDef  // Note: This is being investigated. Please report to Github, any issues.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    Ammo = new ParticleDef
                    {
                        Name = "MRMStage2Trail", //ShipWelderArc
                        Offset = Vector(x: 0, y: 0, z: 0),
                        DisableCameraCulling = true,// If not true will not cull when not in view of camera, be careful with this and only use if you know you need it
                        Extras = new ParticleOptionDef
                        {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f, //
                        Width = 0.5f, //
                        Color = Color(red: 700, green: 60, blue: 0f, alpha: 45), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        FactionColor = DontUse, // DontUse, Foreground, Background.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        AlwaysDraw = false, // Prevents this tracer from being culled.  Only use if you have a reason too (very long tracers/trails).
        ...
        private AmmoDef bStarcore_MRM_Launch_Mod => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "MODMRMAMMO", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "MRM", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 350, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). Please have a value for this, It stops Bad things.
                AccelPerSec = 1850f, // Meters Per Second. This is the spawning Speed of the Projectile, and used by turning.
                ...
                Smarts = new SmartsDef
                {
                    ...
                    Inaccuracy = 12, // 0 is perfect, hit accuracy will be a random num of meters between 0 and this value.
                    ...
                    OffsetRatio = 0.58f, // The ratio to offset the random direction (0 to 1) 
                    OffsetTime = 355, // how often to offset degree, measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..)
                },
                Mines = new MinesDef  // Note: This is being investigated. Please report to Github, any issues.
                {
                    DetectRadius = 0,
        ...
        private AmmoDef bStarcore_MRM_Acceleration_Mod => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
