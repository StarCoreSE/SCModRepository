...
namespace StarCore.ShareTrack.API.CoreSystem
{
    ...
    public partial class WcApi
    {
        ...
        private Action<IDictionary<MyDefinitionId, List<MyTuple<int, MyTuple<MyDefinitionId, string, string, bool>>>>>
        ...
        private Action<MyEntity, int, List<MyTuple<Vector3D, Vector3D, Vector3D, Vector3D, MatrixD, MatrixD>>>
            _getMuzzleInfo;
        ...
        private Action<long, int, Action<ListReader<
                MyTuple<ulong, long, int, MyEntity, MyEntity, ListReader<MyTuple<Vector3D, object, float>>>>>>
        ...
        {
            return _isTargetAlignedExtended?.Invoke(weapon, targetEnt, weaponId) ?? new MyTuple<bool, Vector3D?>();
        }
        ...
        public void GetAllWeaponDefinitions(IList<byte[]> collection)
        {
        ...
        public void GetNpcSafeWeapons(ICollection<MyDefinitionId> collection)
        {
        ...
        public void GetAllWeaponMagazines(
            IDictionary<MyDefinitionId, List<MyTuple<int, MyTuple<MyDefinitionId, string, string, bool>>>> collection)
        {
        ...
        public void GetAllCorePhantoms(ICollection<MyDefinitionId> collection)
        {
            _getCorePhantoms?.Invoke(collection);
        }

        public void GetAllCoreRifles(ICollection<MyDefinitionId> collection)
        {
            _getCoreRifles?.Invoke(collection);
        }

        public void GetAllCoreArmors(IList<byte[]> collection)
        {
        ...
        {
            return _getProjectilesLockedOn?.Invoke(victim) ?? new MyTuple<bool, int, int>();
        }
        ...
        {
            return _getWeaponTarget?.Invoke(weapon, weaponId) ?? new MyTuple<bool, bool, bool, MyEntity>();
        }
        ...
        {
            return _getWeaponScope?.Invoke(weapon, weaponId) ?? new MyTuple<Vector3D, Vector3D>();
        }
        ...
        {
            return _isInRange?.Invoke(entity) ?? new MyTuple<bool, bool>();
        }
        ...
        internal void GetMuzzleInfo(MyEntity weaponBlock, int weaponId,
            List<MyTuple<Vector3D, Vector3D, Vector3D, Vector3D, MatrixD, MatrixD>> output)
        {
        ...
        public void ShootRequestHandler(long handledEntityId, bool unregister,
            Func<Vector3D, Vector3D, int, bool, object, int, int, int, bool> callback)
        {
        ...
        public class DamageHandlerHelper
        {
            ...
            private readonly Stack<List<ProjectileDamageEvent.ProHit>> _hitPool =
                new Stack<List<ProjectileDamageEvent.ProHit>>(256);
            ...
            private void DefaultCallBack(
                ListReader<MyTuple<ulong, long, int, MyEntity, MyEntity, ListReader<MyTuple<Vector3D, object, float>>>>
                    listReader)
            {
            ...
            private List<ProjectileDamageEvent> ProcessEvents(
                ListReader<MyTuple<ulong, long, int, MyEntity, MyEntity, ListReader<MyTuple<Vector3D, object, float>>>>
                    projectiles)
            {
