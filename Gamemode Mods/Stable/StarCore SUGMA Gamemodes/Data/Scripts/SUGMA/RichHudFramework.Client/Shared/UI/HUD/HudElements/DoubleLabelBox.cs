...
namespace RichHudFramework.UI
{
    ...
    public class DoubleLabelBox : LabelBoxBase
    {
        ...
        {
            get { return left.AutoResize; }
            set
            {
                left.AutoResize = value;
                right.AutoResize = value;
            }
        }
        ...
        {
            get { return left.BuilderMode; }
            set
            {
                left.BuilderMode = value;
                right.BuilderMode = value;
            }
        }
        ...
        /// </summary>
        public RichText LeftText
        {
            get { return left.TextBoard.GetText(); }
            set { left.TextBoard.SetText(value); }
        }

        /// <summary>
        /// Text rendered by the right label.
        /// </summary>
        public RichText RightText
        {
            get { return right.TextBoard.GetText(); }
            set { right.TextBoard.SetText(value); }
        }
        ...
        public DoubleLabelBox(HudParentBase parent = null) : base(parent)
        {
            ...
            right = new Label(this)
                { ParentAlignment = ParentAlignments.Right | ParentAlignments.InnerH | ParentAlignments.UsePadding };
        }
