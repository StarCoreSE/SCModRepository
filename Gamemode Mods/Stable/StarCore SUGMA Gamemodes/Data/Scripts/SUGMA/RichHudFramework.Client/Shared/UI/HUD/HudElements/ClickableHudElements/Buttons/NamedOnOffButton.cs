...
namespace RichHudFramework.UI
{
    ...
    public class NamedOnOffButton : HudElementBase, IClickableElement
    {
        ...
        {
            get { return onOffButton.ButtonSpacing; }
            set { onOffButton.ButtonSpacing = value; }
        }
        ...
        {
            get { return onOffButton.Padding; }
            set { onOffButton.Padding = value; }
        }
        ...
        {
            get { return onOffButton.BorderColor; }
            set { onOffButton.BorderColor = value; }
        }

        /// <summary>
        /// On button text
        /// </summary>
        public RichText OnText
        {
            get { return onOffButton.OnText; }
            set { onOffButton.OnText = value; }
        }

        /// <summary>
        /// Off button text
        /// </summary>
        public RichText OffText
        {
            get { return onOffButton.OnText; }
            set { onOffButton.OnText = value; }
        }
        ...
        {
            get { return onOffButton.Format; }
            set { onOffButton.Format = value; }
        }
        ...
        public bool Value
        {
            get { return onOffButton.Value; }
            set { onOffButton.Value = value; }
        }
