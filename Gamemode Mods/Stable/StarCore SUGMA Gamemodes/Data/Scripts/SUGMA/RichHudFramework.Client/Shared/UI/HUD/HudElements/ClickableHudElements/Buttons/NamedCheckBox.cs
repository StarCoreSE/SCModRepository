...
namespace RichHudFramework.UI
{
    ...
    public class NamedCheckBox : HudElementBase, IClickableElement
    {
        ...
        {
            get { return name.TextBoard.GetText(); }
            set { name.TextBoard.SetText(value); }
        }
        ...
        {
            get { return name.TextBoard.Format; }
            set { name.TextBoard.Format = value; }
        }
        ...
        {
            get { return name.Padding; }
            set { name.Padding = value; }
        }
        ...
        {
            get { return name.BuilderMode; }
            set { name.BuilderMode = value; }
        }
        ...
        {
            get { return name.VertCenterText; }
            set { name.VertCenterText = value; }
        }
        ...
        {
            get { return checkbox.IsBoxChecked; }
            set { checkbox.IsBoxChecked = value; }
        }
