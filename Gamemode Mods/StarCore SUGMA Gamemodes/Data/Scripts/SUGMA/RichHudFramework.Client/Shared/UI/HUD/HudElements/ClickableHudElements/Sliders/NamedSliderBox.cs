...
namespace RichHudFramework.UI
{
    ...
    public class NamedSliderBox : HudElementBase, IClickableElement
    {
        ...
        {
            get { return current.TextBoard.GetText(); }
            set { current.TextBoard.SetText(value); }
        }
        ...
        public float Min
        {
            get { return sliderBox.Min; }
            set { sliderBox.Min = value; }
        }
        ...
        public float Max
        {
            get { return sliderBox.Max; }
            set { sliderBox.Max = value; }
        }
        ...
        {
            get { return sliderBox.Current; }
            set { sliderBox.Current = value; }
        }
        ...
        {
            get { return sliderBox.Percent; }
            set { sliderBox.Percent = value; }
        }
