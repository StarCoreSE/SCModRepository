...
namespace RichHudFramework.UI
{
    ...
    public class LabelBox : LabelBoxBase, ILabelElement
    {
        ...
        {
            get { return textElement.TextBoard.GetText(); }
            set { textElement.TextBoard.SetText(value); }
        }
        ...
        {
            get { return textElement.TextBoard.Format; }
            set { textElement.TextBoard.Format = value; }
        }
        ...
        {
            get { return textElement.Padding; }
            set { textElement.Padding = value; }
        }
        ...
        {
            get { return textElement.Size; }
            set { textElement.Size = value; }
        }
        ...
        {
            get { return textElement.AutoResize; }
            set { textElement.AutoResize = value; }
        }
        ...
        {
            get { return TextBoard.BuilderMode; }
            set { TextBoard.BuilderMode = value; }
        }
        ...
        {
            get { return textElement.VertCenterText; }
            set { textElement.VertCenterText = value; }
        }
