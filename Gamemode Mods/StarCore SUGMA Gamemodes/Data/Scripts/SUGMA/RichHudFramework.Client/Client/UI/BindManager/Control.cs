        ...
        public sealed partial class BindManager
        {
            private class Control : IControl
            {
                ...
                public string DisplayName =>
                    _instance.GetControlMember(Index, (int)ControlAccessors.DisplayName) as string;
                ...
                public bool IsPressed =>
                    (bool)(_instance.GetControlMember(Index, (int)ControlAccessors.IsPressed) ?? false);

                /// <summary>
                /// Returns true if the control was just pressed
                /// </summary>
                public bool IsNewPressed =>
                    (bool)(_instance.GetControlMember(Index, (int)ControlAccessors.IsNewPressed) ?? false);

                /// <summary>
                /// Returns true if the control was just released
                /// </summary>
                public bool IsReleased =>
                    (bool)(_instance.GetControlMember(Index, (int)ControlAccessors.IsReleased) ?? false);
