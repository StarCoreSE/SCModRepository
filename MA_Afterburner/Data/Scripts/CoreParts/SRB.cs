...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SRB => new WeaponDefinition
        {
            ...
            {
                PartName = "Solid Rocket Booster", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    DelayUntilFire = 150, // How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
