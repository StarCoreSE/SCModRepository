...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AncientAfterburnerT42 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "AncientAfterburnerT42",
            ...
            HardPoint = new HardPointDef
            {
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Ancient_Afterburner_MidMany", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "AfterburnerExhaust_1x1", // SubtypeId of muzzle particle effect.
