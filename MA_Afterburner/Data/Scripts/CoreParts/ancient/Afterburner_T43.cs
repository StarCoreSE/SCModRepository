...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AncientAfterburnerT43 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "AncientAfterburnerT43",
            ...
            HardPoint = new HardPointDef
            {
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Ancient_Afterburner_MidManyAB", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "AfterburnerExhaust_3x3", // SubtypeId of muzzle particle effect.
