...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AncientAfterburnerT44 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "AncientAfterburnerT44",
            ...
            HardPoint = new HardPointDef
            {
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Ancient_Afterburner_Deep", // Audio for firing.
