    ...
    namespace UI
    {
        ...
        public struct GlyphFormat : IEquatable<GlyphFormat>
        {
            public static readonly GlyphFormat
                ...
                White = new GlyphFormat(Color.White),
                Blueish = new GlyphFormat(new Color(220, 235, 242)),
            ...
            {
                return new GlyphFormat(color, Alignment, TextSize, StyleIndex);
            }
            ...
            {
                return new GlyphFormat(Color, textAlignment, TextSize, StyleIndex);
            }
            ...
            {
                return new GlyphFormat(Color, Alignment, TextSize, new Vector2I(font, 0));
            }
            ...
            {
                return new GlyphFormat(Color, Alignment, TextSize, fontStyle);
            }
            ...
            {
                return new GlyphFormat(Color, Alignment, size, StyleIndex);
            }
