...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Afterburner_LG_Ion_Large => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Afterburner_LG_Ion_Large",
            ...
            {
                PartName = "Ion Afterburner", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 8f, // Projectile inaccuracy in degrees.
                ...
                Loading = new LoadingDef
                {
                    ...
                    MaxHeat = 3200, // Max heat before weapon enters cooldown (70% of max heat).
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "AfterburnerExhaust_ion", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                Afterburner_ammo_4,                // Must list all primary, shrapnel, and pattern ammos.
            },
