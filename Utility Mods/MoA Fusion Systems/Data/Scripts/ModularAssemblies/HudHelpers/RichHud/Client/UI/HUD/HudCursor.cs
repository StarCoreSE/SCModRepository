    ...
    namespace UI.Client
    {
        public sealed partial class HudMain
        {
            ...
            private class HudCursor : ICursor
            {
                ...
                {
                    return IsCapturingSpaceFunc(GetHudSpaceFunc);
                }
                ...
                {
                    return TryCaptureHudSpaceFunc(depthSquared, GetHudSpaceFunc);
                }
                ...
                {
                    return IsCapturingFunc(capturedElement);
                }
                ...
                {
                    return TryCaptureFunc(capturedElement);
                }
                ...
                {
                    return TryReleaseFunc(capturedElement);
                }
