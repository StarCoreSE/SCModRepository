    ...
    namespace UI
    {
        ...
        namespace Rendering.Client
        {
            ...
            public class TextBoard : TextBuilder, ITextBoard
            {
                ...
                public float Scale
                {
                    get { return GetScaleFunc(); }
                    set { SetScaleAction(value); }
                }
                ...
                ///     Full text size including any text outside the visible range.
                /// </summary>
                public Vector2I VisibleLineRange =>
                    (Vector2I)GetOrSetMemberFunc(null, (int)TextBoardAccessors.VisibleLineRange);
                ...
                {
                    get { return GetFixedSizeFunc(); }
                    set { SetFixedSizeAction(value); }
                }
                ...
                {
                    var halfSize = GetSizeFunc() * .5f;
                    var box = new BoundingBox2(origin - halfSize, origin + halfSize);
                ...
                {
                    return (Vector2I)GetOrSetMemberFunc(offset, (int)TextBoardAccessors.GetCharAtOffset);
                }
            }
        }
