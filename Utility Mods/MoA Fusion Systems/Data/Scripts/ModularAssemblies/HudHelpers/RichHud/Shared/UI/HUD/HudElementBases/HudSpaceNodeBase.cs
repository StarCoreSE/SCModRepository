...
namespace RichHudFramework
{
    namespace UI
    {
        ...
        {
            protected const HudElementStates spaceNodeVisible =
                HudElementStates.IsVisible | HudElementStates.WasParentVisible;
            ...
            protected override void Layout()
            {
                ...
                var cursorLine = HudMain.Cursor.WorldLine;

                var plane = new PlaneD(PlaneToWorldRef[0].Translation, PlaneToWorldRef[0].Forward);
                var worldPos = plane.Intersection(ref cursorLine.From, ref cursorLine.Direction);
