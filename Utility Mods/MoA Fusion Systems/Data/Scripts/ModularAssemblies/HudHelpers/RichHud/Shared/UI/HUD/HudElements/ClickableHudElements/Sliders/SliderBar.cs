...
namespace RichHudFramework.UI
{
    ...
    public class SliderBar : HudElementBase, IClickableElement
    {
        ...
        {
            var fullCurosrPos = HudSpace.CursorPos;
            var cursorPos = new Vector2(fullCurosrPos.X, fullCurosrPos.Y);
