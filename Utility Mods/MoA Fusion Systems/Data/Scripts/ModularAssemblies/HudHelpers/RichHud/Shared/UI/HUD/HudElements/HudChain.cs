...
namespace RichHudFramework
{
    namespace UI
    {
        ...
        /// </summary>
        public enum HudChainSizingModes
        {
        ...
        */
            ...
            where TElement : HudElementBase
        {
            protected const HudElementStates
                nodeSetVisible = HudElementStates.IsVisible | HudElementStates.IsRegistered;
            ...
            public override float Width
            {
                set
                {
                    ...
                    if (value > 0f && offAxis == 0 && (SizingMode &
                                                       (HudChainSizingModes.ClampMembersOffAxis |
                                                        HudChainSizingModes.FitMembersOffAxis)) > 0)
            ...
            public override float Height
            {
                set
                {
                    ...
                    if (value > 0f && offAxis == 1 && (SizingMode &
                                                       (HudChainSizingModes.ClampMembersOffAxis |
                                                        HudChainSizingModes.FitMembersOffAxis)) > 0)
            ...
            {
                get { return _absMaxSize; }
                set { _absMaxSize = value; }
            }
            ...
            {
                get { return _absMinSize; }
                set { _absMinSize = value; }
            }
            ...
            protected void UpdateMemberSizes()
            {
                ...
                for (var n = 0; n < hudCollectionList.Count; n++)
                {
                    var element = hudCollectionList[n].Element;
                    ...
                    if ((SizingMode & HudChainSizingModes.FitMembersOffAxis) > 0)
                        ...
                        elementSize[offAxis] =
                            MathHelper.Clamp(elementSize[offAxis], minSize[offAxis], maxSize[offAxis]);
                    ...
                    if ((SizingMode & HudChainSizingModes.FitMembersAlignAxis) > 0)
                        ...
                        elementSize[alignAxis] = MathHelper.Clamp(elementSize[alignAxis], minSize[alignAxis],
                            maxSize[alignAxis]);
            ...
            protected void UpdateMemberOffsets(Vector2 offset, Vector2 padding)
            {
                ...
                for (var n = 0; n < hudCollectionList.Count; n++)
                {
                    ...
                    var newOffset = offset + elementSize * alignMask * .5f;

                    if ((element.ParentAlignment & left) == left)
                        newOffset += padding * offMask * .5f;
                    else if ((element.ParentAlignment & right) == right) newOffset -= padding * offMask * .5f;
