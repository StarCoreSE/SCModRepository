...
{ // Don't edit above this line
    partial class Parts
    {
	    ...
	    private AmmoDef Afterburner_ammo_2 => new AmmoDef
        {
            ...
            AmmoRound = "Afterburner_ammo_2", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                {
                    Distance = 20f, // Distance at which damage begins falling off.
        ...
        private AmmoDef Afterburner_ammo_2_smallgrid => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Afterburner_ammo_2_SG", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.001f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 0f, // Direct damage; one steel plate is worth 100.
            Mass = 0, // In kilograms; how much force the impact will apply to the target.
            Health = 0, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 20000f, // Recoil.
            DecayPerShot = 0f, // Damage to the firing weapon itself.
            HardPointUsable = true, // Whether this is a primary ammo type fired directly by the turret. Set to false if this is a shrapnel ammoType and you don't want the turret to be able to select it directly.
            EnergyMagazineSize = 1, // For energy weapons, how many shots to fire before reloading.
            HeatModifier = -1f, // Allows this ammo to modify the amount of heat the weapon produces per shot.
