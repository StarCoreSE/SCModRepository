...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition MA_Afterburner_Large_5x => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "MA_Afterburner_Large_5x",
            ...
            {
                PartName = "Extra Large Afterburner", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    Cooldown = .4f, // Percentage of max heat to be under to start firing again after overheat; accepts 0 - 0.95
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "AfterburnerExhaust_5x5", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                Afterburner_ammo_3,                // Must list all primary, shrapnel, and pattern ammos.
            },
