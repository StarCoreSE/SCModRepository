...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AncientAfterburnerT40 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "AncientAfterburnerT40",
            ...
            HardPoint = new HardPointDef
            {
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Ancient_Afterburner_Mid", // Audio for firing.
