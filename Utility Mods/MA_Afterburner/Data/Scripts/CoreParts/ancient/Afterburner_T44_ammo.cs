...
{ // Don't edit above this line
    partial class Parts
    {
	    ...
	    private AmmoDef Afterburner_ammo_T44 => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Afterburner_ammo_T44", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
