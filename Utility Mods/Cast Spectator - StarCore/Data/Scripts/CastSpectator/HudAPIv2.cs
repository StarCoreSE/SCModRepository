...
namespace Draygo.API
{
	public class HudAPIv2
	{
		...
		{
			private string v1;
			private MenuRootCategory spectatorCameraRootCat;
			private float v2;
			private string v3;
			private string sensOnSubmit;
			private Action<float> senseToValue;
			...
			public MenuSliderInput(string v1, MenuRootCategory spectatorCameraRootCat, float v2, string v3, string sensOnSubmit, Action<float> senseToValue)
			{
				this.v1 = v1;
				this.spectatorCameraRootCat = spectatorCameraRootCat;
				this.v2 = v2;
				this.v3 = v3;
				this.sensOnSubmit = sensOnSubmit;
				this.senseToValue = senseToValue;
			}
		}
		#endregion
	}
