...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition NHI_Fixed_Light_Gatling_Laser => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NHI_Fixed_Light_Gatling_Laser", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "'Brandr' Gatling", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    MaxHeat = 730, // Max heat before weapon enters cooldown (70% of max heat).
                    ...
                    BarrelSpinRate = 300, // Visual only, 0 disables and uses RateOfFire.
            ...
            Ammos = new[] {
                GatLasPulse4, // Must list all primary, shrapnel, and pattern ammos.
            },
