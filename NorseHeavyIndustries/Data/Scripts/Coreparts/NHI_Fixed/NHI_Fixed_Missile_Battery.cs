...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition NHI_Fixed_Missile_Battery => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NHI_Fixed_Missile_Battery", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "200mm 'Thors Wrath' Missile System", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                NHI_Missile_Battery_Launch,
                NHI_Missile_Battery_Travel,
                NHI_Missile_Battery_Travel_2,
                NHI_Missile_Battery_Terminal,
                NHI_Missile_Battery_Terminal_2,// Must list all primary, shrapnel, and pattern ammos.
            },
