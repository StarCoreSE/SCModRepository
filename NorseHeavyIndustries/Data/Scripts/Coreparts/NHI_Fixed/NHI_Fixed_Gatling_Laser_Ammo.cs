...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef GatLasPulse2 => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
        ...
        private AmmoDef GatLasPulse3 => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Shield H. Pulse Laser", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            ...
            IgnoreVoxels = false, // Whether the projectile should be able to penetrate voxels.
            Synchronize = false, // For future use
            HeatModifier = 0.5f, // Allows this ammo to modify the amount of heat the weapon produces per shot.
            Shape = new ShapeDef // Defines the collision shape of the projectile, defaults to LineShape and uses the visual Line Length if set to 0.
            {
                Shape = LineShape, // LineShape or SphereShape. Do not use SphereShape for fast moving projectiles if you care about precision.
                Diameter = 1, // Diameter is minimum length of LineShape or minimum diameter of SphereShape.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Grids = new GridSizeDef
                {
                    Large = .01f, // Multiplier for damage against large grids.
                    Small = .01f, // Multiplier for damage against small grids.
                },
                Armor = new ArmorDef
                {
                    Armor = .01f, // Multiplier for damage against all armor. This is multiplied with the specific armor type multiplier (light, heavy).
                    Light = .01f, // Multiplier for damage against light armor.
                    Heavy = .01f, // Multiplier for damage against heavy armor.
                    NonArmor = .01f, // Multiplier for damage against every else.
                },
                Shields = new ShieldDef
                {
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 0.001f, //
                        Width = .15f, //
                        Color = Color(red: 0, green: 1, blue: 12, alpha: .1f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "WeaponLaser", // Please always have this Line set, if this Section is enabled.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 25, // In Ticks. 1 = 1 Additional Tracer generated per motion, 33 is 33 lines drawn per projectile. Keep this number low.
                        Color = Color(red: 8, green: 19, blue: 19f, alpha: .35f),
                        Back = false,
                        CustomWidth = .5f,
                        UseWidthVariance = false,
                        UseColorFade = true,
