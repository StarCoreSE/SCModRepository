...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition NHI_Fixed_Light_Autocannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NHI_Fixed_Light_Autocannon", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "muzzle_gatling_01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "muzzle_gatling_01", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "'Fang' Rotary", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    Cooldown = .75f, // Percentage of max heat to be under to start firing again after overheat; accepts 0 - 0.95
                    ...
                    DelayAfterBurst = 18, // How long to spend "reloading" after each burst. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    ...
                    BarrelSpinRate = 450, // Visual only, 0 disables and uses RateOfFire.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Auto_Fire_Test_Two", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "NHI_Fixed_Autocannon_Muzzleflash", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                Light_Autocannon_Fixed_Bullet_Primary,
                Light_Autocannon_Fixed_Bullet_Secondary,
                Light_Phantom_Primary,
                Light_Phantom_Secondary // Must list all primary, shrapnel, and pattern ammos.
            },
