...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition NHI_Kinetic_Cannon_Turret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NHI_Kinetic_Cannon_Turret", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "Hurricane_Mk2_Elevation", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "Hurricane_Mk2_Azimuth", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "Hurricane_Mk2_Elevation",// Your Elevating Subpart, that bit that moves up.
                ...
                Muzzles = new[] {
                    "Cannon_Muzzle_01",
                    "Cannon_Muzzle_02", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A

                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "Cannon_Scope", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            HardPoint = new HardPointDef
            {
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "ArcWepShipARYXTyphoon_Fire2", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "AWE_Cyclone_Muzzleblast", // SubtypeId of muzzle particle effect.
                        ...
                        Extras = new ParticleOptionDef
                        {
                            ...
                            MaxDistance = 3000, // Max distance at which this effect should be visible. NOTE: This will use whichever MaxDistance value is higher across Effect1 and Effect2!
            ...
            Ammos = new[] {
                H_APCBC,
                H_APCBC_Frag // Must list all primary, shrapnel, and pattern ammos.
