...
namespace Scripts {
    partial class Parts {
        ...
        WeaponDefinition NHI_PD_Turret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NHI_PD_Turret", // Block Subtypeid. Your Cubeblocks contain this information
                    ...
                    new MountPointDef {
                        SubtypeId = "NHI_PD_Turret_Half", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "GatlingBarrel", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "GatlingBarrel", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "GatlingTurretBase1", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "GatlingTurretBase2",// Your Elevating Subpart, that bit that moves up.
                    ...
                    new MountPointDef {
                        SubtypeId = "NHI_PD_Turret_Half_Slope_Top", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "GatlingBarrel", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "GatlingBarrel", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "GatlingTurretBase1", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "GatlingTurretBase2",// Your Elevating Subpart, that bit that moves up.
                    ...
                    new MountPointDef {
                        SubtypeId = "NHI_PD_Turret_Half_Slope_Tip", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "GatlingBarrel", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "GatlingBarrel", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "GatlingTurretBase1", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "GatlingTurretBase2",// Your Elevating Subpart, that bit that moves up.
                     ...
                     new MountPointDef {
                        SubtypeId = "NHI_PD_Turret_45_Slope", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "GatlingBarrel", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "GatlingBarrel", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "GatlingTurretBase1", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "GatlingTurretBase2",// Your Elevating Subpart, that bit that moves up.
                ...
                Muzzles = new[] {
                    "muzzle_projectile_001.001 (L).001",
            ...
            HardPoint = new HardPointDef
            {
                ...
                {
                    RotateRate = 0.035f, // Max traversal speed of azimuth subpart in radians per tick (0.1 is approximately 360 degrees per second).
                    ...
                    InventorySize = 3f, // Inventory capacity in kL.
                    ...
                    CriticalReaction = new CriticalDef
                    {
                        ...
                        AmmoRound = "Odin_PDC_Primary", // Optional. If specified, the warhead will always use this ammo on detonation rather than the currently selected ammo.
                    },
                },
                Other = new OtherDef
                {
                ...
                {
                    RateOfFire = 2300, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                    ...
                    MaxHeat = 510, // Max heat before weapon enters cooldown (70% of max heat).
                    Cooldown = 1f, // Percentage of max heat to be under to start firing again after overheat; accepts 0 - 0.95
                    HeatSinkRate = 510, // Amount of heat lost per second.
                    ...
                    BarrelSpinRate = 1800, // Visual only, 0 disables and uses RateOfFire.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Heimdall_Firesound", // Audio for firing.
            ...
            Ammos = new[] {
                Odin_PDC_Primary,
                Odin_PDC_Secondary, // Must list all primary, shrapnel, and pattern ammos.
            },
