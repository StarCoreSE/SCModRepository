...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition NHI_Heavy_Railgun_Turret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NHI_Heavy_Railgun_Turret", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            Targeting = new TargetingDef
            {
                ...
                SubSystems = new[] {
                     Any, Thrust, Utility, Power, Production, Offense, // Subsystem targeting priority: Offense, Utility, Power, Production, Thrust, Jumping, Steering, Any
                },
            ...
            {
                PartName = "Heavy Railgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    IdlePower = 0.55f, // Constant base power draw in MW.
                ...
                Loading = new LoadingDef
                {
                    ...
                    DelayUntilFire = 25, // Howe long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    HeatPerShot = 1500, // Heat generated per shot.
                    MaxHeat = 3750, // Max heat before weapon enters cooldown (70% of max heat).
                    Cooldown = 0f, // Percentage of max heat to be under to start firing again after overheat; accepts 0 - 0.95
                    HeatSinkRate = 1500, // Amount of heat lost per second.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    ReloadSound = "Railgun_Reload_S", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
            ...
            Ammos = new[] {
                Railgun_Bullet_Primary,
                Odin_Railgun_Ammo_VFX1,
                Odin_Railgun_Ammo_VFX2,
                Odin_Railgun_Fragment// Must list all primary, shrapnel, and pattern ammos.
            },
