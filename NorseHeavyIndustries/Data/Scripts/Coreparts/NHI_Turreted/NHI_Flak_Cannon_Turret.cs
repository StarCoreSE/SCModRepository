...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition NHI_Flak_Cannon_Turret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NHI_Flak_Cannon_Turret", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    ...
                    "muzzle_missile_01",
                    "muzzle_missile_02",
                    "muzzle_missile_03", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            HardPoint = new HardPointDef
            {
                ...
                HardWare = new HardwareDef
                {
                    ...
                    CriticalReaction = new CriticalDef
                    {
                        ...
                        AmmoRound = "Flak_Shell_Primary", // Optional. If specified, the warhead will always use this ammo on detonation rather than the currently selected ammo.
                    },
                },
                Other = new OtherDef
                {
                ...
                Loading = new LoadingDef
                {
                    ...
                    HeatPerShot = 17, // Heat generated per shot.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Autocannon_Firesound", // Audio for firing.
            ...
            Ammos = new[] {
                Flak_Shell_Primary,
                Flak_Shell_Secondary,
                Flak_Shell_Shrapnel_Base,
                Flak_Shell_Shrapnel,
                Flak_Shell_Frag,
                NewFlakShell,
                NewFlakShell_Frag, // Must list all primary, shrapnel, and pattern ammos.
            },
