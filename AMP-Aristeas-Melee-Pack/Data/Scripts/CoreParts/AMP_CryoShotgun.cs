...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition AMP_CryoShotgun => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "AMP_CryoShotgun", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Cryogenic Shotgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                CryoDefault, // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = CryoAnimation,
