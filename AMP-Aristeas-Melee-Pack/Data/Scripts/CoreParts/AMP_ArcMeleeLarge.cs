...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition AMP_ArcMeleeLarge => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "AMP_ArcMeleeLarge", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Arc Lance", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    MaxHeat = 2400, // Max heat before weapon enters cooldown (70% of max heat).
            ...
            Ammos = new[] {
                ArcLong, // Must list all primary, shrapnel, and pattern ammos.
            },
