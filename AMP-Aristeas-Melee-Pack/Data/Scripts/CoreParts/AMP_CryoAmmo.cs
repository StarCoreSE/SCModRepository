...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef CryoDefault => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "CryoShotgun_Magazine", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Cryo Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 30f, //
                        Width = 1f, //
                        Color = Color(red: 25f, green: 50f, blue: 50f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
            ...
            Ejection = new EjectionDef // Optional Component, allows generation of Particle or Item (Typically magazine), on firing, to simulate Tank shell ejection
            {
                ...
                {
                    ItemName = "CryoShotgun_Magazine", //InventoryComponent name
        ...
        private AmmoDef CryoEwar => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "CryoShotgun_Magazine", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Cryo EWAR Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
