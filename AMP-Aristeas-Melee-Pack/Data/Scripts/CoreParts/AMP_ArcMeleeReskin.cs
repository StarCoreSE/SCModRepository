...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition AMP_ArcMeleeReskin => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "AMP_ArcMeleeReskin", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Arc Emitter", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "ArcMuzzle", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                ArcDefault, // Must list all primary, shrapnel, and pattern ammos.
            },
