...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition Starcore_M_Laser => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Starcore_M_Laser_Block", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Medium Laser", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "MedLaserFire", // Audio for firing.
