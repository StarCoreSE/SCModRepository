...
namespace Scripts {
    partial class Parts {
        ...
        WeaponDefinition E_Starcore_OPA_Light_Missile => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "OPA_Light_Missile", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "OPA Light Missile", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                E_Starcore_OPA_Light_Missile_Launch,
