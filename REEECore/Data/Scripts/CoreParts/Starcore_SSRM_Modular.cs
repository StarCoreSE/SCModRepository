...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition ModularSRM8 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ModularSRM8", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "SSRM-8", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                ...
                Starcore_SSRM_Launch,
                Starcore_SSRM_Acceleration,
                Starcore_SSRM_Detonation// Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = Starcore_SRM_Animation,
