...
{
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_Reactor), true, "LargeBlockLargeGenerator", "LargeBlockSmallGenerator")]
    public class MyReactorUpgradeLogic : MyGameLogicComponent   
    {
        ...
        public override void Init(MyObjectBuilder_EntityBase objectBuilder)
        {
            ...
            else if (m_reactor.BlockDefinition.SubtypeName == "LargeBlockSmallGenerator")
            {
