...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SC_Radome => new WeaponDefinition
        {
            ...
            {
                PartName = "Sauron Radome Unit", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
