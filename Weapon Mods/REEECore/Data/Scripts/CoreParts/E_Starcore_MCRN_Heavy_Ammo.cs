...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef E_Starcore_MCRN_Torpedo_Launch => new AmmoDef
        {
            AmmoMagazine = "MCRNHEAVYMAG", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "MCRN Heavy Torp Launch", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            ...
            {
                AmmoRound = "MCRN Heavy Torp Acceleration", // AmmoRound field of the ammo to spawn.
        ...
        private AmmoDef E_Starcore_MCRN_Torpedo_Acceleration => new AmmoDef
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "MCRN Heavy Torp Acceleration", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "MCRN Heavy Torp Frag", // AmmoRound field of the ammo to spawn.
        ...
        private AmmoDef E_Starcore_MCRN_Torpedo_Detonation => new AmmoDef
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "MCRN Heavy Torp Terminal", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
        ...
        private AmmoDef E_Starcore_MCRN_Torpedo_Detonation_Frag => new AmmoDef
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "MCRN Heavy Torp Frag", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.01f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
