...
{ // Don't edit above this line
    partial class Parts
    {
        private AnimationDef Starcore_Arrow_Single_Animation => new AnimationDef
        {
            ...
            AnimationSets = new[]
            {
               ...
               new PartAnimationSetDef()
                {
                    SubpartId = Names("Arrowhead"),
                    BarrelId = "Arrow_IV_Muzzle", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 60,
