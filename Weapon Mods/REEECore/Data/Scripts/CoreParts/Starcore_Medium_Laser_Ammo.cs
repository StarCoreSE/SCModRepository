...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Starcore_M_Laser_Ammo => new AmmoDef // StarCore AMS I
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Starcore Medium Laser", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.066f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 900f, // Direct damage; one steel plate is worth 100. 
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
            Health = 0, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 0, // Recoil.
            DecayPerShot = 0f, // Damage to the firing weapon itself.
            HardPointUsable = true, // Whether this is a primary ammo type fired directly by the turret. Set to false if this is a shrapnel ammoType and you don't want the turret to be able to select it directly.
            EnergyMagazineSize = 50, // For energy weapons, how many shots to fire before reloading.
            ...
            Pattern = new PatternDef
            {
                Patterns = new[] { // If enabled, set of multiple ammos to fire in order instead of the main ammo.
                    "",//"Starcore Medium Laser Fake",//"Starcore Medium Laser Fake","Starcore Medium Laser Fake","Starcore Medium Laser Fake",
                },
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 1, green: 12, blue: 1, alpha: 1),
                        Back = true,
                        CustomWidth = 1f,
        ...
        private AmmoDef Starcore_M_Laser_Ammo_Fake => new AmmoDef // StarCore AMS I
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Starcore Medium Laser Fake", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
