...
{ // Don't edit above this line
    partial class Parts
    {
        private AnimationDef Starcore_AMS_I_Animation => new AnimationDef
        {
            ...
            AnimationSets = new[]
            {
                ...
                {
                    SubpartId = Names("SC_AMS_I_Barrel"),
                    BarrelId = "SC_AMS_I_barrel_01", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 0,
                    ...
                    EventMoveSets = new Dictionary<PartAnimationSetDef.EventTriggers, RelMove[]>
                    {
                        ...
                        [Firing] =
                            new[]
                            {
                                new RelMove
                                {
                                    CenterEmpty = "SC_AMS_I_Barrel",
                                    TicksToMove = 36, //number of ticks to complete motion, 60 = 1 second
                                    MovementType = Linear,
