...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Starcore_ArmourLRM => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Starcore_MissileTube_LRM",
            ...
            {
                PartName = "Armour", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RateOfFire = 2, // Set this to 3600 for beam weapons.
