...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Starcore_Flare_Launch => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            Health = 50f, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            ...
            {
                AmmoRound = "FlarePulse", // AmmoRound field of the ammo to spawn.
            ...
            Ewar = new EwarDef
            {
                ...
                */
                ...
                Field = new FieldDef
                {
                    ...
                    TriggerRange = 4000f, //range at which fields are triggered
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                TargetLossTime = 10, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                Smarts = new SmartsDef
                {
                    ...
                    OffsetRatio = 0.26f, // The ratio to offset the random direction (0 to 1) 
                    OffsetMinRange = 50,
                    NoSteering = false,
                    FocusOnly = false,
                    ScanRange = 4500f,
                    OffsetTime = 33, // how often to offset degree, measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..)
        ...
        private AmmoDef Starcore_Flare_Acceleration => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "FlarePulse", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            Health = 250f, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                ...
                TimedSpawns = new TimedSpawnDef // disables FragOnEnd in favor of info specified below
                {
                    ...
                    GroupSize = 12, // Number of spawns in each group
            ...
            Ewar = new EwarDef
            {
                ...
                */
                ...
                Field = new FieldDef
                {
                    ...
                    PulseChance = 100, // Chance from 0 - 100 that an entity in the field will be hit by any given pulse.
                    GrowTime = 11, // How many ticks it should take the field to grow to full size.
                    HideModel = false, // Hide the projectile model if it has one.
                    ShowParticle = false, // Set to show block damage effect when ewared.
                    TriggerRange = 200f, //range at which fields are triggered
                    Particle = new ParticleDef // Particle effect to generate at the field's position.
                    {
                        Name = "", // SubtypeId of field particle effect.
                        Extras = new ParticleOptionDef
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxTrajectory = 3500, // Max Distance the projectile or beam can Travel.
                DeaccelTime = 0, // 0 is disabled, a value causes the projectile to come to rest overtime, (Measured in game ticks, 60 = 1 second)
                GravityMultiplier = 0f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable. Natural Gravity Only.
        ...
        private AmmoDef Starcore_Flare_Detonation => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "FlareCandy", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1f, // Direct damage; one steel plate is worth 100.
            Mass = 10f, // In kilograms; how much force the impact will apply to the target.
