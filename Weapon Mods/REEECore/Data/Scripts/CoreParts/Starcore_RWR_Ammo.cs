...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef RWR_P_Fake => new AmmoDef // StarCore AMS I
        {
            AmmoMagazine = "PainlessMag" , // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "RWR_P_Fake" , // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 0.1f , //
                        Width = 0.1f , //
                        Color = Color(red: 0 , green: 0 , blue: 0 , alpha: 0) , // RBG 255 is Neon Glowing, 100 is Quite Bright.
