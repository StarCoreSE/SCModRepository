...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition Starcore_PPC => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Starcore_PPC_Block", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "PPC_barrel_01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
            ...
            {
                PartName = "PPC", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    IdlePower = 75f, // Constant base power draw in MW.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "PPCFire", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "PPCRecharge", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "PPCMuzzleSparks", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                Starcore_PPC_Main,
                Starcore_PPC_Secondary,
                PPCFXshots,
                PPCFXshots2,
                PPCFXshots3,
                Starcore_PPC_Sparkly,
                PPCFXshots4,
