...
namespace Scripts {
    partial class Parts {
        ...
        WeaponDefinition SM3_Counter_Battery => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Counter_Battery", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "missileturretbarrels", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "missileturretbase1", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
            ...
            Targeting = new TargetingDef
            {
                ...
                MinTargetDistance = 650, // Minimum distance at which targets will be automatically shot at.
            ...
            {
                PartName = "SM-3 Torpedo", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 7f, // Projectile inaccuracy in degrees.
                AimingTolerance = 270f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 2400, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    ...
                    ShotsInBurst = 8, // Use this if you don't want the weapon to fire an entire physical magazine in one go. Should not be more than your magazine capacity.
