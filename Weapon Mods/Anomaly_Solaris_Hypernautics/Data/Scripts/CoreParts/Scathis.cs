...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Scathis => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ScathisM77", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Scope = "metal_camera", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "Scathis M-77", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    Cooldown = 0.01f, // Percentage of max heat to be under to start firing again after overheat; accepts 0 - 0.95
                    HeatSinkRate = 61, // Amount of heat lost per second.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "metalstorm", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "metalstormreload", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "Muzzle_Flash_MetalStorm", // SubtypeId of muzzle particle effect.
