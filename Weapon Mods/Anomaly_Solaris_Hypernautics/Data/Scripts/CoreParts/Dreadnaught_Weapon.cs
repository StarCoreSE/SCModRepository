...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Dreadnaught_Beacon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Dreadnaught_Beacon", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Dreadnaught", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Dreadnaught_Arrival", // Audio for firing.
            ...
            Ammos = new[] {
                Launch_Dummy_Dreadnaught,
                Dreadnaught,
                Light_Turbolaser_Dreadnaught,
                Light_Turbolaser_2_Dreadnaught,
                Light_Turboion_Dreadnaught,// Must list all primary, shrapnel, and pattern ammos.
            },
