...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Auger3_Internal_Turret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Meson3_Turret",
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "Meson3_Elevation", // The subpart where your muzzle empties are located.
                        AzimuthPartId = "Meson3_Azimuth",
                        ElevationPartId = "Meson3_Elevation",
            ...
            {
                PartName = "AugerS3", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                Meson_Medium_Round, //Nariman_EWAR_Round,  Must list all primary, shrapnel, and pattern ammos.
            },
