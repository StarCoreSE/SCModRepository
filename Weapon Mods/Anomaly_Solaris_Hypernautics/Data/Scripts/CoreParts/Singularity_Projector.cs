...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Point_Singularity_Projector => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "PSP", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Point Singularity Projector", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    HeatPerShot = 7200, // Heat generated per shot.
                ...
                {
                    PreFiringSound = "caution", // Audio for warmup effect.
                    FiringSound = "gapsfx", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "EXPLODETHESUN1", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                ...
                SubterraneanSun,
                SubterraneanSunStage2,
                SubterraneanSunStage2SuccParticleInvis,
                SubterraneanSunStage2SuccParticleVisible,
                SubterraneanSunStage2EWARTimespawn,
                SubterraneanSunStage2EWARPattern,
