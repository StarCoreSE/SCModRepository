...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Nebulon_Beacon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Nebulon_Beacon", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "muzzle_Dreadnaught", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
            ...
            {
                PartName = "Nebulon-B", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "NebulonB_Arrival", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "BeaconWarpFlash", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                Launch_Dummy_Nebulon,
                Nebulon,
                Light_Turbolaser_Nebulon,
                Blank_Round_Neb,
                Concussion_Missile_Nebulon,// Must list all primary, shrapnel, and pattern ammos.
            },
