...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Auger5_Internal_Turret => new WeaponDefinition
        {
            ...
            {
                PartName = "AugerS5", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
