...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Meatball_Center => new WeaponDefinition
        {
            ...
            {
                PartName = "Meatball", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                MA_Meatball_Ammo, // Must list all primary, shrapnel, and pattern ammos.
            },
        ...
        WeaponDefinition Meatball_Left => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "MA_Meatball",
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "Part3", // The subpart where your muzzle empties are located.
                        AzimuthPartId = "Base4",
            ...
            HardPoint = new HardPointDef
            {
                PartName = "Meatball Left Side", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 1.8f, // Projectile inaccuracy in degrees.
                AimingTolerance = 0.3f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                AimLeadingPrediction = Advanced, // Level of turret aim prediction; Off, Basic, Accurate, Advanced
                DelayCeaseFire = 0, // Measured in game ticks (6 = 100ms, 60 = 1 second, etc..). Length of time the weapon continues firing after trigger is released.
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 120, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    MagsToLoad = 1, // Number of physical magazines to consume on reload.
                    DelayUntilFire = 31, // How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    HeatPerShot = 10, // Heat generated per shot.
                    MaxHeat = 1000, // Max heat before weapon enters cooldown (70% of max heat).
                    Cooldown = .8f, // Percentage of max heat to be under to start firing again after overheat; accepts 0 - 0.95
                    HeatSinkRate = 40, // Amount of heat lost per second.
        ...
        WeaponDefinition Meatball_Right => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                PartName = "Meatball Right Side", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 1.8f, // Projectile inaccuracy in degrees.
                AimingTolerance = 0.3f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                AimLeadingPrediction = Advanced, // Level of turret aim prediction; Off, Basic, Accurate, Advanced
                DelayCeaseFire = 0, // Measured in game ticks (6 = 100ms, 60 = 1 second, etc..). Length of time the weapon continues firing after trigger is released.
