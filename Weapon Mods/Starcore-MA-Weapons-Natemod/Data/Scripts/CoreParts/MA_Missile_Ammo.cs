...
//MA_Missile
		private AmmoDef MA_Missile => new AmmoDef  //derecho launch stage 1
        {
            AmmoMagazine = "MA_Missile", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "MA_Missile", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            ...
            BaseDamage = 1f, //500 Direct damage; one steel plate is worth 100.
            ...
            {
                AmmoRound = "MA_Missile_Stage2", // AmmoRound field of the ammo to spawn.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 40, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). Please have a value for this, It stops Bad things.
                ...
                SpeedVariance = Random(start: -100, end: 150), // subtracts value from DesiredSpeed. Be warned, you can make your projectile go backwards.
            ...
            {
                ModelName = "\\Models\\Ammo\\MA_Missile_Ammo.mwm",
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 3f,
                        Width = 0.1f,
                        Color = Color(red: .5f, green: 7f, blue: 15f, alpha: 1),
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 20,
                        Color = Color(red: 1.5f, green: 1.5f, blue: 4.1f, alpha: .4f),
                        Back = false,
                        CustomWidth = 0.1f,
...
//MA_Missile_Stage2
        private AmmoDef MA_Missile_Stage2 => new AmmoDef  //derecho Stage 2
        {
            ...
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 6000f, //500 Direct damage; one steel plate is worth 100.
            Mass = 1f, // In kilograms; how much force the impact will apply to the target.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                Smarts = new SmartsDef
                {
                    ...
                    MaxLateralThrust = 20, // controls how sharp the trajectile may turn
                    TrackingDelay = 0, // Measured in Shape diameter units traveled.
                    MaxChaseTime = 0, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    OverideTarget = false, // when set to true ammo picks its own target, does not use hardpoint's.
                    MaxTargets = 0, // Number of targets allowed before ending, 0 = unlimited
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 4f,
                        Width = 0.1f,
                        Color = Color(red: 1, green: 15, blue: 30f, alpha: 1),
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "ProjectileTrailLine",
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 60,
                        Color = Color(red: 2f, green: 2f, blue: 10f, alpha: .3f),
                        Back = false,
                        CustomWidth = 0.1f,
                        UseWidthVariance = true,
                        UseColorFade = true,
