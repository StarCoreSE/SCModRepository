...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HakkeroBeam => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "HakkeroBeam", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Arcane Octagon (Beam)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    MaxHeat = 36000, // Max heat before weapon enters cooldown (70% of max heat).
                ...
                {
                    PreFiringSound = "powerup2", // Audio for warmup effect.
                    FiringSound = "mspark", // Audio for firing.
            ...
            Ammos = new[] {
                HakkeroMSBeam,  // Must list all primary, shrapnel, and pattern ammos.
                HakkeroHealBeam,
                HakkeroSprayBeamStage0Dummy,
                HakkeroSprayBeamStage1Beam,
                HakkeroSprayBeamStage2Smart,
                HakkeroSprayBeamStage3Final,
                HakkeroSentryBeamDummy,
                HakkeroSentryBeamStage1,
                HakkeroSentryBeamStage2Smart,
                HakkeroSentryBeamStage3Sentrywep,
        ...
        // Don't edit above this line
        WeaponDefinition HakkeroBeamMini => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "HakkeroBeamMini", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "GatlingBarrel", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "None", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "None", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "None",// Your Elevating Subpart, that bit that moves up.
            ...
            HardPoint = new HardPointDef
            {
                PartName = "Arcane Octagon Compact (Beam)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0f, // Projectile inaccuracy in degrees.
                AimingTolerance = 360f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                AimLeadingPrediction = Off, // Level of turret aim prediction; Off, Basic, Accurate, Advanced
                DelayCeaseFire = 0, // Measured in game ticks (6 = 100ms, 60 = 1 second, etc..). Length of time the weapon continues firing after trigger is released - while a target is available.
