...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Light_Autocannon_Fixed_Bullet_Primary => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "60mmFLAC1Ammo", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "60mm HE Shell", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            EnergyMagazineSize = 60, // For energy weapons, how many shots to fire before reloading.
            ...
            Pattern = new PatternDef
            {
                Patterns = new[] { // If enabled, set of multiple ammos to fire in order instead of the main ammo.
                    "Phantom_Primary","Phantom_Primary"
                },
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = false,
                    ParticleScale = 1,
                    CustomParticle = "HE_Shell_Impact", // Particle SubtypeID, from your Particle SBC
        ...
        private AmmoDef Light_Autocannon_Fixed_Bullet_Secondary => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "60mmFLAC2Ammo", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "60mm AP Shell", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.10f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 8250f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
            Health = 0, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 400f, // Recoil. This is applied to the Parent Grid.
            DecayPerShot = 0f, // Damage to the firing weapon itself.
            ...
            {
                Patterns = new[] { // If enabled, set of multiple ammos to fire in order instead of the main ammo.
                    "Phantom_Secondary","Phantom_Secondary"
                },
                Mode = Weapon, // Select when to activate this pattern, options: Never, Weapon, Fragment, Both 
                TriggerChance = 100f, // This is %
                Random = false, // This randomizes the number spawned at once, NOT the list order.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = false,
                    ParticleScale = 1,
                    CustomParticle = "PDC_Explosion", // Particle SubtypeID, from your Particle SBC
                    CustomSound = "", // SubtypeID from your Audio SBC, not a filename
                    Shape = Diamond, // Round or Diamond shape.  Diamond is more performance friendly.
                },
            },
        ...
        private AmmoDef Light_Phantom_Primary => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
        ...
        private AmmoDef Light_Phantom_Secondary => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
