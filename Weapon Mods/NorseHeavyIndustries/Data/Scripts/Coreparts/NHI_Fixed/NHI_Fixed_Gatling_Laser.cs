...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition NHI_Fixed_Gatling_Laser => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NHI_Fixed_Gatling_Laser", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Scope = "muzzle_laser_01", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "Laser Gatling Fixed", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    MaxHeat = 1260, // Max heat before weapon enters cooldown (70% of max heat).
                    Cooldown = .85f, // Percentage of max heat to be under to start firing again after overheat; accepts 0 - 0.95
            ...
            Ammos = new[] {
                GatLasPulse2,
                GatLasPulse3, // Must list all primary, shrapnel, and pattern ammos.
            },
