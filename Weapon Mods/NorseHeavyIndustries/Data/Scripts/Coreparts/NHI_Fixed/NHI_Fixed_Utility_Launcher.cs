...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition NHI_Fixed_Utility_Launcher => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NHI_Fixed_Utility_Launcher", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "muzzle_torpedo_1", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            Targeting = new TargetingDef
            {
                ...
                MinTargetDistance = 300, // Minimum distance at which targets will be automatically shot at.
            ...
            {
                PartName = "'Loki' Utility Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RateOfFire = 8, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                    BarrelsPerShot = 1, // How many muzzles will fire a projectile per fire event.
                    TrajectilesPerBarrel = 1, // Number of projectiles per muzzle per fire event.
                    SkipBarrels = 0, // Number of muzzles to skip after each fire event.
                    ReloadTime = 1600, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
            ...
            Ammos = new[] {
                Vortex_Torpedo,
                Vortex_Effect, // Must list all primary, shrapnel, and pattern ammos.
            },
