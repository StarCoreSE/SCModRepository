...
namespace Scripts {
    partial class Parts {
        ...
        WeaponDefinition NHI_Fixed_Torpedo_Launcher => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NHI_Fixed_Torpedo_Launcher", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "muzzle_torpedo_01" // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                    
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "muzzle_torpedo_01", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "Horizon Torpedo", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 6f, // Inventory capacity in kL.
                    ...
                    CriticalReaction = new CriticalDef
                    {
                        ...
                        AmmoRound = "Odin_Torpedo_Primary", // Optional. If specified, the warhead will always use this ammo on detonation rather than the currently selected ammo.
                    },
                },
                Other = new OtherDef
                {
                ...
                Loading = new LoadingDef
                {
                    ...
                    MaxHeat = 900, // Max heat before weapon enters cooldown (70% of max heat).
                    ...
                    DelayAfterBurst = 1500, // How long to spend "reloading" after each burst. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
            ...
            Ammos = new[] {
               Mine_Launch,
               Mine_Static  // Must list all primary, shrapnel, and pattern ammos.
            },
