...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition EXP_Spinal_Ion_Cannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "EXP_Spinal_Ion_Cannon", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "muzzle_ion_beam", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
            ...
            Targeting = new TargetingDef
            {
                ...
                SubSystems = new[] {
                    Utility, Offense, Power, Any, // Subsystem targeting priority: Offense, Utility, Power, Production, Thrust, Jumping, Steering, Any
                },
            ...
            HardPoint = new HardPointDef
            {
                ...
                HardWare = new HardwareDef
                {
                    ...
                    ElevateRate = 11f, // Max traversal speed of elevation subpart in radians per tick.
                    MinAzimuth = -180,
                    MaxAzimuth = 180,
                    MinElevation = -10,
                    MaxElevation = 90,
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "Ion_Beam_Flash", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                Ion_Beam, // Must list all primary, shrapnel, and pattern ammos.
            },
