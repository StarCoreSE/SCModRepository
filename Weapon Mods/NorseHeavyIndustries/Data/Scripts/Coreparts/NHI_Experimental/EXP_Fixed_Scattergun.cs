...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition EXP_Fixed_Scattergun => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "EXP_Fixed_Scattergun", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    ...
                    "muzzle_projectile_02",
                    "muzzle_projectile_03",
                    "muzzle_projectile_04",
                    "muzzle_projectile_05",
                    "muzzle_projectile_06",
                    "muzzle_projectile_07",
                    "muzzle_projectile_08",
                    "muzzle_projectile_09",
                    "muzzle_projectile_010",
                    "muzzle_projectile_011",
                    "muzzle_projectile_012",// Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
            ...
            {
                PartName = "Scattergun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    BarrelsPerShot = 12, // How many muzzles will fire a projectile per fire event.
                    ...
                    HeatSinkRate = 1250, // Amount of heat lost per second.
                    DegradeRof = false, // Progressively lower rate of fire when over 80% heat threshold (80% of max heat).
                    ShotsInBurst = 12, // Use this if you don't want the weapon to fire an entire physical magazine in one go. Should not be more than your magazine capacity.
            ...
            Ammos = new[] {
                Scattergun_Shot, // Must list all primary, shrapnel, and pattern ammos.
                Scattergun_Shot_2,
                Scattergun_Sabot,
            },
