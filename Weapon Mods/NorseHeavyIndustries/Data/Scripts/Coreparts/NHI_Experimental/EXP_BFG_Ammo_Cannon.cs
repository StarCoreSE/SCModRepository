...
namespace Scripts {
    partial class Parts {
        ...
        WeaponDefinition EXP_BFG_Ammo_Cannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "EXP_BFG_Ammo_Cannon", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "BFG_Muzzle_01" // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
            ...
            Targeting = new TargetingDef
            {
                ...
                MinTargetDistance = 2500, // Minimum distance at which targets will be automatically shot at.
            ...
            {
                PartName = "BFG-Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 12f, // Inventory capacity in kL.
                    ...
                    CriticalReaction = new CriticalDef
                    {
                        ...
                        AmmoRound = "BFG_Cannon_Primary", // Optional. If specified, the warhead will always use this ammo on detonation rather than the currently selected ammo.
                    },
                },
                Other = new OtherDef
                {
            ...
            Ammos = new[] {
                BFG_Cannon_Primary,// Must list all primary, shrapnel, and pattern ammos.
                BFG_Cannon_Frag,
            },
