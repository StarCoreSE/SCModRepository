...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition SC_COV_Plasma_Turret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "SC_COV_Plasma_Turret", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "muzzle_plasma", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
            ...
            {
                PartName = "Plasma", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                Plasma_Beam_COV, // Must list all primary, shrapnel, and pattern ammos.
            },
