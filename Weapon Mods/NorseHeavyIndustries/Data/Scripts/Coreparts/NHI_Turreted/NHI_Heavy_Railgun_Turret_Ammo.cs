...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Railgun_Bullet_Primary => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "150mmRGAmmo", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Odin_Railgun_Slug", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            Mass = 750f, // In kilograms; how much force the impact will apply to the target.
            ...
            {
                AmmoRound = "Odin_Railgun_Frag", // AmmoRound field of the ammo to spawn.
                ...
                Offset = -1.75f, // Offsets the fragment spawn by this amount, in meters (positive forward, negative for backwards), value is read from parent ammo type.
            ...
            Pattern = new PatternDef
            {
                Patterns = new[] { // If enabled, set of multiple ammos to fire in order instead of the main ammo.
                    "Odin_Railgun_VFX1","Odin_Railgun_VFX2",
                },
                Mode = Weapon, // Select when to activate this pattern, options: Never, Weapon, Fragment, Both 
                TriggerChance = 1f, // This is % from 0-1f, (0-100%), do not enter a value greater than 1, it will default to 1.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                GravityMultiplier = 30f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable. Natural Gravity Only.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 5f, //
                        Width = 1f, //
                        Color = Color(red: 2.8f, green: 1f, blue: 5.5f, alpha: 1f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How maney ticks after fade began before it will be invisible.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 2.8f, green: 1f, blue: 5.5f, alpha: 1f),
                        Back = false,
                        CustomWidth = 1,
        ...
        private AmmoDef Odin_Railgun_Fragment => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Odin_Railgun_Frag", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f, //
                        Width = 0.25f, //
                        Color = Color(red: 5f, green: 4f, blue: 2f, alpha: 1f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 3, // How maney ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "WeaponLaser", // Please always have this Line set, if this Section is enabled.
                        },
                        TextureMode = Normal, // Normal, Cycle, Chaos, Wave
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 15, // In Ticks. 1 = 1 Additional Tracer generated per motion, 33 is 33 lines drawn per projectile. Keep this number low.
                        Color = Color(red: 5f, green: 4f, blue: 2f, alpha: 1f),
                        Back = false,
                        CustomWidth = 0.25f,
                        UseWidthVariance = false,
                        UseColorFade = false,
        ...
        private AmmoDef Odin_Railgun_Ammo_VFX1 => new AmmoDef
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Odin_Railgun_VFX1", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 15f, //
                        Width = .25f, //
                        Color = Color(red: 4.4f, green: 4.4f, blue: 2.75f, alpha: 0.2f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 4.4f, green: 4.4f, blue: 2.75f, alpha: 0.2f),
                        Back = false,
                        CustomWidth = 0.25f,
                        UseWidthVariance = false,
                        UseColorFade = false,
        ...
        private AmmoDef Odin_Railgun_Ammo_VFX2 => new AmmoDef
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Odin_Railgun_VFX2", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ColorVariance = Random(start: 6f, end: 0f), // multiply the color by random values within range.
                    WidthVariance = Random(start: 0f, end: 0f), // adds random value to default width (negatives shrinks width)
                    Tracer = new TracerBaseDef
                    {
                        Enable = true,
                        Length = 5f, //
                        Width = 0.25f, //
                        Color = Color(red: 6f, green: 6f, blue: 2.4f, alpha: 0.2f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "ProjectileTrailLine", // Please always have this Line set, if this Section is enabled.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 6f, green: 6f, blue: 2.4f, alpha: 0.2f),
                        Back = false,
                        CustomWidth = 0.25f,
                        UseWidthVariance = false,
                        UseColorFade = false,
