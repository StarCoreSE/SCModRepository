...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition NHI_Heavy_Gun_Turret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NHI_Heavy_Gun_Turret", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "'Gungir' Heavy Gun Turret", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Gugnir_Firesound", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "Gugnir_Reload", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "BC_Muzzleflash_2", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                ...
                ThumperShell_Frag,
                ThumperFlareShell,
                ThumperFlareShell_Frag,
                ThumperFlareShell_Flare,// Must list all primary, shrapnel, and pattern ammos.
            },
