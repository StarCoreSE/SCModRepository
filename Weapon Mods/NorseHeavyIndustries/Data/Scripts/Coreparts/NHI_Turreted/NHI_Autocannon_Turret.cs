...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition NHI_Autocannon_Turret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NHI_Autocannon_Turret", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "muzzle_missile_01",
                    "muzzle_missile_02"// Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A

                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "autocannon_scope_01", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "Aesir Autocannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    IdlePower = 0.06f, // Constant base power draw in MW.
                    ...
                    CriticalReaction = new CriticalDef
                    {
                        ...
                        AmmoRound = "Autocannon_Bullet_Primary", // Optional. If specified, the warhead will always use this ammo on detonation rather than the currently selected ammo.
                    },
                },
                Other = new OtherDef
                {
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Auto_Fire_Test", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "NHI_Autocannon_Muzzleflash", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                Autocannon_Bullet_Tertiary, // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = NHI_Autocannon_Recoil_Anim,
