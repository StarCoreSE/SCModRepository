...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition NHI_Mk1_Cannon_Turret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NHI_Mk1_Cannon_Turret", // Block Subtypeid. Your Cubeblocks contain this information
                    ...
                    new MountPointDef {
                        SubtypeId = "NHI_Mk1_Cannon_Surface_Turret", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "MissileTurretBarrels", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "MissileTurretBase1", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "MissileTurretBarrels",// Your Elevating Subpart, that bit that moves up.
                ...
                Muzzles = new[] {
                    "muzzle_cannon_01",// Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "muzzle_cannon_01", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "Mk1 Battleship Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 0.68f, // Inventory capacity in kL.
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 270, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
            ...
            Ammos = new[] {
                BC3Shell,
                BC3Shell_Frag,
                BC3APShell,// Must list all primary, shrapnel, and pattern ammos.
            },
