...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition NHI_Light_Autocannon_Turret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NHI_Light_Autocannon_Turret", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "muzzle_defense_001" // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A

                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "muzzle_defense_001", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "Defense Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0.18f, // Projectile inaccuracy in degrees.
                ...
                HardWare = new HardwareDef
                {
                    ...
                    CriticalReaction = new CriticalDef
                    {
                        ...
                        AmmoRound = "Defense_Bullet_Primary", // Optional. If specified, the warhead will always use this ammo on detonation rather than the currently selected ammo.
                    },
                },
                Other = new OtherDef
                {
                ...
                {
                    RateOfFire = 140, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                    ...
                    DelayAfterBurst = 45, // How long to spend "reloading" after each burst. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "DefenseFiresound", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
                    HardPointRotationSound = "NWIWepTurretHelpImGettingRotated", // Audio played when turret is moving.
                    BarrelRotationSound = "",
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "BrightFlash", // SubtypeId of muzzle particle effect.
                        Color = Color(red: 15, green: 2, blue: 1, alpha: 1), // Deprecated, set color in particle sbc.
                        Offset = Vector(x: 0, y: 0, z: 0), // Offsets the effect from the muzzle empty.
                        Extras = new ParticleOptionDef
                        {
                            Loop = false, // Set this to the same as in the particle sbc!
                            Restart = false, // Whether to end a looping effect instantly when firing stops.
                            MaxDistance = 200, // Max distance at which this effect should be visible. NOTE: This will use whichever MaxDistance value is higher across Effect1 and Effect2!
                            MaxDuration = 2, // How many ticks the effect should be ended after, if it's still running.
            ...
            Ammos = new[] {
                Defense_Bullet_Primary, // Must list all primary, shrapnel, and pattern ammos.
            },
