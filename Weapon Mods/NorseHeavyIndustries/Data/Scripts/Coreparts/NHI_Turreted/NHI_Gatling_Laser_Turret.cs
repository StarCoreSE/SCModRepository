...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition NHI_Gatling_Laser_Turret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NHI_Gatling_Laser_Turret", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "GatlingTurretBarrels", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "GatlingTurretBase2", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                ...
                Muzzles = new[] {
                    "muzzle_laser_01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            {
                PartName = "Laser Gatling", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0.1f, // Projectile inaccuracy in degrees.
                AimingTolerance = 8f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 660, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    MagsToLoad = 1, // Number of physical magazines to consume on reload.
                    DelayUntilFire = 25, // How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    ...
                    DelayAfterBurst = 3, // How long to spend "reloading" after each burst. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Gatling_Laser_Firesound", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "Gatling_Laser_Charge", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "NHI_Laser_Flash", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                GatLasPulse, // Must list all primary, shrapnel, and pattern ammos.
            },
