...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HAS_Crossfield => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        ...
                        MuzzlePartId = "Elevation One", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "Azimuth One", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "Elevation One",// Your Elevating Subpart, that bit that moves up
                ...
                Muzzles = new[] {
                    "Barrel01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "Barrel01", // Where line of sight checks are performed from. Must be clear of block collision.
            },
