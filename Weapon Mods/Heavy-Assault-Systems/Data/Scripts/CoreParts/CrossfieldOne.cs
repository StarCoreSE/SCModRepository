...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HAS_CrossfieldOne => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        ...
                        MuzzlePartId = "Elevation Two", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "Azimuth Two", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "Elevation Two",// Your Elevating Subpart, that bit that moves up
                ...
                Muzzles = new[] {
                    "Barrel02", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "Barrel02", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            HardPoint = new HardPointDef
            {
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "HAS_CrossfieldCrackle", // Audio for firing.
