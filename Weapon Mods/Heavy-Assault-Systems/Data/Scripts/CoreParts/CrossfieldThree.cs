...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HAS_CrossfieldThree => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        ...
                        MuzzlePartId = "Elevation Four", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "Azimuth Four", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "Elevation Four",// Your Elevating Subpart, that bit that moves up
