...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HAS_Esper => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "HAS_Esper", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "TigtoneBarrel", // For weapons with a spinning barrel such as Gatling Guns.
                ...
                Muzzles = new[] {
                    "TigtoneMuzzle",// Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "TigtoneMuzzle", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "Tigtone", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RotateRate = 0.5f, // Max traversal speed of azimuth subpart in radians per tick (0.1 is approximately 360 degrees per second).
                    ElevateRate = 0.5f, // Max traversal speed of elevation subpart in radians per tick.
                    MinAzimuth = 0,
                    MaxAzimuth = 0,
                    MinElevation = 0,
                    MaxElevation = 0,
                    ...
                    IdlePower = 0.1f, // Constant base power draw in MW.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "HAS_TigtoneFire", // Audio for firing.
                    FiringSoundPerShot = false, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "HAS_Tigtone_Reload", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "EsperFire5", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                HAS_Esper_Ammo,
                HAS_Esper_Stage2_Ammo,// Must list all primary, shrapnel, and pattern ammos.
            },
