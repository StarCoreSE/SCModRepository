...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition MacroTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "MacroTurret", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "MacroTurretElevation", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "MacroTurretAzimuth", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "MacroTurretElevation",// Your Elevating Subpart, that bit that moves up
                ...
                Muzzles = new[] {
                    "muzzle1",
                    "muzzle2", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            {
                PartName = "Macro Cannon Turret", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RotateRate = 0.0045f, // Max traversal speed of azimuth subpart in radians per tick (0.1 is approximately 360 degrees per second).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    ReloadSound = "MacroReloadTwo", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
