...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition LanceLightBattery => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "LanceLightBattery", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "LanceLightElevation", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "LanceLightAzimuth", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "LanceLightElevation",// Your Elevating Subpart, that bit that moves up
            ...
            {
                PartName = "Light Lance Battery", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 870, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
            ...
            Ammos = new[] {
                LanceLightAmmo, // Must list all primary, shrapnel, and pattern ammos.
            },
