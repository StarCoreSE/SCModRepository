...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FixedLance => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "FixedLance", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Fixed Lance", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    MaxHeat = 18, // Max heat before weapon enters cooldown (70% of max heat).
            ...
            Ammos = new[] {
                LanceFixedAmmo,  // Must list all primary, shrapnel, and pattern ammos.
            },
