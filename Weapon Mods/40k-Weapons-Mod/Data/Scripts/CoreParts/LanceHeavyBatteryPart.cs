...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition LanceHeavyBattery => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "LanceHeavyBattery", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "LanceHeavyElevation", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "LanceHeavyAzimuth", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "LanceHeavyElevation",// Your Elevating Subpart, that bit that moves up
                ...
                Muzzles = new[] {
                    ...
                    "muzzle3",
                    "muzzle4",
                    "muzzle5", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            HardPoint = new HardPointDef
            {
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 915, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "LanceFire", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "Lance_Muzzle_Flash", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                LanceHeavyAmmo, // Must list all primary, shrapnel, and pattern ammos.
            },
