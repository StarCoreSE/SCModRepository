    ...
    partial class Parts {
        ...
        WeaponDefinition NovaCannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NovaCannon", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Nova Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                NovaAmmo1, NovaPlas1, NovaGrav1, NovaGrav2, NovaGrav3, NovaFrag, NovaFragFrag, NovaWarning,  // Must list all primary, shrapnel, and pattern ammos.
            },
