...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition MacroHeavyTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "MacroHeavyTurret", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "MacroHeavyTurretElevation", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "MacroHeavyTurretAzimuth", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "MacroHeavyTurretElevation",// Your Elevating Subpart, that bit that moves up
                ...
                Muzzles = new[] {
                    "muzzle1",
                    "muzzle2",
                    "muzzle3", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "muzzle2", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "Heavy Macro Cannon Turret", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RotateRate = 0.0035f, // Max traversal speed of azimuth subpart in radians per tick (0.1 is approximately 360 degrees per second).
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 930, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "HeavyMacroFire", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "MacroReloadThree", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
            ...
            Ammos = new[] {
                MacroCannonAmmo, // Must list all primary, shrapnel, and pattern ammos.
            },
