...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition LanceBattery => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "LanceBattery", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "LanceElevation", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "LanceAzimuth", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "LanceElevation",// Your Elevating Subpart, that bit that moves up
            ...
            Ammos = new[] {
                LanceAmmo, // Must list all primary, shrapnel, and pattern ammos.
            },
