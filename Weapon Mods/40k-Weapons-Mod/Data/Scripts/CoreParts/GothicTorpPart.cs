...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition GothicTorp => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "GothicTorp", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "[40k] Gothic Torpedo", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 2800, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "GothicTorpFire", // Audio for firing.
