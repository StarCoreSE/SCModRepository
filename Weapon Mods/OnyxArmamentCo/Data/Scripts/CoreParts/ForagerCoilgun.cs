...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SC_AR_Forager => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "SC_AR_Forager", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Forager 405mm Coilgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "ArcWepShipOnyxLightCoilgunFire", // Audio for firing.
