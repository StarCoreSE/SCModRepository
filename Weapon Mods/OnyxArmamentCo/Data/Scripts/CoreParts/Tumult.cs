...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SC_AR_Tumult => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "SC_AR_Tumult", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Tumult", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "TempestFiresound_01", // Audio for firing.
