...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef KineticBatteryBeam => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            EnergyCost = 1.2f, //630@1.2 //315MW@0.6 Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ByBlockHit = new ByBlockHitDef
                {
                    ...
                    MaxAbsorb = 1500f, // Soft cutoff for damage, except for pooled falloff.  If pooled falloff, limits max damage per block.
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    CustomSound = "VindicatorHit", // SubtypeID from your Audio SBC, not a filename
                    Shape = Diamond, // Round or Diamond shape.  Diamond is more performance friendly.
                },
            },
            Ewar = new EwarDef
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                RangeVariance = Random(start: 990, end: 1000), // subtracts value from MaxTrajectory
