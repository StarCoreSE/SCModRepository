...
{ // Don't edit above this line
    ...
    {
        // Type HE Shell
        private AmmoDef Standard_Fast_HighCapacity_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "C_Type_Magazine", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Standard Fast High Capacity Shell", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
