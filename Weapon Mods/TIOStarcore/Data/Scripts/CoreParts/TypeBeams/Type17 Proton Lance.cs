...
namespace Scripts {   
    partial class Parts {
       ...
       WeaponDefinition ParticleLance_Type17 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Type17_BeamLance", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Type 17 Kodiak Particle Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
