...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AdvancedCannon_Type21 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        ...
                        MuzzlePartId = "MK2_Barrels", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "MK2_AZ", // Your Rotating Subpart, the bit that moves sideways
            ...
            HardPoint = new HardPointDef
            {
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 675, //11.25 seconds Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    ...
                    DelayAfterBurst = 222, //190 How long to spend "reloading" after each burst. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
