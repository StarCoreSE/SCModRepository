...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition DualBarrelArtillery => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "DualBarrelArtillery", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "dualartyelev", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "dualartyazim", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "dualartyelev",// Your Elevating Subpart, that bit that moves up.
            ...
            {
                PartName = "Callisto Long Ranged Flak", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RateOfFire = 82, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                    BarrelsPerShot = 2, // How many muzzles will fire a projectile per fire event.
                    TrajectilesPerBarrel = 20, // Number of projectiles per muzzle per fire event.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "NewMediumCalibreShot", //MyLargeCalibreShot Audio for firing.
            ...
            Ammos = new[] {
                MediumCalibreSalvoAmmo,
                 // BoforFlak_Ammo, Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = DualArtyAnim,
