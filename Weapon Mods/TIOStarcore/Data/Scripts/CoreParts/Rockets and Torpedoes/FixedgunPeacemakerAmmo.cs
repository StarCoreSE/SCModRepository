...
{ // Don't edit above this line
        ...
        private AmmoDef UnguidedHeavyRockets => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Armor = new ArmorDef
                {
                    ...
                    NonArmor = -1f, //0.4 Multiplier for damage against every else.
                },
                    ...
                    Types = new[] // List of blocks to apply custom damage multipliers to.
    {
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                SpeedVariance = Random(start: -300, end: 300), // subtracts value from DesiredSpeed. Be warned, you can make your projectile go backwards.
