...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HeavyTorpedo_Trident => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        ...
                        ElevationPartId = "TorpReaperElevationn",// Your Elevating Subpart, that bit that moves up
            ...
            Targeting = new TargetingDef
            {
                ...
                SubSystems = new[] {
                    Offense, Power, Thrust, Utility, Production, Any, // Subsystem targeting priority: Offense, Utility, Power, Production, Thrust, Jumping, Steering, Any
                },
            ...
            HardPoint = new HardPointDef
            {
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 16f, // Inventory capacity in kL.
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 1770, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
