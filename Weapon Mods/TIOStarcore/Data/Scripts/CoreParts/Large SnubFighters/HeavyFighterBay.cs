...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HeavyFighterBay => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "HeavyFighterBay", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                Threats = new[] {
                    Projectiles, Grids, Meteors, Neutrals, // Types of threat to engage: Grids, Projectiles, Characters, Meteors, Neutrals, ScanRoid, ScanPlanet, ScanFriendlyCharacter, ScanFriendlyGrid, ScanEnemyCharacter, ScanEnemyGrid, ScanNeutralCharacter, ScanNeutralGrid, ScanUnOwnedGrid, ScanOwnersGrid
                },
                SubSystems = new[] {
            ...
            {
                PartName = "Phoenix Snubfighter", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    HeatPerShot = 160, // Heat generated per shot.
                    MaxHeat = 150, // Max heat before weapon enters cooldown (70% of max heat).
                    Cooldown = 0.10f, // Percentage of max heat to be under to start firing again after overheat; accepts 0 - 0.95
            ...
            Ammos = new[] {
                Heavy_Fighter_Main,
                Heavy_Fighter_Laser,
                taiidan_interceptor_debris_Parent,
                taiidan_interceptor_debris1,
                taiidan_interceptor_debris2,
                taiidan_interceptor_debris3,
                taiidan_interceptor_debris4,
            },

            Animations = Plane_Animation1,
