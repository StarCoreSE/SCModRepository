    ...
    partial class Parts
    {
        ...
        private AmmoDef taiidan_interceptor_debris_Parent => new AmmoDef
        {
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = false,
                    ParticleScale = 3,
                    CustomParticle = "Reactor_Explosion_Particle", // Particle SubtypeID, from your Particle SBC
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                RangeVariance = Random(start: -60, end: 10), // subtracts value from MaxTrajectory
            ...
            {
                ModelName = "\\Models\\Taiidan_Interceptor",
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    {
                        Name = "Fighter_OofOwie", //ShipWelderArc
        ...
        private AmmoDef taiidan_interceptor_debris1 => new AmmoDef
        {
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                RangeVariance = Random(start: -350, end: 110), // subtracts value from MaxTrajectory
                MaxTrajectoryTime = 0, // How long the weapon must fire before it reaches MaxTrajectory.
                TotalAcceleration = 0, // 0 means no limit, something to do due with a thing called delta and something called v.
            },
            AmmoGraphics = new GraphicDef
            {
                ModelName = "\\Models\\Destroyed\\Taiidan_Interceptor_Cockpit_Debris",
                VisualProbability = 1f,
                ShieldHitDraw = false,
                Particles = new AmmoParticleDef
                {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f,
                        Width = 0.5f,
                        Color = Color(red: 30, green: 15, blue: 15f, alpha: 4),
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "WeaponLaser",
        ...
        private AmmoDef taiidan_interceptor_debris2 => new AmmoDef
        {
            ...
            AmmoGraphics = new GraphicDef
            {
                ModelName = "\\Models\\Destroyed\\Taiidan_Interceptor_Engine_Debris",
                VisualProbability = 1f,
                ShieldHitDraw = false,
                Particles = new AmmoParticleDef
                {
        ...
        private AmmoDef taiidan_interceptor_debris3 => new AmmoDef
        {
            ...
            AmmoGraphics = new GraphicDef
            {
                ModelName = "\\Models\\Destroyed\\Taiidan_Interceptor_Gun_Debris",
                VisualProbability = 1f,
                ShieldHitDraw = false,
                Particles = new AmmoParticleDef
                {
        ...
        private AmmoDef taiidan_interceptor_debris4 => new AmmoDef
        {
            ...
            AmmoGraphics = new GraphicDef
            {
                ModelName = "\\Models\\Destroyed\\Taiidan_Interceptor_Wing_Debris",
                VisualProbability = 1f,
                ShieldHitDraw = false,
                Particles = new AmmoParticleDef
                {
