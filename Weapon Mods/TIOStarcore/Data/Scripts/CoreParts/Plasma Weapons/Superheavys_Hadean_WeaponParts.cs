...
namespace Scripts {   
    partial class Parts {
        ...
        //Hadean
        WeaponDefinition HeavyPlas_Hadean_Super => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "HadeanPlasmaBlastgun", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            HardPoint = new HardPointDef
            {
                ...
                {
                    RotateRate = 0.0012f, // Max traversal speed of azimuth subpart in radians per tick (0.1 is approximately 360 degrees per second).
