...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition K_SA_Launcher_ATM_I => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_SA_Launcher_VIV", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "Launcher_ATM_I_1",
                    "Launcher_ATM_I_2", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "Launcher_ATM_I_1", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            Targeting = new TargetingDef
            {
                ...
                SubSystems = new[] {
                    Production, Power, Thrust, Utility, Offense, Any, // Subsystem targeting priority: Offense, Utility, Power, Production, Thrust, Jumping, Steering, Any
                },
            ...
            {
                PartName = "Cocytus IX", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                K_SA_MSKI_ATM_I_Stage1,
                K_SA_MSKI_ATM_I_Stage2,
                K_SA_MSKI_ATM_I_Stage3,
                K_SA_MSKI_ATM_I_Stage4,
                K_SA_MSKI_ATM_I_LockLaser, // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = K_SA_Launcher_ATM_Animations,
