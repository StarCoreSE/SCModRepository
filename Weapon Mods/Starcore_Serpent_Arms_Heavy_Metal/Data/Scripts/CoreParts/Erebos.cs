...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SA_HMI_Erebos => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "SA_HMI_Erebos", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "GaussAIIC_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "GaussAIIC_Rot", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "GaussAIIC_Ele",// Your Elevating Subpart, that bit that moves up
                ...
                Muzzles = new[] {
                    "Muzzle_GaussAIC_01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "scope_GaussAIIC", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            Targeting = new TargetingDef
            {
                ...
                MaxTrackingTime = 90, // After this time has been reached the weapon will stop tracking existing target and scan for a new one, only applies to turreted weapons
            ...
            {
                PartName = "Erebos", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Satisfaction", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "K_SA_GaussFire_erebos", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                K_SA_ErebosAmmo,
                K_SA_ErebosAmmo_AOE// Must list all primary, shrapnel, and pattern ammos.
            },
