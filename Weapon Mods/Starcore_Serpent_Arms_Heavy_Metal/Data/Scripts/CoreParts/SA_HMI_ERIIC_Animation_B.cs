...
{ // Don't edit above this line
    partial class Parts
    {
        private AnimationDef SA_HMI_ERGaussII_II_Animation => new AnimationDef
        {
            ...
            AnimationSets = new[]
            {
                ...
                {
                    SubpartId = Names("HGaussII_Recoil_II"),
                    BarrelId = "Muzzle_HeavyGaussIIA_01", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 0,
