...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AnimationDef SA_HMI_ERGaussFM_Animation => new AnimationDef
        {
       ...
       AnimationSets = new[]
            {   
                ...
                {
                    SubpartId = Names("HGaussII_Barrel_1","HGaussII_Barrel_2","HGaussII_Barrel_3"),
   ...
   new PartAnimationSetDef // Recoil 1
                {
                    SubpartId = Names("SAERFM_Barrel"),
                   BarrelId = "Muzzle_Gauss_ER_FM_01", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 0,
                  AnimationDelays = Delays(FiringDelay : 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(),
