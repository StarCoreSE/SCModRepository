...
{ // Don't edit above this line
    partial class Parts
    {
        private AnimationDef SA_HeavyMetal_Spinal_Rotary_Animation => new AnimationDef
        {
            ...
            AnimationSets = new[]
            {
                ...
                {
                    SubpartId = Names("Spinner"),
                    BarrelId = "muzzle_projectile_002", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 0,
