...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef SA_Hellfire_Ammo_Decal => new AmmoDef  //T4 continuous beam (using pattern to reduce partcles and decals, any damage tweaks do to both)
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "SA_Hellfire_Ammo_Decal", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
