...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef K_SA_GaussRound_Standard => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            AmmoRound = "Ceis Gauss", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            Pattern = new PatternDef
            {
                ...
                Mode = Fragment, // Select when to activate this pattern, options: Inactive, Weapon, Fragment, Both 
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Armor = new ArmorDef
                {
                    Armor = 1.55f, // Multiplier for damage against all armor. This is multiplied with the specific armor type multiplier (light, heavy).
                    Light = -1f, // Multiplier for damage against light armor.
                    Heavy = -1f, // Multiplier for damage against heavy armor.
                    NonArmor = 0.45f, // Multiplier for damage against every else.
                },
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 5f, //
                        Width = 0.5f, //
                        Color = Color(red: 1, green: 17f, blue: 3f, alpha: 0.75f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
        ...
        {
            AmmoMagazine = "K_GaussCase_S", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Carnifex", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Armor = new ArmorDef
                {
                    Armor = 0.45f, // Multiplier for damage against all armor. This is multiplied with the specific armor type multiplier (light, heavy).
                    Light = -1f, // Multiplier for damage against light armor.
                    Heavy = -1f, // Multiplier for damage against heavy armor.
                ...
                Shields = new ShieldDef
                {
                    Modifier = 2.25f, // Multiplier for damage against shields.
                    Type = Default, // Damage vs healing against shields; Default, Heal
                    BypassModifier = -1f, // If greater than zero, the percentage of damage that will penetrate the shield.
                },
                DamageType = new DamageTypes // Damage type of each element of the projectile's damage; Kinetic, Energy
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Segmentation = new SegmentDef
                        {
                            Enable = false, // If true Tracer TextureMode is ignored
                            Textures = new[] {
                                "K_Beam_Type_1_Section_1",
                                  "K_Beam_Type_1_Section_2",
                                  "K_Beam_Type_1_Section_3",
                                  "K_Beam_Type_1_Section_4",
                                  "K_Beam_Type_1_Section_5",
                                  "K_Beam_Type_1_Section_6",
                                  "K_Beam_Type_1_Section_7",
                                  "K_Beam_Type_1_Section_8",
                                  "K_Beam_Type_1_Section_9", // Please always have this Line set, if this Section is enabled.
                            },
