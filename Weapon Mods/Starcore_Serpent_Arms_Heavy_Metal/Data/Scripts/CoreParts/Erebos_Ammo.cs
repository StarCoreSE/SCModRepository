...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef K_SA_ErebosAmmo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Erebos Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 6f, //12.5MW->30MW //Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            {
                AmmoRound = "Erebos Ammo AOE", // AmmoRound field of the ammo to spawn.
                ...
                TimedSpawns = new TimedSpawnDef // disables FragOnEnd in favor of info specified below
                {
                    ...
                    Proximity = 35f, // Starting distance from target bounding sphere to start spawning fragments, 0 disables this feature.  No spawning outside this distance
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                HealthHitModifier = 40, //2 Erebos turrets shooting the same LRM will kill it and all its friends in a 100m diameter sphere.  //used to be 175 //How much Health to subtract from another projectile on hit; defaults to 1 if zero or less.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                {
                    Enable = true,
                    Radius = 45f, // Radius of AOE effect, in meters.
                    Damage = 40000f,
                    Depth = 45f, // Max depth of AOE effect, in meters. 0=disabled, and AOE effect will reach to a depth of the radius value
                    MaxAbsorb = 8000f, // Soft cutoff for damage, except for pooled falloff.  If pooled falloff, limits max damage per block.
                    ...
                    NoSound = false,
                    ParticleScale = 1f,
                    CustomParticle = "K_SA_Explosion_III_Erebos", // Particle SubtypeID, from your Particle SBC
                    CustomSound = "Pulse_Flak_placeholder", // SubtypeID from your Audio SBC, not a filename
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    {
                        Name = "ErebusProjectile", //ShipWelderArc
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 2f, //
                        Width = 1f, //
                        Color = Color(red: 1f, green: 14f, blue: 14f, alpha: 2), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            SegmentLength = 10f, // Uses the values below.
                            SegmentGap = 10f, // Uses Tracer textures and values
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 1f, green: 1f, blue: 2f, alpha: 1),
                        Back = false,
                        CustomWidth = 0,
       ...
       private AmmoDef K_SA_ErebosAmmo_AOE => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Erebos Ammo AOE", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                DamageVoxels = false, // Whether to damage voxels.
                SelfDamage = false, // Whether to damage the weapon's own grid.
                HealthHitModifier = 30, //75 How much Health to subtract from another projectile on hit; defaults to 1 if zero or less.
                VoxelHitModifier = 1, // Voxel damage multiplier; defaults to 1 if zero or less.
                Characters = -1f, // Character damage multiplier; defaults to 1 if zero or less.
                // For the following modifier values: -1 = disabled (higher performance), 0 = no damage, 0.01f = 1% damage, 2 = 200% damage.
                FallOff = new FallOffDef
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                TargetLossTime = 0, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                MaxLifeTime = 6, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). Please have a value for this, It stops Bad things.
                AccelPerSec = 0f, // Meters Per Second. This is the spawning Speed of the Projectile, and used by turning.
                DesiredSpeed = 8000, // voxel phasing if you go above 5100
                MaxTrajectory = 75f, // Max Distance the projectile or beam can Travel.
                DeaccelTime = 0, // 0 is disabled, a value causes the projectile to come to rest, spawn a field and remain for a time (Measured in game ticks, 60 = 1 second)
                GravityMultiplier = 0f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable. Natural Gravity Only.
                SpeedVariance = Random(start: 0, end: 0), // subtracts value from DesiredSpeed. Be warned, you can make your projectile go backwards.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 2f, //
                        Width = 1f, //
                        Color = Color(red: 1f, green: 14f, blue: 14f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 1, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 6, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "WeaponLaser", // Please always have this Line set, if this Section is enabled.
                        },
                        TextureMode = Normal, // Normal, Cycle, Chaos, Wave
