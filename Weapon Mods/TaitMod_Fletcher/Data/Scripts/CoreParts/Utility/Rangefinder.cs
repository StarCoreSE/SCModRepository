...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition RangeFinderMK24 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Mk25Rangefinder",  // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Mark 24 Rangefinder", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    MagsToLoad = 10000, // Number of physical magazines to consume on reload.
            ...
            Ammos = new[] {
                RFLAmmo, // Must list all primary, shrapnel, and pattern ammos.
            },
