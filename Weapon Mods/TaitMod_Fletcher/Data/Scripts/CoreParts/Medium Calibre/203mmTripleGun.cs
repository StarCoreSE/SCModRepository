...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Triple203 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "203mmTriple", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Des Moines Triple 203mm", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
