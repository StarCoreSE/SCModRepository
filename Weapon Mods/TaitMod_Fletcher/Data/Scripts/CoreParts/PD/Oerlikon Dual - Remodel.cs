...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FaOerlikon20mmDualRemodel => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "OerlikonDual", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "20mm Oerlikon Dual", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    MagsToLoad = 120, // Number of physical magazines to consume on reload.
                    ...
                    HeatSinkRate = 202, // Amount of heat lost per second.
                ...
                Graphics = new HardPointParticleDef
                {
                   Effect1 = new ParticleDef {
                        Name = "TaitSmallPDBlast", // Smoke_LargeGunShot
                        Color = Color(red: 25.5f, green: 16.5f, blue: 0f, alpha: 0.8f),
