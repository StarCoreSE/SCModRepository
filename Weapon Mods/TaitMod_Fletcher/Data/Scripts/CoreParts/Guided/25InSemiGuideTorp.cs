...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef TorpLaunch1 => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            Health = 200f, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    MinArmingTime = 900, // In ticks, before the Ammo is allowed to explode, detonate or similar; This affects shrapnel spawning.
                    NoVisuals = false,
                    NoSound = false,
                    ParticleScale = 1f,
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 15f, green: 0f, blue: 0f, alpha: 1),
                        Back = false,
                        CustomWidth = 0.15f,
        ...
        private AmmoDef SemiGuidedTorp => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = false,
                    ParticleScale = 1f,
                    CustomParticle = "GetHitNerd", // Particle SubtypeID, from your Particle SBC
                    CustomSound = "", // SubtypeID from your Audio SBC, not a filename
                    Shape = Diamond, // Round or Diamond shape.  Diamond is more performance friendly.
                },
            },
            ...
            AmmoAudio = new AmmoAudioDef
            {
                TravelSound = "TorpInbound", // SubtypeID for your Sound File. Travel, is sound generated around your Projectile in flight
                HitSound = "TorpHit",
                //FragmentSound = "",
                ShieldHitSound = "",
                PlayerHitSound = "",
