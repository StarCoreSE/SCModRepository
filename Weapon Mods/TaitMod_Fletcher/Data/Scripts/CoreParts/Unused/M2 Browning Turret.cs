...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FaM2Turret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "FAM2BrowningTurret", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "M2 Turret FA", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RateOfFire = 450, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                    ...
                    MaxHeat = 3000000, // Max heat before weapon enters cooldown (70% of max heat).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "M2OneShot", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    Effect1 = new ParticleDef {
                        Name = "MuzzleTest", // Smoke_LargeGunShot
            ...
            Ammos = new[] {
                FAM2TurretAmmo // Must list all primary, shrapnel, and pattern ammos.
            },
        };
