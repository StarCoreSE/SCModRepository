...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition CHP_SmallKineticTurretLG => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "CHP_SmallKineticTurretLG", // Block Subtypeid. Your Cubeblocks contain this information
					...
					new MountPointDef {
                        SubtypeId = "CHP_SmallKineticTurretLGColorable", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Small Kinetic Turret LG", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0.37f, // Projectile inaccuracy in degrees.
                ...
                HardWare = new HardwareDef
                {
                    ...
                    ElevateRate = 0.0185f, // Max traversal speed of elevation subpart in radians per tick.
                    ...
                    IdlePower = 0.085f, // Constant base power draw in MW.
                ...
                {
                    RateOfFire = 125, // Set this to 3600 for beam weapons. This is how fast your gun fires per minute.
                    ...
                    MaxHeat = 110, // Max heat before weapon enters cooldown (70% of max heat).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "CHP_SmallShot", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "CHP_MuzzleFlash_SmallCannon", // SubtypeId of muzzle particle effect.
		...
		WeaponDefinition CHP_SmallKineticTurretSG => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "CHP_SmallKineticTurretSG", // Block Subtypeid. Your Cubeblocks contain this information
					...
					new MountPointDef {
                        SubtypeId = "CHP_SmallKineticTurretSGColorable", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            HardPoint = new HardPointDef
            {
                PartName = "Small Kinetic Turret SG", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0.37f, // Projectile inaccuracy in degrees.
                AimingTolerance = 1f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                AimLeadingPrediction = Advanced, // Level of turret aim prediction; Off, Basic, Accurate, Advanced
                DelayCeaseFire = 0, // Measured in game ticks (6 = 100ms, 60 = 1 second, etc..). Length of time the weapon continues firing after trigger is released - while a target is available.
