...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition CHP_PlasmaBombLauncher => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "CHP_PlasmaBombLauncher", // Block Subtypeid. Your Cubeblocks contain this information
					...
					new MountPointDef {
                        SubtypeId = "CHP_PlasmaBombLauncher_New", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Plasma Bomb Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RateOfFire = 45, // Set this to 3600 for beam weapons. This is how fast your gun fires per minute.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "CHP_MuzzleFlash_PlasmaBombShot", // SubtypeId of muzzle particle effect.
