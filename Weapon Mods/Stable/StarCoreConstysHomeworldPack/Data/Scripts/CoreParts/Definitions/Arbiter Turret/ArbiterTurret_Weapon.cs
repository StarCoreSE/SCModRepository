...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition CHP_ArbiterKineticBurstCannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "CHP_ArbiterKineticBurstCannon", // Block Subtypeid. Your Cubeblocks contain this information
					...
					new MountPointDef {
                        SubtypeId = "CHP_ArbiterKineticBurstCannonColorable", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Arbiter Turret", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    ElevateRate = 0.0045f, // Max traversal speed of elevation subpart in radians per tick.
                    ...
                    InventorySize = 1.2f, // Inventory capacity in kL.
                ...
                {
                    RateOfFire = 65, // Set this to 3600 for beam weapons. This is how fast your gun fires per minute.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "CHP_HeavyShot", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "CHP_MuzzleFlash_LargeCannon", // SubtypeId of muzzle particle effect.
