...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition CHP_MediumIonTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "CHP_MediumIonTurret", // Block Subtypeid. Your Cubeblocks contain this information          
            ...
            {
                PartName = "Medium Ion Turret", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RotateRate = 0.00275f, // Max traversal speed of azimuth subpart in radians per tick (0.1 is approximately 360 degrees per second).
                    ...
                    IdlePower = 0.45f, // Constant base power draw in MW.
                ...
                Loading = new LoadingDef
                {
                    ...
                    DelayUntilFire = 72, // How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                {
                    PreFiringSound = "CHP_IonHeavyShotPreFire", // Audio for warmup effect.
                    FiringSound = "CHP_IonHeavyShot", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "CHP_MuzzleFlash_HeavyIon", // SubtypeId of muzzle particle effect.
