...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef MA_Laser_T2_Ammo => new AmmoDef  //T2 orange pulse for turrets
        {
            ...
            EnergyCost = 0.0417f, //100MW  //50MW 0.417 Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                {
                    Distance = 1750f, // Distance at which damage begins falling off.
        ...
        private AmmoDef MA_Laser_T2_Ammo_Fake => new AmmoDef  //T2 orange pulse for turrets
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "MA_Laser_T2_Ammo_Fake", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0f, //100MW  //50MW 0.417 Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
