...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef MA_Laser_T4_Ammo => new AmmoDef  //T4 continuous beam (using pattern to reduce partcles and decals, any damage tweaks do to both)
        {
            ...
            EnergyMagazineSize = 2900, // For energy weapons, how many shots to fire before reloading.
            ...
            Pattern = new PatternDef
            {
                Patterns = new[] { // If enabled, set of multiple ammos to fire in order instead of the main ammo.
                    "MA_Laser_T4_Ammo", "MA_Laser_T4_Ammo_Decal",
                },
                Mode = Weapon,
                TriggerChance = 1f,
                Random = false,
