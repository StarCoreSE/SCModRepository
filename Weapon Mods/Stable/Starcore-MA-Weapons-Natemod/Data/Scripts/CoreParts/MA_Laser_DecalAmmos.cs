...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef MA_Laser_T4_Ammo_Decal => new AmmoDef  //T4 continuous beam (using pattern to reduce partcles and decals, any damage tweaks do to both)
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "MA_Laser_T4_Ammo_Decal", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f,
                        Width = 1.5f,
                        Color = Color(red: 0, green: 0, blue: 0, alpha: 0f),
        ...
        private AmmoDef MA_Laser_T3_Ammo_Decal => new AmmoDef  //T4 continuous beam (using pattern to reduce partcles and decals, any damage tweaks do to both)
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "MA_Laser_T3_Ammo_Decal", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.0001f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 0f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
        ...
        private AmmoDef MA_Laser_T2_Ammo_Decal => new AmmoDef  //T4 continuous beam (using pattern to reduce partcles and decals, any damage tweaks do to both)
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "MA_Laser_T2_Ammo_Decal", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.0001f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 0f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
