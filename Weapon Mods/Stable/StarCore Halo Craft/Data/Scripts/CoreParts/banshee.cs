...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition banshee => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "banshee", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "banshee", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Viper_Launch", // Audio for firing.
            ...
            Ammos = new[] {
                banshee_shot_Main,
                banshee_shot_Acceleration,
                banshee_plasma_shot_Acceleration,
