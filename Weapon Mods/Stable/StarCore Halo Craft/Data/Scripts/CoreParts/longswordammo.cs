...
{ // Don't edit above this line
    partial class Parts //test2
    {
        ...
        private AmmoDef longsword_shot_Main => new AmmoDef // StarCore AMS I
        {
            ...
            AmmoRound = "longsword shot main", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            ...
            Health = 1500, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            ...
            {
                AmmoRound = "Longsword Nuke Acceleration", // AmmoRound field of the ammo to spawn.
                ...
                TimedSpawns = new TimedSpawnDef // disables FragOnEnd in favor of info specified below
                {
                    ...
                    GroupDelay = 720, // Delay between each group.
                },
            },
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                HealthHitModifier = 600, // How much Health to subtract from another projectile on hit; defaults to 1 if zero or less.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    CustomSound = "longswordend", // SubtypeID from your Audio SBC, not a filename
                    Shape = Diamond, // Round or Diamond
                },
            },
            Trajectory = new TrajectoryDef
            {
                ...
                DesiredSpeed = 320f, // voxel phasing if you go above 5100
                ...
                Smarts = new SmartsDef
                {
                    ...
                    MaxLateralThrust = 0.7f, // controls how sharp the projectile may turn, this is the cheaper but less realistic version of SteeringLimit, cost of 2 on a scale of 1-5, 0 being basic smart.
                ...
                Approaches = new[] // These approaches move forward and backward in order, once the end condition of the last one is reached it will revert to default behavior. Cost level of 4+, or 5+ if used with steering.
                {
                    ...
                    new ApproachDef // Launch
                    {
                        ...
                        AccelMulti = 0.2f, // Modify default acceleration by this factor
                        ...
                        SpeedCapMulti = 0.2f, // Limit max speed to this factor, must keep this value BELOW default maxspeed (1).
                    ...
                    new ApproachDef // Travel
                    {
                        ...
                        ElevationTolerance = 1000, // adds additional tolerance (in meters) to meet the Elevation condition requirement.  *note* collision size is also added to the tolerance
                        TrackingDistance = 0, // Minimum travel distance before projectile begins racing to target
                        DesiredElevation = 2000, // The desired elevation relative to source 
                        StoredStartId = 0, // Which approach id the the start storage was saved in, if any.
                        StoredEndId = 0, // Which approach id the the end storage was saved in, if any.
                        StoredStartType = PositionA,
                        ...
                        DeAccelMulti = 1.0, // Modifies your default deacceleration by this factor
                        TotalAccelMulti = 1.0, // Modifies your default totalacceleration by this factor
                    ...
                    new ApproachDef // Orbit
                    {
                        ...
                        OrbitRadius = 1500, // The orbit radius to extend between the projectile and the target (target volume + this value)
                        OffsetMinRadius = 1200, // Min Radius to offset from target.  
                        OffsetMaxRadius = 2500, // Max Radius to offset from target.  
                    ...
                    new ApproachDef // Turn
                    {
                        ...
                        Up = UpTargetVelocity, // UpRelativeToBlock*, UpRelativeToShooter, UpRelativeToGravity, UpTargetDirection, UpTargetVelocity, UpStoredStartPosition, UpStoredEndPosition, UpStoredStartLocalPosition, UpStoredEndLocalPosition, UpOriginDirection, UpDestinationDirection
                    ...
                    new ApproachDef // Strafe
                    {
                        ...
                        Orbit = true, // Orbit the target
                        OrbitRadius = 1500, // The orbit radius to extend between the projectile and the target (target volume + this value)
                        OffsetMinRadius = 1000, // Min Radius to offset from target.  
                        OffsetMaxRadius = 2000, // Max Radius to offset from target.  
                        OffsetTime = 60, // How often to change the offset direction.
                    ...
                    new ApproachDef // RTB
                    {
                        ...
                        // Modify speed and acceleration ratios while this approach is active
                        AccelMulti = 1.2, // Modify default acceleration by this factor
                        DeAccelMulti = 0, // Modifies your default deacceleration by this factor
                        TotalAccelMulti = 0, // Modifies your default totalacceleration by this factor
                    ...
                    new ApproachDef // Recover Orbit
                    {
                        ...
                        // Tweaks to vantagepoint behavior
                        AngleOffset = 0, // value 0 - 1, rotates the Updir
                        ElevationTolerance = 200, // adds additional tolerance (in meters) to meet the Elevation condition requirement.  *note* collision size is also added to the tolerance
                        TrackingDistance = 0, // Minimum travel distance before projectile begins racing to target
                        DesiredElevation = 0, // The desired elevation relative to source 
                        StoredStartId = 0, // Which approach id the the start storage was saved in, if any.
                        StoredEndId = 0, // Which approach id the the end storage was saved in, if any.
                    ...
                    new ApproachDef // Recover
                    {
                        ...
                        // Modify speed and acceleration ratios while this approach is active
                        AccelMulti = 2.5, // Modify default acceleration by this factor
                        DeAccelMulti = 0, // Modifies your default deacceleration by this factor
                        TotalAccelMulti = 0, // Modifies your default totalacceleration by this factor
                        SpeedCapMulti = 1.75, // Limit max speed to this factor, must keep this value BELOW default maxspeed (1).
            ...
            {
                ModelName = "\\Models\\longsword", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
                ...
                Lines = new LineDef
                {
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 0.95f, green: 15f, blue: 15f, alpha: 0.10f),
            ...
            {
                TravelSound = "longswordloop", // SubtypeID for your Sound File. Travel, is sound generated around your Projectile in flight
                HitSound = "longswordend",
                ShieldHitSound = "longswordend",
                PlayerHitSound = "",
                VoxelHitSound = "longswordend",
                FloatingHitSound = "",
                HitPlayChance = 1f,
                HitPlayShield = true,
            },
        ...
        private AmmoDef Longsword_NUKE_Acceleration => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Longsword Nuke Acceleration", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "Longsword Nuke Terminal", // AmmoRound field of the ammo to spawn.
                Fragments = 1, // Number of projectiles to spawn.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                Smarts = new SmartsDef
                {
                    ...
                    FutureIntersectionRange = 300, // Range in front of the projectile at which it will detect obstacle.  If set to zero it defaults to DesiredSpeed + Shape Diameter
                    MaxChaseTime = 0, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    OverideTarget = false, // when set to true ammo picks its own target, does not use hardpoint's.
                    MaxTargets = 16, // Number of targets allowed before ending, 0 = unlimited
                    NoTargetExpire = false, // Expire without ever having a target at TargetLossTime
            ...
            AmmoGraphics = new GraphicDef
            {
                ModelName = "\\Models\\Ammo\\Starcore_Arrow_Missile_Large",
                VisualProbability = 1f,
                ShieldHitDraw = false,
                Particles = new AmmoParticleDef
                {
            ...
            AmmoAudio = new AmmoAudioDef
            {
                TravelSound = "LongswordTravelOffshoot", // SubtypeID for your Sound File. Travel, is sound generated around your Projectile in flight
                HitSound = "LongswordHit",
                ShotSound = "halobomblaunch",
                ShieldHitSound = "LongswordHit",
                PlayerHitSound = "",
                VoxelHitSound = "",
                FloatingHitSound = "",
                HitPlayChance = 1f,
        ...
        private AmmoDef Longsword_NUKE_Terminal => new AmmoDef
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Longsword Nuke Terminal", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.01f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            Health = 30, //the answer to life, the universe, and everything //How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 0f, // Recoil. This is applied to the Parent Grid.
            DecayPerShot = 0f, // Damage to the firing weapon itself. 
                               //float.MaxValue will drop the weapon to the first build state and destroy all components used for construction
                               //If greater than cube integrity it will remove the cube upon firing, without causing deformation (makes it look like the whole "block" flew away)
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Shields = new ShieldDef
                {
                    Modifier = 10f, //50100 total shield damage from this stage now instead of 5010. 648k is done by fragents. total is about 700k.  Used to be uhhh 2.9m, was 1m with reloadable longswords, now is just under 700k. //Multiplier for damage against shields.
                    Type = Default, // Damage vs healing against shields; Default, Heal
                    BypassModifier = -1f, // If greater than zero, the percentage of damage that will penetrate the shield.
                },
                DamageType = new DamageTypes // Damage type of each element of the projectile's damage; Kinetic, Energy
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    CustomSound = "LongswordCloseNuked", // SubtypeID from your Audio SBC, not a filename
                    Shape = Diamond, // Round or Diamond
                },
            },
            Ewar = new EwarDef
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                DesiredSpeed = 410, // voxel phasing if you go above 5100
                ...
                GravityMultiplier = 0f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable. Natural Gravity Only.
                SpeedVariance = Random(start: 0, end: 30), // subtracts value from DesiredSpeed. Be warned, you can make your projectile go backwards.
                RangeVariance = Random(start: 0, end: 100), // subtracts value from MaxTrajectory
                MaxTrajectoryTime = 0, // How long the weapon must fire before it reaches MaxTrajectory.
                TotalAcceleration = 0, // 0 means no limit, something to do due with a thing called delta and something called v.
                Smarts = new SmartsDef
                {
                    SteeringLimit = 200, // 0 means no limit, value is in degrees, good starting is 150.  This enable advanced smart "control", cost of 3 on a scale of 1-5, 0 being basic smart.
                    ...
                    NavAcceleration = 0.1f, // helps influence how the projectile steers. 
                    TrackingDelay = 0, // Measured in Shape diameter units traveled.
                    AccelClearance = false, // Setting this to true will prevent smart acceleration until it is clear of the grid and tracking delay has been met (free fall).
                    MaxChaseTime = 0, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    OverideTarget = false, // when set to true ammo picks its own target, does not use hardpoint's.
        ...
        private AmmoDef Longsword_NUKE_Frag => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
        ...
        //ungodly attempt at making it "stick" to grids was attempted, it's almost possible with a "perfect" tracking smart that will keep its range from the target

        private AmmoDef longsword_napalm_base => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "longsword napalm base", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.001f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "longsword napalm timespawn", // AmmoRound field of the ammo to spawn.
                Fragments = 1, // Number of projectiles to spawn.
                Degrees = 0, // Cone in which to randomize direction of spawned projectiles.
                Reverse = false, // Spawn projectiles backward instead of forward.
                DropVelocity = true, // fragments will not inherit velocity from parent.
                ...
                TimedSpawns = new TimedSpawnDef // disables FragOnEnd in favor of info specified below
                {
                    ...
                    MaxSpawns = 1, // Max number of fragment children to spawn
                    Proximity = 5000, // Starting distance from target bounding sphere to start spawning fragments, 0 disables this feature.  No spawning outside this distance
                    ParentDies = true, // Parent dies once after it spawns its last child.
                    PointAtTarget = true, // Start fragment direction pointing at Target
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = false,
                    ParticleScale = 1,
                    CustomParticle = "NapalmBomb", // Particle SubtypeID, from your Particle SBC
                    CustomSound = "halobombexplode", // SubtypeID from your Audio SBC, not a filename
                    Shape = Diamond, // Round or Diamond
                },
            },
            Ewar = new EwarDef
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 4,
                        Color = Color(red: 23, green: 0, blue: 0f, alpha: 4),
                        Back = false,
                        CustomWidth = 0.4f,
                        UseWidthVariance = false,
                        UseColorFade = true,
        ...
        private AmmoDef longsword_napalm_timespawn => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "longsword napalm timespawn", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.001f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "longsword napalm frag", // AmmoRound field of the ammo to spawn.
                Fragments = 1, // Number of projectiles to spawn.
                Degrees = 360, // Cone in which to randomize direction of spawned projectiles.
                Reverse = false, // Spawn projectiles backward instead of forward.
                DropVelocity = true, // fragments will not inherit velocity from parent.
            ...
            {
                Guidance = Smart, // None, Remote, TravelTo, Smart, DetectTravelTo, DetectSmart, DetectFixed
                TargetLossDegree = 360,
                TargetLossTime = 0, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                MaxLifeTime = 900, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                AccelPerSec = 0f,
                DesiredSpeed = 0.01f, // voxel phasing if you go above 5100
                MaxTrajectory = 100f,
                DeaccelTime = 0, // 0 is disabled, a value causes the projectile to come to rest overtime, (Measured in game ticks, 60 = 1 second)
                GravityMultiplier = 0f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable.
                SpeedVariance = Random(start: 0, end: 0), // subtracts value from DesiredSpeed
                ...
                {
                    SteeringLimit = 0, // 0 means no limit, value is in degrees, good starting is 150.  This enable advanced smart "control", cost of 3 on a scale of 1-5, 0 being basic smart.
                    Inaccuracy = 100f, // 0 is perfect, hit accuracy will be a random num of meters between 0 and this value.
            ...
            AmmoAudio = new AmmoAudioDef
            {
                TravelSound = "halofireloop", // SubtypeID for your Sound File. Travel, is sound generated around your Projectile in flight
                HitSound = "",
                ShotSound = "",
                ShieldHitSound = "",
                PlayerHitSound = "",
        ...
        private AmmoDef longsword_napalm_frag => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "longsword napalm frag", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.001f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
