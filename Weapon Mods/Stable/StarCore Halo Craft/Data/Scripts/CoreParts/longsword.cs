...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition longsword => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "longsword", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "longsword", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    MaxHeat = 250, // Max heat before weapon enters cooldown (70% of max heat).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "hwjsfx", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "haloreload", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
