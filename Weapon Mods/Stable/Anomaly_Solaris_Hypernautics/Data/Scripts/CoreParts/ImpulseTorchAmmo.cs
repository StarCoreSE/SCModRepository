...
{ // Don't edit above this line
    partial class Parts
    {
	    private AmmoDef Impulse_Torch_Ammo => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Impulse_Torch_Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
