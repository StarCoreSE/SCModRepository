...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef SM3_Counter_Battery_Launch => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "SM3MAG", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                ...
                TimedSpawns = new TimedSpawnDef // disables FragOnEnd in favor of info specified below
                {
                    ...
                    Interval = 60, // Time between spawning fragments, in ticks, 0 means every tick, 1 means every other
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                AccelPerSec = 1200f, // Meters Per Second. This is the spawning Speed of the Projectile, and used by turning.
                DesiredSpeed = 2100f, // voxel phasing if you go above 5100
                MaxTrajectory = 40000f, // Max Distance the projectile or beam can Travel.
                ...
                Smarts = new SmartsDef
                {
                    ...
                    Aggressiveness = 12f, // controls how responsive tracking is.
                    MaxLateralThrust = 1.25f, // controls how sharp the trajectile may turn
            ...
            AmmoAudio = new AmmoAudioDef
            {
                ...
                HitSound = "DRONEFLYBY",
                ShotSound = "DRONEFLYBY",
                ShieldHitSound = "DRONEFLYBY",
                PlayerHitSound = "",
                VoxelHitSound = "DRONEFLYBY",
                FloatingHitSound = "DRONEFLYBY",
                HitPlayChance = 0.5f,
                HitPlayShield = true,
            },
