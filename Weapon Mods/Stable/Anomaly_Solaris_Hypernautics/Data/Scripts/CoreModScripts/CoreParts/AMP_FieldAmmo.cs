...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef FieldDefault => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Goncol Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 6.75f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = true,
                    ParticleScale = 1,
                    CustomParticle = "AnomalyHeal_2", // Particle SubtypeID, from your Particle SBC
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxTrajectory = 1750f, // Max Distance the projectile or beam can Travel.
                ...
                Smarts = new SmartsDef
                {
                    ...
                    MaxLateralThrust = 9999, // controls how sharp the trajectile may turn
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f, //
                        Width = 1f, //
                        Color = Color(red: 1f, green: 1f, blue: 1.2f, alpha: 1f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            Speed = 750f, // meters per second
                            Color = Color(red: 1f, green: 1f, blue: 1.2f, alpha: 1f),
                            WidthMultiplier = 1f,
                            Reverse = false,
