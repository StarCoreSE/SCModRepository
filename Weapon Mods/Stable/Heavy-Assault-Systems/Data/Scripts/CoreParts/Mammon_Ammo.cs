...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef HAS_Mammon_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            EnergyCost = 0.125f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 10f, //
                        Width = 0.25f, //
                        Color = Color(red: 3, green: 50, blue: 50f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
