...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef HAS_Vulcan_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "VulcanAmmoMag", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "VulcanShell", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                AmmoRound = "VulcanFrag", // AmmoRound field of the ammo to spawn.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 105f, //
                        Width = 0.5f, //
                        Color = Color(red: 5.5f, green: 4.2f, blue: 1.25f, alpha: 0.5f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            SegmentLength = 60f, // Uses the values below.
                            ...
                            WidthVariance = Random(start: -0.5f, end: 0.5f),
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 16f, green: 0f, blue: 0f, alpha: 0.2f),
                        Back = false,
                        CustomWidth = 0.25f,
...
//unused
        private AmmoDef HAS_Vulcan_Stage2_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
