    ...
    partial class Parts {
        ...
        WeaponDefinition HAS_Thanatos => new WeaponDefinition
        {
            ...
            Targeting = new TargetingDef
            {
                ...
                MaxTargetDistance = 7000, //huh //Maximum distance at which targets will be automatically shot at; 0 = unlimited.
            ...
            {
                PartName = "'Thanatos' Pattern Macrocannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    MinAzimuth = -15, //werent these all 20's-25's before?
                    MaxAzimuth = 15,
                    MinElevation = -15,
                    MaxElevation = 15,
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 600, // 10 seconds Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    MagsToLoad = 1, //1 mag = 3 shots in ammo deff //Number of physical magazines to consume on reload.
                    DelayUntilFire = 10, //will make sure it shoots straighter with this easy hack of 10 ticks to wait //How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    ...
                    HeatSinkRate = 8, // 16 seconds, takes 6 seconds to fire, cools off under 10%, thus heat doesnt restrict gun, just a reload counter. //Amount of heat lost per second.
                    ...
                    FireFull = false, //probably part of the "always missing" issue //Whether the weapon should fire the full magazine (or the full burst instead if ShotsInBurst > 0), even if the target is lost or the player stops firing prematurely.
