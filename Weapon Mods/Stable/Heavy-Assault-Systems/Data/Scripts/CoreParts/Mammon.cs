...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HAS_Mammon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "HAS_Mammon", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            Ammos = new[] {
                HAS_Mammon_Ammo,  // Must list all primary, shrapnel, and pattern ammos.
            },
