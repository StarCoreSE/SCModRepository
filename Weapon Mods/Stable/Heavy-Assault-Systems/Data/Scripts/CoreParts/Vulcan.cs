...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HAS_Vulcan => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                {
                    RateOfFire = 1000, //102 shots in 6.1 seconds //Set this to 3600 for beam weapons. This is how fast your Gun fires.
                    BarrelsPerShot = 1, // How many muzzles will fire a projectile per fire event.
                    TrajectilesPerBarrel = 1, // Number of projectiles per muzzle per fire event.
                    SkipBarrels = 0, // Number of muzzles to skip after each fire event.
                    ReloadTime = 330, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    MagsToLoad = 1, // Number of physical magazines to consume on reload.
                    DelayUntilFire = 40, // How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    HeatPerShot = 5, // Heat generated per shot.
                    MaxHeat = 490, // Max heat before weapon enters cooldown (70% of max heat).
                    ...
                    BarrelSpinRate = 0, //315 //Visual only, 0 disables and uses RateOfFire.
                ...
                {
                    PreFiringSound = "HAS_AvengerSpinup", // Audio for warmup effect.
                    FiringSound = "HAS_AvengerBRRT", // Audio for firing.
                    FiringSoundPerShot = false, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "HAS_AvengerReload", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
                    HardPointRotationSound = "", // Audio played when turret is moving.
                    BarrelRotationSound = "HAS_AvengerBarrelSpin", //HAS_AvengerBarrelSpin //Audio played when turret is moving.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "Avenger_Muzzle_Flash_RAC5", // SubtypeId of muzzle particle effect.
