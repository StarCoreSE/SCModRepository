...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SA_HMI_ERGauss_Main => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        ...
                        MuzzlePartId = "HGaussII_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "HGaussII_Rot", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "HGaussII_Ele",// Your Elevating Subpart, that bit that moves up
                ...
                Muzzles = new[] {
                    "Muzzle_HeavyGaussII_01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
            ...
            {
                PartName = "Cerberus (A)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Animations = SA_HMI_ERGaussII_I_Animation,
