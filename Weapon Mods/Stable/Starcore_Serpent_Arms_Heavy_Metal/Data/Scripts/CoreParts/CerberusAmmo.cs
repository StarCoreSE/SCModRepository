...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef K_Cerberus_Gauss => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            EnergyCost = 0.001f, // ~200 MW / Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
