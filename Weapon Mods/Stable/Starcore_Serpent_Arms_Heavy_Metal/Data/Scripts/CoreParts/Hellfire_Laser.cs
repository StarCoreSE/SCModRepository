...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition Hellfire_Laser => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Hellfire_Laser_Block", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "muzzle_beam_001", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
            ...
            Targeting = new TargetingDef
            {
                ...
                SubSystems = new[] {
                    Production, Any, // Subsystem targeting priority: Offense, Utility, Power, Production, Thrust, Jumping, Steering, Any
                },
            ...
            {
                PartName = "Hellfire Laser", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    TrajectilesPerBarrel = 2, // ok this means same damage // Number of projectiles per muzzle per fire event.
                ...
                {
                    PreFiringSound = "HellfireCharge", // Audio for warmup effect.
                    FiringSound = "HellfireShoot", // Audio for firing.
