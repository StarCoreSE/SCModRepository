...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef K_SA_GaussRound_ER => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            {
                AmmoRound = "GaussER_Shrap", // AmmoRound field of the ammo to spawn.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 5f, //
                        Width = 0.5f, //
                        Color = Color(red: 32f, green: 45f, blue: 5f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 20, green: 35, blue: 5, alpha: 1),
                        Back = false,
                        CustomWidth = 0.5f,
        ...
        private AmmoDef K_SA_GaussRound_ER_Shrap => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
