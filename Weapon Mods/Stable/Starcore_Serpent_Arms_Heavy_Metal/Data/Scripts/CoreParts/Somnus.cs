...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SA_HMI_GaussER_FM => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_SA_HeavyMetal_Gauss_ERFM", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "Muzzle_Gauss_ER_FM_01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "scope_GaussIIFM", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "Somnus", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 480, //8 Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Somnus_Fire", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    Effect1 = new ParticleDef
                    {
                        ...
                        Color = Color(red: 1, green: 20, blue: 1, alpha: 1f),  // Deprecated, set color in particle sbc.
            ...
            Ammos = new[] {
                K_SA_MHI_Fixed_Gauss,
                K_SA_MHI_Fixed_Gauss_Frag,
                SomnusFXshots,
                SomnusFXshots2,
                SomnusFXshots3,
                SomnusFXshots4,// Must list all primary, shrapnel, and pattern ammos.
            },
