...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef NetworkTester_Laser_Ammo => new AmmoDef // StarCore AMS I
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "NetworkTester Laser", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Decals = new DecalDef   //warning: this is being applied every tick, need to be careful. If too intensive will need to kill the maxtrajtime and put on pattern.
                {
                    ...
                    Map = new[]
                    {
                        ...
                        {
                            HitMaterial = "Metal",
                            DecalMaterial = "SA_Laser_NetworkTester_Decal",
                        },
                    },
                },
