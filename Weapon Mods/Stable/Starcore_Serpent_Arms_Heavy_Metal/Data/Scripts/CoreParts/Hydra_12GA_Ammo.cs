...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef K_SA_CapitalWeaponry_SpinalA_MainProjectile => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            BackKickForce = 9.54e+6f, // Recoil. This is applied to the Parent Grid.
            ...
            {
                AmmoRound = "BFG_Indicator", // AmmoRound field of the ammo to spawn.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                RangeVariance = Random(start: 250, end: 400), // subtracts value from MaxTrajectory
                MaxTrajectoryTime = 0, // How long the weapon must fire before it reaches MaxTrajectory.
                Smarts = new SmartsDef
                {
                    Inaccuracy = 18f, // 0 is perfect, hit accuracy will be a random num of meters between 0 and this value.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 15f, //
                        Width = 0.1f, //
                        Color = Color(red: 0, green: 10, blue: 5f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
        ...
        private AmmoDef K_SA_CapitalWeaponry_SpinalA_Indicator => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "BFG_Indicator", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
        ...
        private AmmoDef K_SA_CapitalWeaponry_SpinalA_MainProjectile_RGB => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "BFG", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.0030f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 38500f, // Direct damage; one steel plate is worth 100.
            Mass = 100f, // In kilograms; how much force the impact will apply to the target.
            Health = 0, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 5540000f, // Recoil. This is applied to the Parent Grid.
            DecayPerShot = 0f, // Damage to the firing weapon itself.
            HardPointUsable = false, // Whether this is a primary ammo type fired directly by the turret. Set to false if this is a shrapnel ammoType and you don't want the turret to be able to select it directly.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Shields = new ShieldDef
                {
                    ...
                    Type = Default, // Damage vs healing against shields; Default, Heal
                    BypassModifier = 0.9f, // If greater than zero, the percentage of damage that will penetrate the shield.
                },
                DamageType = new DamageTypes // Damage type of each element of the projectile's damage; Kinetic, Energy
                {
                    Base = Kinetic, // Base Damage uses this
