...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SA_HMI_GaussIIC => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_SA_HeavyMetal_Gauss_A", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "GaussIIC_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                ...
                Muzzles = new[] {
                    "Muzzle_GaussIC_01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                    "Muzzle_GaussIC_02",
                },
            ...
            HardPoint = new HardPointDef
            {
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "K_SA_Gauss_Asterius", // Audio for firing.
            ...
            Ammos = new[] {
                K_SA_MHI_GaussHeavy_ER, // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = SA_HMI_GaussIC_Animation,
