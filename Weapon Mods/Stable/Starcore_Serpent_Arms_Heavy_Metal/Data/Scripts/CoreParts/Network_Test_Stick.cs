...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition NetworkTester_Laser => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NetworkTester_Laser_Block", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "NetworkTester Laser", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    PreFiringSound = "NetworkTesterCharge", // Audio for warmup effect.
                    FiringSound = "NetworkTesterShoot", // Audio for firing.
