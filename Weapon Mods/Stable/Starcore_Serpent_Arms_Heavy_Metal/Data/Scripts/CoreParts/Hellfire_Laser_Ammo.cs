...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Hellfire_Laser_Ammo => new AmmoDef // StarCore AMS I
        {
            ...
            BaseDamage = 1500f, // Direct damage; one steel plate is worth 100. 1
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxTrajectory = 6666f, // Max Distance the projectile or beam can Travel.
		...
		private AmmoDef Hellfire_LP_Ammo => new AmmoDef // StarCore AMS I
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "LP Hellfire", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
        ...
        private AmmoDef Hellfire_Laser_Ammo_Indicator => new AmmoDef // StarCore AMS I
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Hellfire Laser Indicator", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.40f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                AccelPerSec = 0f, // Meters Per Second. This is the spawning Speed of the Projectile, and used by turning.
                DesiredSpeed = 15000, // voxel phasing if you go above 5100
                MaxTrajectory = 16f, // Max Distance the projectile or beam can Travel.
                DeaccelTime = 0, // 0 is disabled, a value causes the projectile to come to rest overtime, (Measured in game ticks, 60 = 1 second)
                GravityMultiplier = 0f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable. Natural Gravity Only.
                SpeedVariance = Random(start: 0, end: 0), // subtracts value from DesiredSpeed. Be warned, you can make your projectile go backwards.
                RangeVariance = Random(start: 0, end: 0), // subtracts value from MaxTrajectory
