...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SA_HMI_PrototypeGaussBlitz => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_SA_HeavyMetal_Gauss_PGBC", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "GaussBlitz_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "GaussBlitz_Rot", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "GaussBlitz_Ele",// Your Elevating Subpart, that bit that moves up
                ...
                Muzzles = new[] {
                    "Muzzle_GaussBlitz_01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                    "Muzzle_GaussBlitz_02",
                    "Muzzle_GaussBlitz_03",
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "scope_GaussBlitz", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            Targeting = new TargetingDef
            {
                ...
                MaxTrackingTime = 120, // After this time has been reached the weapon will stop tracking existing target and scan for a new one
            ...
            HardPoint = new HardPointDef
            {
                ...
                Other = new OtherDef
                {
                    ...
                    RestrictionRadius = 8, // Prevents other blocks of this type from being placed within this distance of the centre of the block.
                    CheckInflatedBox = false, // If true, the above distance check is performed from the edge of the block instead of the centre.
                    CheckForAnyWeapon = false, // If true, the check will fail if ANY weapon is present, not just weapons of the same subtype.
                },
                Loading = new LoadingDef
                {
                    RateOfFire = 1040, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                    ...
                    HeatSinkRate = 999, // Amount of heat lost per second.
                ...
                {
                    PreFiringSound = "Charon_Charge", // Audio for warmup effect.
                    FiringSound = "K_SA_Gauss_HeavyCharon", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
                    HardPointRotationSound = "", // Audio played when turret is moving.
                    BarrelRotationSound = "Charon_Barrel_Spin",
                ...
                Graphics = new HardPointParticleDef
                {
                    Effect1 = new ParticleDef
                    {
                        ...
                        Color = Color(red: 1, green: 1, blue: 1, alpha: 1f),  // Deprecated, set color in particle sbc.
            ...
            Ammos = new[] {
                K_SA_MHI_PGBC_A,
                K_SA_MHI_PGBC_A_Bounce,
                Charon_Fake// Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = SA_HMI_PrototypeGaussBlitz_Animations,
