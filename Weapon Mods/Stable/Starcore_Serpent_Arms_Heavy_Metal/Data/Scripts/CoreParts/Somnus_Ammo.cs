...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef K_SA_MHI_Fixed_Gauss => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "K_GaussHeavyCase_FM", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Somnus Gauss", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            BaseDamage = 62500f, // Direct damage; one steel plate is worth 100.
            ...
            {
                AmmoRound = "Somnus Gauss Frag", // AmmoRound field of the ammo to spawn.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Armor = new ArmorDef
                {
                    Armor = 1.5f, //2.5f Multiplier for damage against all armor. This is multiplied with the specific armor type multiplier (light, heavy).
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    CustomSound = "Somnus_Hit", // SubtypeID from your Audio SBC, not a filename
                    Shape = Diamond, // Round or Diamond shape.  Diamond is more performance friendly.
                }, 
            },
            Ewar = new EwarDef
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                RangeVariance = Random(start: 400, end: 600), // subtracts value from MaxTrajectory
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 300f, //
                        Width = 0.95f, //
                        Color = Color(red: 25.0f, green: 40.20f, blue: 25.20f, alpha: 0.8f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 8.985f, green: 40.81f, blue: 8.162f, alpha: 1f),
                        Back = false,
                        CustomWidth = 0.2f,
            ...
            {
                TravelSound = "SomnusFlyby", // SubtypeID for your Sound File. Travel, is sound generated around your Projectile in flight
                HitSound = "Somnus_Hit",
                ShotSound = "",
                ShieldHitSound = "Somnus_Shield_Hit",
                PlayerHitSound = "",
                VoxelHitSound = "",
                FloatingHitSound = "",
                HitPlayChance = 1f,
        ...
        private AmmoDef K_SA_MHI_Fixed_Gauss_Frag => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Somnus Gauss Frag", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.5f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                FallOff = new FallOffDef
                {
                    Distance = 3f, // Distance at which damage begins falling off.
                ...
                Shields = new ShieldDef
                {
                    ...
                    Type = Default, // Damage vs healing against shields; Default, Heal
                    BypassModifier = 0.75f, // If greater than zero, the percentage of damage that will penetrate the shield.
                },
                DamageType = new DamageTypes // Damage type of each element of the projectile's damage; Kinetic, Energy
                {
                    Base = Kinetic, // Base Damage uses this
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxTrajectory = 150f, // Max Distance the projectile or beam can Travel.
                DeaccelTime = 0, // 0 is disabled, a value causes the projectile to come to rest, spawn a field and remain for a time (Measured in game ticks, 60 = 1 second)
                GravityMultiplier = 0f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable. Natural Gravity Only.
                SpeedVariance = Random(start: -100, end: 250), // subtracts value from DesiredSpeed. Be warned, you can make your projectile go backwards.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 300f, //
                        Width = 0.8f, //
                        Color = Color(red: 120f, green: 7.5f, blue: 0f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "ProjectileTrailLine", // Please always have this Line set, if this Section is enabled.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 120f, green: 7.5f, blue: 0f, alpha: 1),
                        Back = false,
                        CustomWidth = 0.2f,
                        UseWidthVariance = false,
                        UseColorFade = true,
        ...
        private AmmoDef SomnusFXshots => new AmmoDef // StarCore AMS II
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "SomnusFXshots", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.0f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "SomnusFXshots3", // AmmoRound field of the ammo to spawn.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    WidthVariance = Random(start: 0.09f, end: 0.05f), // adds random value to default width (negatives shrinks width)
                    Tracer = new TracerBaseDef
                    {
                        Enable = true,
                        Length = 2500f, //
                        Width = 0.05f, //
                        Color = Color(red: 15f, green: 30f, blue: 15f, alpha: 0.8f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 8.985f, green: 35f, blue: 8.162f, alpha: 1f),
                        Back = false,
                        CustomWidth = 0.3f,
        ...
        private AmmoDef SomnusFXshots2 => new AmmoDef // StarCore AMS II
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "SomnusFXshots2", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.0f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 2500f, //
                        Width = 0.03f, //
                        Color = Color(red: 5.0f, green: 15f, blue: 8.0f, alpha: 0.7f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 1, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 5, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "WeaponLaser", // Please always have this Line set, if this Section is enabled.
        ...
        private AmmoDef SomnusFXshots3 => new AmmoDef // StarCore AMS II
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "SomnusFXshots3", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.0f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
        ...
        private AmmoDef SomnusFXshots4 => new AmmoDef // StarCore AMS II
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "SomnusFXshots4", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.0f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                ...
                MaxChildren = 0, // number of maximum branches for fragments from the roots point of view, 0 is unlimited
                IgnoreArming = false, // If true, ignore ArmOnHit or MinArmingTime in EndOfLife definitions
                AdvOffset = Vector(x: 0, y: 0, z: -2), // advanced offsets the fragment by xyz coordinates relative to parent, value is read from fragment ammo type.
                TimedSpawns = new TimedSpawnDef // disables FragOnEnd in favor of info specified below
                {
                    Enable = false, // Enables TimedSpawns mechanism
                    Interval = 0, // Time between spawning fragments, in ticks, 0 means every tick, 1 means every other
