...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SA_HMI_ERGauss_SecondaryB => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        ...
                        MuzzlePartId = "HGaussII_Ele_SecondB", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "HGaussII_Rot_SecondB", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "HGaussII_Ele_SecondB",// Your Elevating Subpart, that bit that moves up
                ...
                Muzzles = new[] {
                    "Muzzle_HeavyGaussIIB_01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
            ...
            {
                PartName = "Cerberus (C)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    DelayUntilFire = 18, // How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
            ...
            Animations = SA_HMI_ERGaussII_III_Animation,
