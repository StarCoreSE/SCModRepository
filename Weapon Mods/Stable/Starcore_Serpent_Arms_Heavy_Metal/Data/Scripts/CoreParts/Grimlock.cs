    ...
    partial class Parts {
        ...
        WeaponDefinition Grimlock_Launcher => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                ...
                Muzzles = new[] {
                    "subpart_SA_Launch_01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                    "subpart_SA_Launch_02",
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "scope_GrimlockI", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "Grimlock", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "K_SA_Launch", // Audio for firing.
