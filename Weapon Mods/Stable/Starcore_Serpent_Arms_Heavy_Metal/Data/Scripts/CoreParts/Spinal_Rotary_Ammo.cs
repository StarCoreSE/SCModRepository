...
{ // Monopole Ammo
    partial class Parts
    {
        private AmmoDef Spinal_AutoCoil_Base_A => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            EnergyCost = 1.8f, // ~600 MW / Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                HealthHitModifier = 1001, // How much Health to subtract from another projectile on hit; defaults to 1 if zero or less.
