...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef FocusedBeamAmmo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "FocusedBeamLaser", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    //.Pooled damage behaves in a pooled manner that once exhausted damage ceases.
                    //.Exponential drops off exponentially.  Does not scale to max radius
                    ArmOnlyOnHit = false, //should it be true? //Detonation only is available, After it hits something, when this is true. IE, if shot down, it won't explode.
            ...
            Beams = new BeamDef
            {
                ...
                FakeVoxelHitTicks = 10, // If this beam hits/misses a voxel it assumes it will continue to do so for this many ticks at the same hit length and not extend further within this window.  This can save up to n times worth of cpu.
            },
            Trajectory = new TrajectoryDef
            {
                ...
                RangeVariance = Random(start: 1000, end: 1000), // subtracts value from MaxTrajectory
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1.5f, //
                        Width = 1f, //
                        Color = Color(red: 10, green: 15, blue: 100f, alpha: 1f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            Speed = 6f, // meters per second
                            Color = Color(red: 10, green: 15, blue: 100f, alpha: 1f),
                            WidthMultiplier = 1f,
                            Reverse = false,
        ...
        private AmmoDef FocusedBeamTractorAmmo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Tractor Pulse", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
