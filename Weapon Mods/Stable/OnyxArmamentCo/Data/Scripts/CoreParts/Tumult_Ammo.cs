...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef SC_AR_TumultAmmoWC => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "APHE 600mm", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                AmmoRound = "600mm Heavy Shell Frag", // AmmoRound field of the ammo to spawn.
            ...
            {
                ModelName = "\\Models\\PPC_Proj_On_The_Tumult", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 25f, //
                        Width = 0.5f, //
                        Color = Color(red: 26, green: 12, blue: 2f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 10f, green: 4f, blue: 2, alpha: 1),
                        Back = false,
                        CustomWidth = 0.15f,
        ...
        private AmmoDef SC_AR_TumultAmmoWC_Frag => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "600mm Heavy Shell Frag", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                AccelPerSec = 0f, // Meters Per Second. This is the spawning Speed of the Projectile, and used by turning.
                DesiredSpeed = 1100, // voxel phasing if you go above 5100
                MaxTrajectory = 130f, // Max Distance the projectile or beam can Travel.
                //FieldTime = 0, // 0 is disabled, a value causes the projectile to come to rest, spawn a field and remain for a time (Measured in game ticks, 60 = 1 second)
        ...
        private AmmoDef SC_AR_TumultAmmoWC_Contact => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "HE 600mm", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, //huh Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 9f, green: 3f, blue: 6, alpha: 1),
                        Back = false,
                        CustomWidth = 0.15f,
                        UseWidthVariance = false,
                        UseColorFade = true,
