...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition LB_5x => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "JN_175Fixed", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "LB-5X Super", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    CriticalReaction = new CriticalDef
                    {
                        ...
                        DefaultArmedTimer = 1, // Sets default countdown duration.
                ...
                Other = new OtherDef
                {
                    ConstructPartCap = 999, // Maximum number of blocks with this weapon on a grid; 0 = unlimited.
                ...
                {
                    RateOfFire = 7, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                    BarrelsPerShot = 1, // How many muzzles will fire a projectile per fire event.
                    TrajectilesPerBarrel = 1, // Number of projectiles per muzzle per fire event.
                    SkipBarrels = 0, // Number of muzzles to skip after each fire event.
                    ReloadTime = 570, //9.5s //Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    ...
                    HeatSinkRate = 10, //9.5s //Amount of heat lost per second.
