...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AdvancedCannon_Type18 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Type18_Artillery", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "MK1BattleshipBarrel", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "MK1BattleshipAZ", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "MK1BattleshipEL",// Your Elevating Subpart, that bit that moves up
            ...
            {
                PartName = "Type 18 Heavy Naval Artillery", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0f, // Projectile inaccuracy in degrees.
                AimingTolerance = 0.10f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                ...
                HardWare = new HardwareDef
                {
                    ...
                    IdlePower = 3f, // Constant base power draw in MW.
                ...
                {
                    RateOfFire = 21, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                    ...
                    DelayAfterBurst = 190, // How long to spend "reloading" after each burst. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "MyLargeCalibreShot", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "MyLargeCalibreReload", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
            ...
            Ammos = new[] {
                Standard_Fast_HighCapacity_Ammo, 
