...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AdvancedCannon_Type24 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Type24_Artillery", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "Mk3_Barrels", // The subpart where your muzzle empties are located. This is often the elevation subpart.
            ...
            {
                PartName = "Type 24 Heavy Naval Artillery", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 300, //5 seconds //Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
