...
{ // Don't edit above this line
 ...
 //Guided Rocket Turret
        private AmmoDef LrgRocketTurretAmmo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "The_Rockets_Of_All_Time", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Bonfire Mostly Guided Rocket", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                AmmoRound = "Bonfire Mostly Guided Rocket Terminal", // AmmoRound field of the ammo to spawn.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 32, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). time begins at 0 and time must EXCEED this value to trigger "time > maxValue". Please have a value for this, It stops Bad things.
        ...
        private AmmoDef LrgRocketTurretAmmoTerminal => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "The_Rockets_Of_All_Time", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Bonfire Mostly Guided Rocket Terminal", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                AccelPerSec = 120, // Meters Per Second. This is the spawning Speed of the Projectile, and used by turning.
                DesiredSpeed = 390, //340-390, real speed 250ish due to weaving. voxel phasing if you go above 5100
                ...
                Smarts = new SmartsDef
                {
                    ...
                    OffsetMinRange = 40, // The range from target at which offsets are no longer active
                    FocusOnly = false, // only target the constructs Ai's focus target
                    FocusEviction = false, // If FocusOnly and this to true will force smarts to lose target when there is no focus target
                    ScanRange = 0, // 0 disables projectile screening, the max range that this projectile will be seen at by defending grids (adds this projectile to defenders lookup database). 
