...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition LightMissileLauncher => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                ...
                Muzzles = new[] {
                    "muzzle_projectile_1", "muzzle_projectile_1.008", "muzzle_projectile_1.003", "muzzle_projectile_1.007",
                     "muzzle_projectile_1.002", "muzzle_projectile_1.006", "muzzle_projectile_1.001", "muzzle_projectile_1.005",
                      "muzzle_projectile_1.004", "muzzle_projectile_1.009",

                     // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                    
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "muzzle_projectile_1.006", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            Targeting = new TargetingDef
            {
                Threats = new[] {
                    Grids, Neutrals, Characters, Meteors, // Types of threat to engage: Grids, Projectiles, Characters, Meteors, Neutrals
                },
                SubSystems = new[] {
            ...
            {
                PartName = "Spitfire Rocket Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 1.2f, // Projectile inaccuracy in degrees.
                ...
                Loading = new LoadingDef
                {
                    ...
                    MaxHeat = 870, // Max heat before weapon enters cooldown (70% of max heat).
