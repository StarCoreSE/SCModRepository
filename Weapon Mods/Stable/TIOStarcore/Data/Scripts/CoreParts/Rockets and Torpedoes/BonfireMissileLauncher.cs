...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HeavyAssaultMissileLauncher => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "DrunkRocketTurret", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "hamlelev", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "hamlazim", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "hamlelev",// Your Elevating Subpart, that bit that moves up.
                ...
                Muzzles = new[] {
                    "muzzle_projectile_1.010", "muzzle_projectile_1.002",
                    "muzzle_projectile_1.016", "muzzle_projectile_1.013",
                    "muzzle_projectile_1.004", "muzzle_projectile_1.003", 
                    "muzzle_projectile_1.008", "muzzle_projectile_1.014",
                    "muzzle_projectile_1.011", "muzzle_projectile_1.015",
                    "muzzle_projectile_1",     "muzzle_projectile_1.007", 
                    "muzzle_projectile_1.001", "muzzle_projectile_1.012",
                    "muzzle_projectile_1.006", "muzzle_projectile_1.009", 
                    "muzzle_projectile_1.005", "muzzle_projectile_1.010",
                ...
                Scope = "muzzle_projectile_1.009", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            Targeting = new TargetingDef
            {
                Threats = new[] {
                    Grids, Characters, Meteors, Neutrals, // Types of threat to engage: Grids, Projectiles, Characters, Meteors, Neutrals
                },
                SubSystems = new[] {
                    Thrust, Offense, Utility, Any, // Subsystem targeting priority: Offense, Utility, Power, Production, Thrust, Jumping, Steering, Any
                },
            ...
            HardPoint = new HardPointDef
            {
                ...
                {
                    RotateRate = 0.0028f, // Max traversal speed of azimuth subpart in radians per tick (0.1 is approximately 360 degrees per second).
                    ElevateRate = 0.0024f, // Max traversal speed of elevation subpart in radians per tick.
                    MinAzimuth = -180,
                    MaxAzimuth = 180,
                    MinElevation = -12,
                    MaxElevation = 65,
                ...
                Loading = new LoadingDef
                {
                    ...
                    MagsToLoad = 18, // Number of physical magazines to consume on reload.
                    ...
                    ShotsInBurst = 18, // Use this if you don't want the weapon to fire an entire physical magazine in one go. Should not be more than your magazine capacity.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "NewShipSmallMissileShot", // Audio for firing.
