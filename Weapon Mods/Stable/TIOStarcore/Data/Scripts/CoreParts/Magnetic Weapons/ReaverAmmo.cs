    ...
    partial class Parts
    {
        ...
        private AmmoDef ReaverCoilgunAmmo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                {
                    Distance = 3200f, // Distance at which damage begins falling off.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxTrajectory = 4400f, //3600 Max Distance the projectile or beam can Travel.
                ...
                RangeVariance = Random(start: 350, end: 500), // subtracts value from MaxTrajectory
