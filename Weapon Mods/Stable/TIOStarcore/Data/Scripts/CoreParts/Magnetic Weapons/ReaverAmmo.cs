...
{ // Don't edit above this line
    ...
    {
        //Salvos and Reavers
        private AmmoDef ReaverCoilgunAmmo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "UNSC_Coilgun_MagazineLarge", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "ReaverCoilgunAmmo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.2f, //115MW Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                {
                    Distance = 2800f, // Distance at which damage begins falling off.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxTrajectory = 4000f, //3600 Max Distance the projectile or beam can Travel.
                ...
                RangeVariance = Random(start: 150, end: 300), // subtracts value from MaxTrajectory
        ...
        private AmmoDef MediumCalibreSalvoAmmo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    Ammo = new ParticleDef
                    {
                        ...
                        Extras = new ParticleOptionDef
                        {
                            ...
                            MaxDistance = 0, // Max distance at which this effect should be visible. NOTE: This will use whichever MaxDistance value is higher across Effect1 and Effect2!
                ...
                Lines = new LineDef
                {
                    ColorVariance = Random(start: 1f, end: 4f), // multiply the color by random values within range.
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 50f, //
                        Width = 0.5f, //
                        Color = Color(red: 3f, green: 2f, blue: 1f, alpha: 1f), // red: 2.22f, green: 1.77f, blue: 0.88f, alpha: 5f RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
