...
namespace Scripts {   
    partial class Parts {
        ...
        //vindicator
        WeaponDefinition KineticLance_Vindicator_Super => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "VindicatorKineticLance", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Superheavy Kinetic Battery", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
