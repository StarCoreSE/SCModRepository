...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef GraniteLanceAmmo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "GraniteLance", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.012f, //400MW Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 100000, // Direct damage; one steel plate is worth 100.
            ...
            EnergyMagazineSize = 7, // For energy weapons, how many shots to fire before reloading.
            ...
            Pattern = new PatternDef
            {
                Patterns = new[] { // If enabled, set of multiple ammos to fire in order instead of the main ammo.
                    "GraniteLanceParticles1", "GraniteLanceParticles2",
                },
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Shields = new ShieldDef
                {
                    ...
                    BypassModifier = 1.125f, // If greater than zero, the percentage of damage that will penetrate the shield.
                },
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 80, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). time begins at 0 and time must EXCEED this value to trigger "time > maxValue". Please have a value for this, It stops Bad things.
                AccelPerSec = 0f, // Meters Per Second. This is the spawning Speed of the Projectile, and used by turning.
                DesiredSpeed = 9999, // voxel phasing if you go above 5100
                ...
                Smarts = new SmartsDef
                {
                    ...
                    TrackingDelay = 160, // Measured in Shape diameter units traveled.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 250f, //
                        Width = 0.5f, //
                        Color = Color(red: 50, green: 50, blue: 50f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 10, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 50, // How many ticks after fade began before it will be invisible.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal, // Normal, Cycle, Chaos, Wave
                        DecayTime = 110, // In Ticks. 1 = 1 Additional Tracer generated per motion, 33 is 33 lines drawn per projectile. Keep this number low.
                        Color = Color(red: 3, green: 1, blue: 0, alpha: 0.5f),
                        Back = false,
                        CustomWidth = 1f,
        ...
        private AmmoDef GraniteLanceFakeAmmo1 => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "GraniteLanceParticles1", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.012f, //400MW Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ByBlockHit = new ByBlockHitDef
                {
                    ...
                    Damage = 1f,
                    Depth = 1f, // Max depth of AOE effect, in meters. 0=disabled, and AOE effect will reach to a depth of the radius value
                    MaxAbsorb = 1, // Soft cutoff for damage, except for pooled falloff.  If pooled falloff, limits max damage per block.
                    Falloff = Pooled, //.NoFalloff applies the same damage to all blocks in radius
                    //.Linear drops evenly by distance from center out to max radius
                    //.Curve drops off damage sharply as it approaches the max radius
                    //.InvCurve drops off sharply from the middle and tapers to max radius
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                TargetLossDegree = 180f, // Degrees, Is pointed forward
                TargetLossTime = 1, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                MaxLifeTime = 90, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). time begins at 0 and time must EXCEED this value to trigger "time > maxValue". Please have a value for this, It stops Bad things.
                AccelPerSec = 0f, // Meters Per Second. This is the spawning Speed of the Projectile, and used by turning.
                DesiredSpeed = 9999, // voxel phasing if you go above 5100
                MaxTrajectory = 10000f, // Max Distance the projectile or beam can Travel.
                DeaccelTime = 0, // 0 is disabled, a value causes the projectile to come to rest overtime, (Measured in game ticks, 60 = 1 second)
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 250f, //
                        Width = 2f, //
                        Color = Color(red: 50, green: 50, blue: 50f, alpha: 0.1f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 10, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 50, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "WeaponLaser", // Please always have this Line set, if this Section is enabled.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal, // Normal, Cycle, Chaos, Wave
                        DecayTime = 67, // In Ticks. 1 = 1 Additional Tracer generated per motion, 33 is 33 lines drawn per projectile. Keep this number low.
                        Color = Color(red: 5, green: 5, blue: 5, alpha: 1f),
                        Back = false,
                        CustomWidth = 0.3f,
                        UseWidthVariance = false,
                        UseColorFade = true,
        ...
        private AmmoDef GraniteLanceFakeAmmo2 => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "GraniteLanceParticles2", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.012f, //400MW Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 250f, //
                        Width = 3f, //
                        Color = Color(red: 3, green: 2, blue: 1f, alpha: 0.1f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 10, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 50, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "WeaponLaser", // Please always have this Line set, if this Section is enabled.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Cycle, // Normal, Cycle, Chaos, Wave
                        ...
                        Color = Color(red: 4, green: 3, blue: 3, alpha: 1f),
                        Back = false,
                        CustomWidth = 0.2f,
                        UseWidthVariance = false,
                        UseColorFade = true,
