...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition DualPulseLaserTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "DualPulseLaserTurret", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Small Twin-Linked Laser Turret", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    ElevateRate = 0.0475f, // Max traversal speed of elevation subpart in radians per tick.
                    MinAzimuth = -180,
                    MaxAzimuth = 180,
                    MinElevation = -10,
                    MaxElevation = 52,
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "SmallTwinLaser_Unused", // Audio for firing.
