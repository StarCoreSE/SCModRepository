...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HeavyPlas_X4 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "X4_7x7_HeavyTurret", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "siegeelev", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "siegeazim", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "siegeelev",// Your Elevating Subpart, that bit that moves up.
            ...
            Targeting = new TargetingDef
            {
                ...
                SubSystems = new[] {
                    Offense, Utility, Power, Thrust, Production, Any, // Subsystem targeting priority: Offense, Utility, Power, Production, Thrust, Jumping, Steering, Any
                },
            ...
            HardPoint = new HardPointDef
            {
                ...
                {
                    RateOfFire = 105, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                    BarrelsPerShot = 1, // How many muzzles will fire a projectile per fire event.
                    TrajectilesPerBarrel = 1, // Number of projectiles per muzzle per fire event.
                    SkipBarrels = 0, // Number of muzzles to skip after each fire event.
                    ReloadTime = 890, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    ...
                    HeatPerShot = 80, // Heat generated per shot.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    ReloadSound = "", //needs something //Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
            ...
            Ammos = new[] {
                X3PlasmaMain, X3PlasmaFXshots, X3PlasmaFXshots2, X3PlasmaShrap,
