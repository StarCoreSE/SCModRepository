        ...
        private AmmoDef F3Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    WidthVariance = Random(start: 0f, end: 0.08f), // adds random value to default width (negatives shrinks width)
                    Tracer = new TracerBaseDef
                    {
                        Enable = true,
                        Length = 12f, //30
                        Width = 0.07f, //0.25
                        Color = Color(red: 15.80f, green: 3.00f, blue: 3.00f, alpha: 0.70f), //Color = Color(red: 1f, green: 0.8f, blue: 0.6f, alpha: 1f), RBG 255 is Neon Glowing, 100 is Quite Bright.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 9f, //30
                        Width = 0.05f, //0.25
                        Color = Color(red: 10.40f, green: 2.00f, blue: 2.00f, alpha: 0.80f), //Color = Color(red: 1f, green: 0.8f, blue: 0.6f, alpha: 1f), RBG 255 is Neon Glowing, 100 is Quite Bright.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "ProjectileTrailLine", // Please always have this Line set, if this Section is enabled.
                        },
                        TextureMode = Normal, // Normal, Cycle, Chaos, Wave
