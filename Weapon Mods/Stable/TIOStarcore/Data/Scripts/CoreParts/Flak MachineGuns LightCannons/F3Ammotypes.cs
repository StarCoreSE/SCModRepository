...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef F3Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            {
                Patterns = new[] { // If enabled, set of multiple ammos to fire in order after the main ammo.
                    "Real Fake F-3 Ammo Belt Bullet", "Real Fake F-3 Ammo Belt Bullet", 
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                DesiredSpeed = 1750, // voxel phasing if you go above 5100
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 30f, //
                        Width = 0.25f, //
                        Color = Color(red: 1f, green: 0.8f, blue: 0.6f, alpha: 1f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
