...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AnimationDef Type77_Railgun_AdvancedAnimation => new AnimationDef
        {
            EventParticles = new Dictionary<PartAnimationSetDef.EventTriggers, EventParticle[]>
            {
                [PreFire] = new[]{ //This particle fires in the Prefire state, during the 2 second windup.
                       ...
                       new EventParticle
                       {
                           EmptyNames = Names("muzzle_projectile_4"), //If you want an effect on your own dummy
                           MuzzleNames = Names("muzzle_projectile_4"), //If you want an effect on the muzzle
