...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition QuadCarronadeTurret => new WeaponDefinition
        {
            ...
            Targeting = new TargetingDef
            {
                ...
                MaxTargetDistance = 3000, //2500 Maximum distance at which targets will be automatically shot at; 0 = unlimited.
            ...
            {
                PartName = "Shipwreck Heavy Carronade", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    TrajectilesPerBarrel = 13, // Number of projectiles per muzzle per fire event.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "NewMediumCalibreShotDistB", //MyLargeCalibreShot Audio for firing.
            ...
            Ammos = new[] {
                CarronadeSubMunition, CarronadeSubMunition2E,
