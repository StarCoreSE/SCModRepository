...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition MagDriver_Type25 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Type25_Driver", // Block Subtypeid. Your Cubeblocks contain this information
                        ...
                        ElevationPartId = "Mk3_RailgunElevation",// Your Elevating Subpart, that bit that moves up.
                ...
                Muzzles = new[] {
                    "muzzle_projectile_6",
                    "muzzle_projectile_7",
                    "muzzle_projectile_8", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                    
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "muzzle_projectile_7", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "Type 25 Electromagnetic Driver", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0.07f, // Projectile inaccuracy in degrees.
                ...
                HardWare = new HardwareDef
                {
                    ...
                    ElevateRate = 0.00275f, // Max traversal speed of elevation subpart in radians per tick.
                    MinAzimuth = -180,
                    MaxAzimuth = 180,
                    MinElevation = -10,
                    MaxElevation = 60,
                ...
                {
                    RateOfFire = 493, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                    BarrelsPerShot = 1, // How many muzzles will fire a projectile per fire event.
                    TrajectilesPerBarrel = 1, // Number of projectiles per muzzle per fire event.
                    SkipBarrels = 0, // Number of muzzles to skip after each fire event.
                    ReloadTime = 390, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    MagsToLoad = 3, // Number of physical magazines to consume on reload.
                    DelayUntilFire = 105, // How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
