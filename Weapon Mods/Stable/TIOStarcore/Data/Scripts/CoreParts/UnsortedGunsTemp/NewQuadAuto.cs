...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition QuadBarrelAutocannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "QuadBarrelAutocannon", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "quadautoelev", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "quadautoazim", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "quadautoelev",// Your Elevating Subpart, that bit that moves up.
            ...
            Targeting = new TargetingDef
            {
                ...
                MaxTargetDistance = 3600, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
            ...
            HardPoint = new HardPointDef
            {
                ...
                {
                    RateOfFire = 560, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                    BarrelsPerShot = 1, // How many muzzles will fire a projectile per fire event.
                    TrajectilesPerBarrel = 1, // Number of projectiles per muzzle per fire event.
                    SkipBarrels = 0, // Number of muzzles to skip after each fire event.
                    ReloadTime = 180, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    MagsToLoad = 96, // Number of physical magazines to consume on reload.
                    ...
                    ShotsInBurst = 32, // Use this if you don't want the weapon to fire an entire physical magazine in one go. Should not be more than your magazine capacity.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "Definitive_Muzzle_Flash_MediumCalibre", // Definitive_Muzzle_Flash_MediumCalibre SubtypeId of muzzle particle effect.
