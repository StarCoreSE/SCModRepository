...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition AMP_SwordMelee => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "AMP_SwordMelee", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Sword", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                SwordDefault, // Must list all primary, shrapnel, and pattern ammos.
            },
