...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef FieldDefault => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            EnergyCost = 0.07995f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = true,
                    ParticleScale = 1,
                    CustomParticle = "ArcMuzzle", // Particle SubtypeID, from your Particle SBC
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                AccelPerSec = 5100f, // Meters Per Second. This is the spawning Speed of the Projectile, and used by turning.
