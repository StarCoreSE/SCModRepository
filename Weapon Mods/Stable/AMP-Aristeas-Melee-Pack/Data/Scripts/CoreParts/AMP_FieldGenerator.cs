    ...
    partial class Parts
    {
        ...
        WeaponDefinition AMP_FieldGenerator => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "AMP_EnergyShieldGun", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            Targeting = new TargetingDef
            {
                ...
                SubSystems = new[] {
                    Thrust, Offense, Any, // Subsystem targeting priority: Offense, Utility, Power, Production, Thrust, Jumping, Steering, Any
                },
            ...
            HardPoint = new HardPointDef
            {
                ...
                {
                    RotateRate = 100f, // Max traversal speed of azimuth subpart in radians per tick (0.1 is approximately 360 degrees per second).
                    ElevateRate = 100f, // Max traversal speed of elevation subpart in radians per tick.
                    MinAzimuth = -20,
                    MaxAzimuth = 20,
                    MinElevation = -20,
                    MaxElevation = 20,
                ...
                {
                    RateOfFire = 3600, // Set this to 3600 for beam weapons. This is how fast your Gun fires. 60 = once per second
                    ...
                    MaxHeat = 418, // Max heat before weapon enters cooldown (70% of max heat).
                    Cooldown = .01f, // Percentage of max heat to be under to start firing again after overheat; accepts 0 - 0.95
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "ShipLargeWheelsRun", // Audio for firing.
