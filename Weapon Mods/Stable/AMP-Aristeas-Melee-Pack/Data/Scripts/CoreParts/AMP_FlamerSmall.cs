...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition AMP_FlamerSmall => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "AMP_FlameThrowerSmall", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Fixed Flamer", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "FlamerParticle", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                FlamerDefault, // Must list all primary, shrapnel, and pattern ammos.
            },
