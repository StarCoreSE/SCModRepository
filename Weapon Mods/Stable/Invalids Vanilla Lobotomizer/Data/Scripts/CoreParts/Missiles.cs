...
namespace Scripts {   
    partial class Parts
    {
        ...
        WeaponDefinition LargeMissileLauncherSC => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "LargeMissileLauncher_SC", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Multiple Launched Rockets 2.0", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    IdlePower = 4f, // Constant base power draw in MW.
                ...
                Loading = new LoadingDef
                {
                    ...
                    MaxHeat = 121, // Max heat before weapon enters cooldown (70% of max heat).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "MyShipSmallMissileShot", // Audio for firing.
        ...
        WeaponDefinition LargeMissileTurretSC => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "LargeMissileTurret_SC", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
            ...
            HardPoint = new HardPointDef
            {
                PartName = "Guided Rocket Turret 2.0", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    MaxElevation = 150,
                    HomeAzimuth = 0, // Default resting rotation angle
                    HomeElevation = 6, // Default resting elevation
                    InventorySize = 0.768f, // Inventory capacity in kL.
                    IdlePower = 48f, // Constant base power draw in MW.
                    FixedOffset = false, // Deprecated.
                    Offset = Vector(x: 0, y: 0, z: 0), // Offsets the aiming/firing line of the weapon, in metres.
                    Type = BlockWeapon, // What type of weapon this is; BlockWeapon, HandWeapon, Phantom 
                    CriticalReaction = new CriticalDef
                ...
                Loading = new LoadingDef
                {
                    ...
                    TrajectilesPerBarrel = 1, // Number of projectiles per muzzle per fire event.
                    SkipBarrels = 0, // Number of muzzles to skip after each fire event.
                    ReloadTime = 1260, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                {
                    PreFiringSound = "", // Audio for warmup effect.
                    FiringSound = "TurretMissileShot", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "ShipGatlingNoAmmo",
                    HardPointRotationSound = "TurretHelpImGettingRotated", // Audio played when turret is moving.
                    BarrelRotationSound = "",
                    FireSoundEndDelay = 0, // How long the firing audio should keep playing after firing stops. Measured in game ticks(6 = 100ms, 60 = 1 seconds, etc..).
                    FireSoundNoBurst = true, // Don't stop firing sound from looping when delaying after burst.
                },
            ...
            Ammos = new[] {
                LrgMissileTurretAmmo, // Must list all primary, shrapnel, and pattern ammos.
            },
            //Animations = Weapon75_Animation,
            //Upgrades = UpgradeModules,
        };
