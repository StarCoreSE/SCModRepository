...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition LargeBlockRailgunSC => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "LargeRailgun_SC", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Marek Railgun 2.0", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    Cooldown = .98f, // Percentage of max heat to be under to start firing again after overheat; accepts 0 - 0.95
                ...
                {
                    PreFiringSound = "MyRailgunLargeCharge", // Audio for warmup effect.
                    FiringSound = "MyRailgunLargeShot", // Audio for firing.
