...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef BFG_Cannon_Primary => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "BFG_Cannon_Primary", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                AmmoRound = "C_HE_Fragment", // AmmoRound field of the ammo to spawn.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    CustomSound = "TravelPop", // SubtypeID from your Audio SBC, not a filename
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 780, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). time begins at 0 and time must EXCEED this value to trigger "time > maxValue". Please have a value for this, It stops Bad things.
                ...
                Smarts = new SmartsDef
                {
                    ...
                    MaxLateralThrust = .05, // controls how sharp the trajectile may turn
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 5, green: 5, blue: 5, alpha: 0.8f),
                        Back = false,
                        CustomWidth = 1f,
        ...
        private AmmoDef BFG_Cannon_Frag => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "C_HE_Fragment", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
