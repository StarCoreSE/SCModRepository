...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition EXP_Fission_Beam_Turret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "EXP_Fission_Beam_Turret", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "laser_muzzle_01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            {
                Threats = new[] {
                    Grids, Meteors, Characters, Neutrals // Types of threat to engage: Grids, Projectiles, Characters, Meteors, Neutrals
                },
                SubSystems = new[] {
            ...
            {
                PartName = "Laser Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "NukeLaser_Fire", // Audio for firing.
            ...
            Ammos = new[] {
                Fission_Beam_Primary,
                Fission_Beam_Secondary, // Must list all primary, shrapnel, and pattern ammos.
            },
