...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Ion_Beam => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Ion_Beam", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            EnergyMagazineSize = 460, // For energy weapons, how many shots to fire before reloading.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxTrajectoryTime = 280, // How long the weapon must fire before it reaches MaxTrajectory.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 100f, //
                        Width = 0.5f, //
                        Color = Color(red: 8, green: 9, blue: 20, alpha: 0.5f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            Color = Color(red: 1, green: 1, blue: 99f, alpha: 1),
                            WidthMultiplier = 1f,
                            Reverse = false,
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 4f, green: 6, blue: 12, alpha: 1),
                        Back = false,
                        CustomWidth = 1.5f,
