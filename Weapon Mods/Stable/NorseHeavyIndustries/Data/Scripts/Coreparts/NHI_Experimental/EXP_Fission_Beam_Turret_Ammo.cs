...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Fission_Beam_Primary => new AmmoDef  //Initial Beam that tickles the target.
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Fission_Beam_Primary", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            ...
            EnergyMagazineSize = 18, // For energy weapons, how many shots to fire before reloading.
            ...
            Pattern = new PatternDef
            {
				Patterns = new[] { // If enabled, set of multiple ammos to fire in order instead of the main ammo.
                    "Fission_Beam_Primary", "Fission_Beam_Primary", "Fission_Beam_Primary", "Fission_Beam_Primary", "Fission_Beam_Primary", "Fission_Beam_Primary", "Fission_Beam_Primary", "Fission_Beam_Primary", "Fission_Beam_Primary",
					"Fission_Beam_Primary", "Fission_Beam_Primary", "Fission_Beam_Primary", "Fission_Beam_Primary", "Fission_Beam_Primary", "Fission_Beam_Primary", "Fission_Beam_Primary", "Fission_Beam_Primary", "Fission_Beam_Primary",
					"Fission_Beam_Secondary",
                ...
                RandomMax = 1,
                SkipParent = true,
                PatternSteps = 18, // Number of Ammos activated per round, will progress in order and loop.  Ignored if Random = true.				
            },			
        ...
        private AmmoDef Fission_Beam_Secondary => new AmmoDef  //Shot that detonates on impac.
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Fission_Beam_Secondary", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                DamageVoxels = false, // Whether to damage voxels.
                SelfDamage = false, // Whether to damage the weapon's own grid.
                HealthHitModifier = 30, // How much Health to subtract from another projectile on hit; defaults to 1 if zero or less.
                VoxelHitModifier = 1, // Voxel damage multiplier; defaults to 1 if zero or less.
                Characters = .25f, // Character damage multiplier; defaults to 1 if zero or less.
                // For the following modifier values: -1 = disabled (higher performance), 0 = no damage, 0.01f = 1% damage, 2 = 200% damage.
                FallOff = new FallOffDef
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = false,
                    ParticleScale = 1f,
                    CustomParticle = "NukeLaser", // Particle SubtypeID, from your Particle SBC
                    CustomSound = "LaserNuked", // SubtypeID from your Audio SBC, not a filename
                    Shape = Diamond, // Round or Diamond
                }, 
            },
            Ewar = new EwarDef
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 5f,
                        Width = 2f,
                        Color = Color(red: 0, green: 20, blue: 0, alpha: .9f),
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            SegmentGap = 0f, // Uses Tracer textures and values
                            Speed = 40f, // meters per second
                            Color = Color(red: 0, green: 20, blue: 0, alpha: .8f),
                            WidthMultiplier = .9f,
                            Reverse = false,
                            UseLineVariance = true,
                            WidthVariance = Random(start: -.05f, end: 0f),
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 120,
                        Color = Color(red: 0, green: 10, blue: 0, alpha: .4f),
                        Back = false,
                        CustomWidth = 1f,
                        UseWidthVariance = false,
                        UseColorFade = false,
