...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition SC_Coil_Cannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "SC_Coil_Cannon", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "muzzle_coil_01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A

                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "muzzle_coil_01", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            Targeting = new TargetingDef
            {
                ...
                MinimumDiameter = 5, // Minimum radius of threat to engage.
                MaximumDiameter = 0, // Maximum radius of threat to engage; 0 = unlimited.
                MaxTargetDistance = 6800, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
            ...
            {
                PartName = "CoilCannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RotateRate = 0.0019f, // Max traversal speed of azimuth subpart in radians per tick (0.1 is approximately 360 degrees per second).
                    ElevateRate = 0.0019f, // Max traversal speed of elevation subpart in radians per tick.
                    MinAzimuth = -180,
                    MaxAzimuth = 180,
                    MinElevation = -5,
                    MaxElevation = 35,
                    ...
                    InventorySize = 0.600f, // Inventory capacity in kL.
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 810, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "ArcMK1CoilCannon", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "Exp_Spark_Shockwave", // SubtypeId of muzzle particle effect.
                        Color = Color(red: 10, green: 30, blue: 30, alpha: 1), // Deprecated, set color in particle sbc.
            ...
            Ammos = new[] {
                ...
                CoilGunAmmo_VFX1,
                CoilGunAmmo_VFX2,
                CoilGunAmmo_VFX3, // Must list all primary, shrapnel, and pattern ammos.
            },
