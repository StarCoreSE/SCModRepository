...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef GatLasPulse4 => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Light Pulse Laser", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 25, green: 0, blue: 0f, alpha: .25f),
                        Back = false,
                        CustomWidth = .25f,
