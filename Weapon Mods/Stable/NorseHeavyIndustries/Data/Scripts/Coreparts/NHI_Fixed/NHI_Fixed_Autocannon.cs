...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition NHI_Fixed_Autocannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NHI_Fixed_Autocannon", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "muzzle_auto_01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "muzzle_auto_01", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "'Fenrir' Rotary", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    HeatPerShot = 37, // Heat generated per shot.
                    MaxHeat = 1575, // Max heat before weapon enters cooldown (70% of max heat).
                    Cooldown = .75f, // Percentage of max heat to be under to start firing again after overheat; accepts 0 - 0.95
                    HeatSinkRate = 135, // Amount of heat lost per second.
            ...
            Ammos = new[] {
                Autocannon_Fixed_Bullet_Primary,
                Autocannon_Fixed_Bullet_Secondary,
                Phantom_Primary,
                Phantom_Secondary,
                Fragment_Primary,
                Fragment_Secondary// Must list all primary, shrapnel, and pattern ammos.
            },
