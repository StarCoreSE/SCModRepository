...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef Defense_Bullet_Primary => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "20mmDC1Ammo", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "40mm APHE Shell", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                {
                    Enable = true,
                    Radius = 4.5f, // Radius of AOE effect, in meters.
                    Damage = 1250f,
