...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition NHI_Light_Railgun_Turret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NHI_Light_Railgun_Turret", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "SmallRailBarrels", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "SmallRailBase1", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "SmallRailBarrels",// Your Elevating Subpart, that bit that moves up.
                ...
                Muzzles = new[] {
                    "muzzle_rail_001", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            Targeting = new TargetingDef
            {
                ...
                SubSystems = new[] {
                    Any, Thrust, Utility, Offense, Power, Production,  // Subsystem targeting priority: Offense, Utility, Power, Production, Thrust, Jumping, Steering, Any
                },
            ...
            {
                PartName = "Light Railgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    MaxHeat = 375, // Max heat before weapon enters cooldown (70% of max heat).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Railgun_Fire", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "Railgun_Reload", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "Odin_Railgun_Flash", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                Railgun_Bullet_Small,
                Small_Railgun_Ammo_VFX1,
                Small_Railgun_Ammo_VFX2, // Must list all primary, shrapnel, and pattern ammos.
            },
