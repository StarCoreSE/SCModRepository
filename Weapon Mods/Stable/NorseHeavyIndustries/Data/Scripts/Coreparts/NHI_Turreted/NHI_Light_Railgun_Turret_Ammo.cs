...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Railgun_Bullet_Small => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "150mmRGBAmmo", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            ...
            Pattern = new PatternDef
            {
                Patterns = new[] { // If enabled, set of multiple ammos to fire in order instead of the main ammo.
                    "Small_Railgun_Ammo_VFX1","Small_Railgun_Ammo_VFX2",
                },
        ...
        private AmmoDef Odin_Burst_Railgun_Fragment => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Odin_Burst_Railgun_Fragment", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f, //
                        Width = .25f, //
                        Color = Color(red: 3f, green: 3f, blue: 1f, alpha: 1f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 3f, green: 3f, blue: 1f, alpha: 1f),
                        Back = false,
                        CustomWidth = 0.25f,
                        UseWidthVariance = false,
                        UseColorFade = false,
        ...
        private AmmoDef Small_Railgun_Ammo_VFX1 => new AmmoDef
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Small_Railgun_Ammo_VFX1", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
        ...
        private AmmoDef Small_Railgun_Ammo_VFX2 => new AmmoDef
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Small_Railgun_Ammo_VFX2", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
