...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition E_Starcore_MCRN_Heavy => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "MCRN_Heavy_Torpedo",
            ...
            {
                PartName = "MCRN Torpedo", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    MaxReloads = 6, // Maximum number of reloads in the LIFETIME of a weapon
                },
            ...
            Ammos = new[] {
                E_Starcore_MCRN_Torpedo_Launch,
