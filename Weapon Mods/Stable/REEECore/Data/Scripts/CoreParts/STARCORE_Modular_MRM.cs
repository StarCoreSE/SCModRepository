...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition Modular_MRM => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ModularMRM10",
                    ...
                    new MountPointDef {
                        SubtypeId = "ModularMRM10AngledReversed",
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "None", // The subpart where your muzzle empties are located.
                        AzimuthPartId = "None",
                        ElevationPartId = "None",
            ...
            {
                PartName = "MRM", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RateOfFire = 900, // Set this to 3600 for beam weapons.
                    ...
                    MaxHeat = 11, // Max heat before weapon enters cooldown (70% of max heat).
