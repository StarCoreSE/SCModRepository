...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Starcore_ERPPC_Main => new AmmoDef // StarCore PPC 2
        {
            ...
            {
                AmmoRound = "", //ERPPC_EWAR AmmoRound field of the ammo to spawn.
             ...
             {
                 Patterns = new[] { //"ERPPC_EWAR", // If enabled, set of multiple ammos to fire in order instead of the main ammo.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Shields = new ShieldDef
                {
                    ...
                    BypassModifier = -1.2f, // If greater than zero, the percentage of damage that will penetrate the shield.
                },
            ...
            {
                ModelName = "\\Models\\Ammo\\Starcore_ERPPC_Projectile_Large", //what is this exactly? //Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    {
                        Name = "X4PPCPlasma", //ShipWelderArc
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 24f, //
                        Width = 1f, //
                        Color = Color(red: 6, green: 12, blue: 21f, alpha: 1),
        ...
        private AmmoDef Starcore_ERPPC_Secondary => new AmmoDef // StarCore AMS II
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "ERPPC_EWAR", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
        ...
        private AmmoDef ERPPCFXshots => new AmmoDef // StarCore AMS II
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "ERPPCFXshots", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.0f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
        ...
        private AmmoDef ERPPCFXshots2 => new AmmoDef // StarCore AMS II
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "ERPPCFXshots2", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.0f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 0.4f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 800f, //
                        Width = 0.03f, //
                        Color = Color(red: 18.0f, green: 25.20f, blue: 30.0f, alpha: 0.5f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "WeaponLaser", // Please always have this Line set, if this Section is enabled.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 8.985f, green: 8.162f, blue: 40.81f, alpha: 0.5f),
                        Back = false,
                        CustomWidth = 0.3f,
                        UseWidthVariance = true,
                        UseColorFade = true,
                    ...
                    OffsetEffect = new OffsetEffectDef
                    {
                        MaxOffset = 1.5f,// 0 offset value disables this effect
                        MinLength = 2f,
                        MaxLength = 12f,
                    },
                },
        ...
        private AmmoDef ERPPCFXshots3 => new AmmoDef // StarCore AMS II
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "ERPPCFXshots3", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.0f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
        ...
        private AmmoDef ERPPCFXshots4 => new AmmoDef // StarCore AMS II
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "ERPPCFXshots4", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.0f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
