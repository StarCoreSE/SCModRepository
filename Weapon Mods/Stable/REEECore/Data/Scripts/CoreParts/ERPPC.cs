...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition ERPPC => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ERPPC", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "ER PPC", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "ERPPCFire", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "ERPPCRecharge", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
            ...
            Ammos = new[] {
                Starcore_ERPPC_Main,  // Must list all primary, shrapnel, and pattern ammos.
                Starcore_ERPPC_Secondary,
                ERPPCFXshots,
                ERPPCFXshots2,
                ERPPCFXshots3,
                ERPPCFXshots4,
