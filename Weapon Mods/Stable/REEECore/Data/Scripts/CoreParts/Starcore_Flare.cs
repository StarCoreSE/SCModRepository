...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SC_Flare => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "SC_Flare", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "muzzle_flare_01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                    "muzzle_flare_02",
                    "muzzle_flare_03",
                    "muzzle_flare_04",
                    "muzzle_flare_05",
                ...
                Scope = "scope_SSRM", // Where line of sight checks are performed from. Must be clear of block collision.
            },
