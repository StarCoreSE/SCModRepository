...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Starcore_Arrow_Single => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Starcore_Arrow_Block_Single",
                ...
                Scope = "Arrow_IV_Muzzle", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            Targeting = new TargetingDef
            {
                ...
                SubSystems = new[] {
                    Power, Production, Thrust, Any, Utility, Offense, // Subsystem targeting priority: Offense, Utility, Power, Production, Thrust, Jumping, Steering, Any
                },
            ...
            {
                PartName = "Arrow-IV Reloadable Tactical Nuclear Missiles", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 5400, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    ...
                    HeatPerShot = 90, // Heat generated per shot.
                    MaxHeat = 85, // Max heat before weapon enters cooldown (70% of max heat).
                    Cooldown = 1, // Percentage of max heat to be under to start firing again after overheat; accepts 0 - 0.95
            ...
            Ammos = new[] {
                Starcore_Arrow_Single_Davy_Crockett_Launch,
                Starcore_Arrow_Davy_Crockett_Acceleration,
                Starcore_Arrow_Davy_Crockett_Terminal,
                Starcore_Arrow_Davy_Crockett_Frag,
                Starcore_Arrow_Davy_Crockett_EWAR,
                Starcore_Arrow_Single_Davy_Crockett_Classic_Launch,
                Starcore_Arrow_Davy_Crockett_Classic_Acceleration,
                E_Starcore_OPA_Torpedo_Lock_Tone,
                E_Starcore_OPA_Torpedo_Lock_Tone_Terminal,
            },
            Animations = Starcore_Arrow_Single_Animation,
