...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Starcore_L_Laser_Ammo => new AmmoDef // StarCore AMS I
        {
            ...
            EnergyCost = 0.075f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
