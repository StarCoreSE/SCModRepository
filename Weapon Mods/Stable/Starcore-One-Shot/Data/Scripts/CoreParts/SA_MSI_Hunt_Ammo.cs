...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef K_SA_MSKI_Hunt_I_Stage1 => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Hunt_STG1", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                AmmoRound = "Hunt_STG2", // AmmoRound field of the ammo to spawn.
            ...
            {
                ModelName = "\\Models\\Ammo\\SA_Launcher_VI_Missile_Large", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 10f, //
                        Width = 0.25f, //
                        Color = Color(red: 30, green: 60, blue: 30f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
        ...
        private AmmoDef K_SA_MSKI_Hunt_I_Stage2 => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Hunt_STG2", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 35000f, // Direct damage; one steel plate is worth 100.
            Mass = 5000f, // In kilograms; how much force the impact will apply to the target.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    Ammo = new ParticleDef
                    {
                        Name = "TrailKnows_T", //ShipWelderArc
                        Offset = Vector(x: 0, y: 0, z: 0),
                        Extras = new ParticleOptionDef
                        {
                            Scale = 1,
        ...
        private AmmoDef K_SA_MSKI_Hunt_I_Stage3 => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Hunt_STG3", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 35000f, // Direct damage; one steel plate is worth 100.
            Mass = 5000f, // In kilograms; how much force the impact will apply to the target.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "Hunt_STG4", // AmmoRound field of the ammo to spawn.
                    ...
                    Types = new[] // List of blocks to apply custom damage multipliers to.
    {
            ...
            {
                TravelSound = "K_SA_Flight_ATM", // SubtypeID for your Sound File. Travel, is sound generated around your Projectile in flight
                HitSound = "K_SA_Tartarus_Hit_ATMF",
                ShotSound = "",
                ShieldHitSound = "",
                PlayerHitSound = "",
                VoxelHitSound = "",
        ...
        private AmmoDef K_SA_MSKI_Hunt_I_Stage4 => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Hunt_STG4", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 35000f, // Direct damage; one steel plate is worth 100.
            Mass = 5000f, // In kilograms; how much force the impact will apply to the target.
                    ...
                    Types = new[] // List of blocks to apply custom damage multipliers to.
    {
        ...
        private AmmoDef K_SA_MSKI_Hunt_I_LockLaser => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
                    ...
                    Types = new[] // List of blocks to apply custom damage multipliers to.
{
            ...
            AmmoAudio = new AmmoAudioDef
            {
                ...
                HitSound = "K_SA_Tartarus_ATMF",
                ShotSound = "",
                ShieldHitSound = "K_SA_Tartarus_ATMF",
                PlayerHitSound = "",
                VoxelHitSound = "",
                FloatingHitSound = "",
                HitPlayChance = 1f,
