...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition K_SA_Launcher_Hunt => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_SA_Launcher_VI", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Tartarus", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    HeatPerShot = 28000, // Heat generated per shot.
                    ...
                    MaxActiveProjectiles = 8, // Maximum number of projectiles in flight
                    MaxReloads = 1, // Maximum number of reloads in the LIFETIME of a weapon
                },
                Audio = new HardPointAudioDef
                {
                    PreFiringSound = "", // Audio for warmup effect.
                    FiringSound = "K_SA_Launch_ATMF", // Audio for firing.
            ...
            Ammos = new[] {
                K_SA_MSKI_Hunt_I_Stage1,
                K_SA_MSKI_Hunt_I_Stage2,
                K_SA_MSKI_Hunt_I_Stage3,
                K_SA_MSKI_Hunt_I_Stage4,
                K_SA_MSKI_Hunt_I_LockLaser,
                // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = K_SA_Launcher_Hunt_Animations,
