...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SingleCasemate => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "150mmCasemate", // Block Subtypeid. Your Cubeblocks contain this information
                        ...
                        DurabilityMod = 0.07f, // GeneralDamageMultiplier, 0.25f = 25% damage taken.
                        IconName = "TestIcon.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },
                    
                 },
                Muzzles = new[] {
                    "barrel_1", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            {
                PartName = "150mm Casemate Single", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 0.912f, // Inventory capacity in kL.
                    IdlePower = 0.000001f, // Constant base power draw in MW.
                ...
                Loading = new LoadingDef
                {
                    ...
                    DelayAfterBurst = 110, // How long to spend "reloading" after each burst. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
