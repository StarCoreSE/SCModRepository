...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef FA5SHealShell => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "5InchHealShell", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                Smarts = new SmartsDef
                {
                    ...
                    OffsetRatio = 0.01f, // The ratio to offset the random direction (0 to 1) 
