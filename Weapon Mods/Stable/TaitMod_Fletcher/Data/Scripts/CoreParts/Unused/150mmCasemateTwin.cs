...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition CasemateTwin => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "150mmCasemateTwin", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "barrel_1",
                    "barrel_2"// Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            {
                PartName = "150mm Casemate Twin", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
