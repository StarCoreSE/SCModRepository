...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef SK105mmShell => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "105mmShell", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "105mmHE", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                ModelName = "\\Models\\105mmShellFired_Small.mwm",
