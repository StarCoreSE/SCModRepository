...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef MLE100mmShell => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "100mmMLE1931Shell", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "100mmAPHE", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                ModelName = "\\Models\\100mmMLEShellFired_Small.mwm",
