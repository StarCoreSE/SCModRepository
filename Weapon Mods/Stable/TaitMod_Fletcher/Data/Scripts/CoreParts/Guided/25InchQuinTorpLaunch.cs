...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition QuinTorpLauncher => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "TorpBarbette", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            HardPoint = new HardPointDef
            {
                ...
                Other = new OtherDef
                {
                    ...
                    RestrictionRadius = 5f, // Prevents other blocks of this type from being placed within this distance of the centre of the block.
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 36, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    MagsToLoad = 5, // Number of physical magazines to consume on reload.
                    DelayUntilFire = 0, // How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    HeatPerShot = 13, // Heat generated per shot.
                    MaxHeat = 59, // Max heat before weapon enters cooldown (70% of max heat).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "127mmHVARLaunch", // Audio for firing.
            ...
            Ammos = new[] {
                 TorpLaunch1, SemiGuidedTorp // Must list all primary, shrapnel, and pattern ammos.
            },
