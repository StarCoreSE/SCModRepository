...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FA127mmMK56 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "127mmMk56",  // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {"muzzle_missile_1", "muzzle_missile_2" },
            ...
            {
                PartName = "Montana 5-Inch Mark42", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    DelayAfterBurst = 90, // How long to spend "reloading" after each burst. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
