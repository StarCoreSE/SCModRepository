...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FaTwin105mmRemodel => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "105mmTwin",  // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Prinz Eugen 10.5cm SK C33", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0.09f, // Projectile inaccuracy in degrees.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "GenSmallShot", // Audio for firing.
