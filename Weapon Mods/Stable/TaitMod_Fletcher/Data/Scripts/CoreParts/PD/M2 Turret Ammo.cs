...
{ // Don't edit above this line
 ...
 private AmmoDef FAM2TurretAmmo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "M2BrowningAmmoBox", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "12.7mm", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            Shape = new ShapeDef // Defines the collision shape of the projectile, defaults to LineShape and uses the visual Line Length if set to 0.
            {
                ...
                Diameter = 0.1, // Diameter is minimum length of LineShape or minimum diameter of SphereShape.
            },
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxTrajectory = 2100f, // Max Distance the projectile or beam can Travel.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    Hit = new ParticleDef
                    {
                        ...
                        Color = Color(red: 50, green: 1, blue: 1, alpha: 1),
                        Offset = Vector(x: 0, y: 0, z: 0),
                        Extras = new ParticleOptionDef
                        {
                            Loop = false,
                 ...
                 Lines = new LineDef
                {
                     ...
                     Tracer = new TracerBaseDef
                     {
                         ...
                         Length = 3f,
                         Width = 0.05f,
                         Color = Color(red: 64.00f, green: 27.20f, blue: 1.6f, alpha: 0.2f),
                     },
                     Trail = new TrailDef
                    {
                        Enable = false,
