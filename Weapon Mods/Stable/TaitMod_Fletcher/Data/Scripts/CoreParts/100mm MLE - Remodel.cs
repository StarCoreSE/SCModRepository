...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FaSingle100MMRemodel => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "100mmSingleMain",  // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "100mm/45 MLE 1931 Remodel", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
