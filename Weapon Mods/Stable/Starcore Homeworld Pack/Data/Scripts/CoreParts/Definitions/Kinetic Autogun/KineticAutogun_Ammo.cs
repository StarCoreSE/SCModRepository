...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef CHP_KineticAutogunAmmo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "CHP_KineticAutogunMag", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "KineticAutogun_AP", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                MaxObjectsHit = 6, // Limits the number of grids or projectiles that damage can be applied to, useful to limit overpenetration; 0 = unlimited.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                HealthHitModifier = 7, // How much Health to subtract from another projectile on hit; defaults to 1 if zero or less.
                ...
                {
                    Large = 0.65f, // Multiplier for damage against large grids.
            ...
            AreaOfDamage = new AreaOfDamageDef // Note AOE is only applied to the Player/Grid it hit (and nearby projectiles) not nearby grids/players.
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    MaxAbsorb = 750f, // Soft cutoff for damage (total, against shields or grids), except for pooled falloff.  If pooled falloff, limits max damage per block.
                    Falloff = Pooled, //.NoFalloff applies the same damage to all blocks in radius
                    //.Linear drops evenly by distance from center out to max radius
                    //.Curve drops off damage sharply as it approaches the max radius
                    //.InvCurve drops off sharply from the middle and tapers to max radius
                    ...
                    NoSound = false,
                    ParticleScale = 0.5f,
                    CustomParticle = "CHP_ExplosionSmallImpact", // Particle SubtypeID, from your Particle SBC
                    CustomSound = "CHP_SmallExplosionImpact", // SubtypeID from your Audio SBC, not a filename
                    Shape = Diamond, // Round or Diamond shape.  Diamond is more performance friendly.
                }, 
            },
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                SpeedVariance = Random(start: 1, end: 7), // subtracts value from DesiredSpeed. Be warned, you can make your projectile go backwards.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 2f, //
                        Width = 0.08f, //
                        Color = Color(red: 15, green: 6, blue: 3f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
            ...
            AmmoAudio = new AmmoAudioDef
            {
                ...
                ShotSound = "CHP_KineticAutogunShot",
                ShieldHitSound = "",
                PlayerHitSound = "",
                VoxelHitSound = "",
                FloatingHitSound = "",
		...
		private AmmoDef CHP_KineticAutogunAmmoNoAudio => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "AP_NoSound", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 450f, // Direct damage; one steel plate is worth 100.
            ...
            {
                TravelSound = "", // SubtypeID for your Sound File. Travel, is sound generated around your Projectile in flight
                HitSound = "WepShipGatlingImpMetal",
                ShotSound = "",
                ShieldHitSound = "",
                PlayerHitSound = "",
                VoxelHitSound = "",
