...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition CHP_KineticAutogun => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "CHP_KineticAutogun", // Block Subtypeid. Your Cubeblocks contain this information
					...
					new MountPointDef {
                        SubtypeId = "CHP_KineticAutogunMirror", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Kinetic Autogun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    IdlePower = 0.055f, // Constant base power draw in MW.
