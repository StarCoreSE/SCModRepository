...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef CHP_ArbiterTurretAmmo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "CHP_ArbiterMag", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            ...
            BaseDamage = 7600f, // Direct damage; one steel plate is worth 100.
            Mass = 650f, // In kilograms; how much force the impact will apply to the target.
            Health = 0, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 325000f, // Recoil. This is applied to the Parent Grid.
            ...
            AreaOfDamage = new AreaOfDamageDef // Note AOE is only applied to the Player/Grid it hit (and nearby projectiles) not nearby grids/players.
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    MaxAbsorb = 6000f, // Soft cutoff for damage (total, against shields or grids), except for pooled falloff.  If pooled falloff, limits max damage per block.
                    Falloff = Pooled, //.NoFalloff applies the same damage to all blocks in radius
                    //.Linear drops evenly by distance from center out to max radius
                    //.Curve drops off damage sharply as it approaches the max radius
                    //.InvCurve drops off sharply from the middle and tapers to max radius
            ...
            {
                ModelName = "\\Models\\Ammo\\CHP_ArbiterProjectile.mwm", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
