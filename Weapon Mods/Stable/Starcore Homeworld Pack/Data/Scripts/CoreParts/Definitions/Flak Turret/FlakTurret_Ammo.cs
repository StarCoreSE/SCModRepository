...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef CHP_FlakTurretAmmo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "CHP_FlakMag", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            ...
            BackKickForce = 15000f, // Recoil. This is applied to the Parent Grid.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Armor = new ArmorDef
                {
                    ...
                    Heavy = 0.2f, // Multiplier for damage against heavy armor.
            ...
            AreaOfDamage = new AreaOfDamageDef // Note AOE is only applied to the Player/Grid it hit (and nearby projectiles) not nearby grids/players.
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    MaxAbsorb = 95f, // Soft cutoff for damage (total, against shields or grids), except for pooled falloff.  If pooled falloff, limits max damage per block.
                    Falloff = Pooled, //.NoFalloff applies the same damage to all blocks in radius
                    //.Linear drops evenly by distance from center out to max radius
                    //.Curve drops off damage sharply as it approaches the max radius
                    //.InvCurve drops off sharply from the middle and tapers to max radius
                    ...
                    NoSound = false,
                    ParticleScale = 1.2f,
                    CustomParticle = "CHP_FlakExplosion", // Particle SubtypeID, from your Particle SBC
                    CustomSound = "CHP_FlakImpact", // SubtypeID from your Audio SBC, not a filename
                    Shape = Diamond, // Round or Diamond shape.  Diamond is more performance friendly.
                }, 
            },
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 0.75f, //
                        Width = 0.5f, //
                        Color = Color(red: 12.75f, green: 8.5f, blue: 2.55f, alpha: 0.2f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
