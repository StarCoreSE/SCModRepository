...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition CHP_HeavyTorpedoLauncher => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "CHP_HeavyTorpedoLauncher", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Heavy Torpedo Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 42.41f, // Inventory capacity in kL.
                    IdlePower = 0.375f, // Constant base power draw in MW.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "CHP_HeavyTorpedoShot", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "CHP_MuzzleFlash_Torpedo", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                CHP_HeavyTorpedoAmmo_S1, 
				CHP_HeavyTorpedoAmmo_S2,
				// Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = CHP_HeavyTorpedoAnimation,
