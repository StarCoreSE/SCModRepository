...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef CHP_PlasmaBombAmmo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Plasma Bomb", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 2.19f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            BackKickForce = 500f, // Recoil. This is applied to the Parent Grid.
            ...
            ObjectsHit = new ObjectsHitDef
            {
				...
				SkipBlocksForAOE = true, //If CountBlocks = true this will determine if AOE hits are counted against MaxObjectsHit.  Set true to skip counting for AOE
            },
            ...
            AreaOfDamage = new AreaOfDamageDef // Note AOE is only applied to the Player/Grid it hit (and nearby projectiles) not nearby grids/players.
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    MaxAbsorb = 10000f, // Soft cutoff for damage (total, against shields or grids), except for pooled falloff.  If pooled falloff, limits max damage per block.
                    Falloff = Pooled, //.NoFalloff applies the same damage to all blocks in radius
                    //.Linear drops evenly by distance from center out to max radius
                    //.Curve drops off damage sharply as it approaches the max radius
                    //.InvCurve drops off sharply from the middle and tapers to max radius
                    ...
                    NoSound = false,
                    ParticleScale = 0.75f,
                    CustomParticle = "CHP_PlasmaBombImpact", // Particle SubtypeID, from your Particle SBC
                    CustomSound = "CHP_PlasmaBombImpact", // SubtypeID from your Audio SBC, not a filename
                    Shape = Diamond, // Round or Diamond shape.  Diamond is more performance friendly.
                }, 
            },
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    {
                        Name = "CHP_PlasmaBombTracer", //ShipWelderArc
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 4f, //
                        Width = 1f, //
                        Color = Color(red: 2, green: 2, blue: 125f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        ...
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "DecalGlare", // Please always have this Line set, if this Section is enabled.
                        },
            ...
            AmmoAudio = new AmmoAudioDef
            {
                ...
                HitSound = "CHP_PlasmaBombImpact",
                ShotSound = "CHP_PlasmaBombShot",
                ShieldHitSound = "",
                PlayerHitSound = "",
                VoxelHitSound = "",
                FloatingHitSound = "",
		...
		private AmmoDef CHP_PlasmaBomb_Drone_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "PlasmaBombDrone", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 2.19f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 500f, // Direct damage; one steel plate is worth 100.
            Mass = 25f, // In kilograms; how much force the impact will apply to the target.
