...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition CHP_KineticAutogunPDC => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "CHP_KineticAutogunPDC", // Block Subtypeid. Your Cubeblocks contain this information
                        ...
                        DurabilityMod = 0.75f, // GeneralDamageMultiplier, 0.25f = 25% damage taken.
            ...
            {
                PartName = "Kinetic Autogun PDC", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0.125f, // Projectile inaccuracy in degrees.
                ...
                {
                    RotateRate = 0.028f, // Max traversal speed of azimuth subpart in radians per tick (0.1 is approximately 360 degrees per second).
                    ElevateRate = 0.0224f, // Max traversal speed of elevation subpart in radians per tick.
                    MinAzimuth = -52, // Az/Ele figures are in degrees
                    MaxAzimuth = 52,
                    MinElevation = -50,
                    MaxElevation = 50,
                    HomeAzimuth = 0, // Default resting rotation angle
                    HomeElevation = 0, // Default resting elevation
                    InventorySize = 0.12f, // Inventory capacity in kL.
                    IdlePower = 0.105f, // Constant base power draw in MW.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "CHP_MuzzleFlash_KineticAutogun", // SubtypeId of muzzle particle effect.
