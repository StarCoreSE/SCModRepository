...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition CHP_IonCannonFixed => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "CHP_IonCannonFixed", // Block Subtypeid. Your Cubeblocks contain this information
                        ...
                        DurabilityMod = 0.50f, // GeneralDamageMultiplier, 0.25f = 25% damage taken.
            ...
            {
                PartName = "Ion Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    IdlePower = 0.35f, // Constant base power draw in MW.
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 265, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    MagsToLoad = 1, // Number of physical magazines to consume on reload.
                    DelayUntilFire = 38, // How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                {
                    PreFiringSound = "CHP_IonFixedShotPreFire", // Audio for warmup effect.
                    FiringSound = "CHP_IonFixedShot", // Audio for firing.
                    ...
                    BarrelRotationSound = "",
                    FireSoundEndDelay = 20, // How long the firing audio should keep playing after firing stops. Measured in game ticks(6 = 100ms, 60 = 1 seconds, etc..).
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "CHP_MuzzleFlash_FixedIon", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                CHP_IonCannonFixedAmmo, 
				CHP_IonCannonFixedImpactAmmo,
                 // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = CHP_IonFixed_Animation,
