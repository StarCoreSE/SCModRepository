...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition CHP_MediumMassDriverDualTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "CHP_MediumMassDriverTurret", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Medium Mass Driver Dual Turret", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 460, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
            ...
            Ammos = new[] {
                CHP_MediumMassDriverDualTurretAmmo, 
