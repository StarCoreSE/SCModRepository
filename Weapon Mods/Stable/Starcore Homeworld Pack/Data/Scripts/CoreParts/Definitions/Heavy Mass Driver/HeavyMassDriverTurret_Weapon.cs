...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition CHP_HeavyMassDriverTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "CHP_HeavyMassDriverTurret", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            HardPoint = new HardPointDef
            {
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "CHP_HeavyMassDriverShot", // Audio for firing.
