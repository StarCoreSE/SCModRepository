...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition CHP_MediumMassDriverSingleTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "CHP_MediumMassDriverSingleTurret", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Medium Mass Driver Single Turret", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0.28f, // Projectile inaccuracy in degrees.
                ...
                {
                    RotateRate = 0.00475f, // Max traversal speed of azimuth subpart in radians per tick (0.1 is approximately 360 degrees per second).
                    ElevateRate = 0.00575f, // Max traversal speed of elevation subpart in radians per tick.
                    ...
                    InventorySize = 0.82f, // Inventory capacity in kL.
                    IdlePower = 0.175f, // Constant base power draw in MW.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "CHP_MediumLargeShot", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "CHP_MuzzleFlash_MediumCannon", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                CHP_MediumMassDriverSingleTurretAmmo, 
