...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef CHP_taiidan_interceptor_Main => new AmmoDef // StarCore AMS I
        {
            ...
            {
                AmmoRound = "CHPTaiidanInterceptorAttack", // AmmoRound field of the ammo to spawn.
            ...
            Pattern = new PatternDef
            {
                Patterns = new[] { // If enabled, set of multiple ammos to fire in order instead of the main ammo.
                    "CHPTaiidanInterceptorAttack", "CHPTaiidanInterceptorAttack", "CHPTaiidanInterceptorAttack",
                    "CHPTaiidanInterceptorAttack", "CHPTaiidanInterceptorAttack", "CHPTaiidanInterceptorAttack",
                    "CHPTaiidanInterceptorAttack", "CHPTaiidanInterceptorAttack", "CHPTaiidanInterceptorAttack",
                    "CHPTaiidanInterceptorAttack", "CHPTaiidanInterceptorAttack", "CHPTaiidanInterceptorAttack",
                    "CHPTaiidanInterceptorAttack", "CHPTaiidanInterceptorAttack", "CHPTaiidanInterceptorAttack",
                    ...
                    "CHPTaiidanInterceptorAttack", "CHPTaiidanInterceptorAttack", "CHPTaiidanInterceptorAttack",
                    "CHPTaiidanInterceptorAttack", "CHPTaiidanInterceptorAttack", "CHPTaiidanInterceptorAttack",
                    "CHPTaiidanInterceptorMissileAttack",
                },
        ...
        private AmmoDef CHP_taiidan_interceptor_attack => new AmmoDef
        {
            AmmoMagazine = "CHP_TaiidanInterceptorDrone_Mag", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "CHPTaiidanInterceptorAttack", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
        ...
        private AmmoDef CHP_taiidan_interceptor_missile_attack => new AmmoDef
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "CHPTaiidanInterceptorMissileAttack", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
