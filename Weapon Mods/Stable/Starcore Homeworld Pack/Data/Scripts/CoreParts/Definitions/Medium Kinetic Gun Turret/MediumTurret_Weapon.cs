...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition CHP_MediumKineticTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "CHP_MediumKineticTurret", // Block Subtypeid. Your Cubeblocks contain this information
					...
					new MountPointDef {
                        SubtypeId = "CHP_MediumKineticTurretColorable", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Medium Kinetic Turret", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    ElevateRate = 0.0055f, // Max traversal speed of elevation subpart in radians per tick.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "CHP_MediumShot", // Audio for firing.
