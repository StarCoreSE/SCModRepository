...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef CHP_hiigaran_interceptor_Main => new AmmoDef // StarCore AMS I
        {
            ...
            AmmoRound = "CHPHiigaranInterceptor", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            ...
            {
                AmmoRound = "CHPHiigaranInterceptorAttack", // AmmoRound field of the ammo to spawn.
            ...
            Pattern = new PatternDef
            {
                Patterns = new[] { // If enabled, set of multiple ammos to fire in order instead of the main ammo.
                    "CHPHiigaranInterceptorAttack", "CHPHiigaranInterceptorAttack", "CHPHiigaranInterceptorAttack",
                    "CHPHiigaranInterceptorAttack", "CHPHiigaranInterceptorAttack", "CHPHiigaranInterceptorAttack",
                    "CHPHiigaranInterceptorAttack", "CHPHiigaranInterceptorAttack", "CHPHiigaranInterceptorAttack",
                    "CHPHiigaranInterceptorAttack", "CHPHiigaranInterceptorAttack", "CHPHiigaranInterceptorAttack",
                    "CHPHiigaranInterceptorAttack", "CHPHiigaranInterceptorAttack", "CHPHiigaranInterceptorAttack",
                    ...
                    "CHPHiigaranInterceptorAttack", "CHPHiigaranInterceptorAttack", "CHPHiigaranInterceptorAttack",
                    "CHPHiigaranInterceptorAttack", "CHPHiigaranInterceptorAttack", "CHPHiigaranInterceptorAttack",
                    "CHPHiigaranInterceptorMissileAttack",
                },
        ...
        private AmmoDef CHP_hiigaran_interceptor_attack => new AmmoDef
        {
            AmmoMagazine = "CHP_HiigaranInterceptorDrone_Mag", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "CHPHiigaranInterceptorAttack", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
        ...
        private AmmoDef CHP_hiigaran_interceptor_missile_attack => new AmmoDef
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "CHPHiigaranInterceptorMissileAttack", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    Ammo = new ParticleDef
                    {
                        Name = "fightermissiletrail", //ShipWelderArc
                        Offset = Vector(x: 0, y: 0, z: 0f),
                        DisableCameraCulling = true,// If not true will not cull when not in view of camera, be careful with this and only use if you know you need it
                        Extras = new ParticleOptionDef
                        {
        ...
        private AmmoDef hiigaran_bomber_Main => new AmmoDef // StarCore AMS I
        {
            ...
            AmmoRound = "Hiigaran Bomber", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.001f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "Hiigaran Bomber Attack", // AmmoRound field of the ammo to spawn.
                Fragments = 1, // Number of projectiles to spawn.
        ...
        private AmmoDef hiigaran_bomber_attack => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Hiigaran Bomber Attack", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.001f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
