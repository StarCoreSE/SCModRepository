...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef CHP_KushanInterceptorDrone_Ammo => new AmmoDef // StarCore AMS I
        {
            AmmoMagazine = "CHP_KushanInterceptorDrone_Mag", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Interceptor (H)", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            ...
            Mass = 40000, // In kilograms; how much force the impact will apply to the target.
            Health = 190, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            ...
            {
                AmmoRound = "KineticAutogun_AP", // AmmoRound field of the ammo to spawn.
                ...
                TimedSpawns = new TimedSpawnDef // disables FragOnEnd in favor of info specified below
                {
                    ...
                    MaxSpawns = 320, // Max number of fragment children to spawn
                    Proximity = 850, // Starting distance from target bounding sphere to start spawning fragments, 0 disables this feature.  No spawning outside this distance
                    ...
                    GroupDelay = 150, // Delay between each group.
                },
            },
            Pattern = new PatternDef
            {
                Patterns = new[] { // If enabled, set of multiple ammos to fire in order instead of the main ammo.
                    "AP_NoSound", "AP_NoSound", "AP_NoSound", "AP_NoSound", "AP_NoSound", "AP_NoSound", "AP_NoSound", "KineticAutogun_AP",
                },
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                AccelPerSec = 72f, // Acceleration in Meters Per Second. Projectile starts on tick 0 at its parents (weapon/other projectiles) travel velocity.
                DesiredSpeed = 275f, // voxel phasing if you go above 5100
                ...
                Smarts = new SmartsDef
                {
                    ...
                    ScanRange = 5000,
                    MinTurnSpeed = 25, // set this to a reasonable value to avoid projectiles from spinning in place or being too aggressive turing at slow speeds 
            ...
            {
                ModelName = "\\Models\\Ammo\\CHP_KushanInterceptorDrone.mwm", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 0.1f, //
                        Width = 0.1f, //
                        Color = Color(red: 32, green: 8, blue: 9f, alpha: 0f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 3.1f, green: 4.2f, blue: 7.1f, alpha: 0.1f),
            ...
            {
                TravelSound = "CHP_StrikeCraft_Flyby_Loop", // SubtypeID for your Sound File. Travel, is sound generated around your Projectile in flight
                HitSound = "CHP_Drone_Death",
                ShotSound = "CHP_Drone_Launch",
                ShieldHitSound = "CHP_Drone_Death",
                PlayerHitSound = "CHP_Drone_Death",
                VoxelHitSound = "",
                FloatingHitSound = "",
                HitPlayChance = 1f,
                HitPlayShield = true,
        ...
        private AmmoDef CHP_KushanBomberDrone_Ammo => new AmmoDef // StarCore AMS I
        {
            AmmoMagazine = "CHP_KushanBomberDrone_Mag", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Bomber (H)", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.001f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 10000f, // Direct damage; one steel plate is worth 100. 
            Mass = 40000, // In kilograms; how much force the impact will apply to the target.
            Health = 270, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 10, // Recoil.
            DecayPerShot = 0f, // Damage to the firing weapon itself.
            HardPointUsable = true, // Whether this is a primary ammo type fired directly by the turret. Set to false if this is a shrapnel ammoType and you don't want the turret to be able to select it directly.
            EnergyMagazineSize = 5, // For energy weapons, how many shots to fire before reloading.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "Plasma Bomb", // AmmoRound field of the ammo to spawn.
                Fragments = 1, // Number of projectiles to spawn.
                ...
                {
                    Enable = true, // Enables TimedSpawns mechanism
                    Interval = 12, // Time between spawning fragments, in ticks, 0 means every tick, 1 means every other
                    StartTime = 20, // Time delay to start spawning fragments, in ticks, of total projectile life
                    MaxSpawns = 40, // Max number of fragment children to spawn
                    Proximity = 550, // Starting distance from target bounding sphere to start spawning fragments, 0 disables this feature.  No spawning outside this distance
                    ParentDies = false, // Parent dies once after it spawns its last child.
                    PointAtTarget = true, // Start fragment direction pointing at Target
                    PointType = Predict, // Point accuracy, Direct (straight forward), Lead (always fire), Predict (only fire if it can hit)
                    DirectAimCone = 30f, //Aim cone used for Direct fire, in degrees
                    GroupSize = 5, // Number of spawns in each group
                    GroupDelay = 360, // Delay between each group.
                },
            },
            Pattern = new PatternDef
            {
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                TargetLossTime = 0, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                MaxLifeTime = 36000, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). time begins at 0 and time must EXCEED this value to trigger "time > maxValue". Please have a value for this, It stops Bad things.
                AccelPerSec = 64f, // Acceleration in Meters Per Second. Projectile starts on tick 0 at its parents (weapon/other projectiles) travel velocity.
                DesiredSpeed = 220f, // voxel phasing if you go above 5100
                MaxTrajectory = 1000000f, // Max Distance the projectile or beam can Travel.
                DeaccelTime = 0, // 0 is disabled, a value causes the projectile to come to rest overtime, (Measured in game ticks, 60 = 1 second)
                GravityMultiplier = 0f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable. Natural Gravity Only.
                SpeedVariance = Random(start: -0, end: 0), // subtracts value from DesiredSpeed. Be warned, you can make your projectile go backwards.
                ...
                Approaches = new[] // These approaches move forward and backward in order, once the end condition of the last one is reached it will revert to default behavior. Cost level of 4+, or 5+ if used with steering.
                {
                    ...
                    new ApproachDef // Orbit
                    {
                        ...
                        // navigation behavior 
                        Orbit = true, // Orbit the Position
                        OrbitRadius = 550, // The orbit radius to extend between the projectile and the Position (target volume + this value)
                        OffsetMinRadius = 0, // Min Radius to offset from Position.  
                        OffsetMaxRadius = 0, // Max Radius to offset from Position.  
                        OffsetTime = 0, // How often to change the offset radius.
            ...
            AmmoGraphics = new GraphicDef
            {
                ModelName = "\\Models\\Ammo\\CHP_KushanBomberDrone.mwm", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
                VisualProbability = 1f, // %
                ShieldHitDraw = true,
                Particles = new AmmoParticleDef
                {
