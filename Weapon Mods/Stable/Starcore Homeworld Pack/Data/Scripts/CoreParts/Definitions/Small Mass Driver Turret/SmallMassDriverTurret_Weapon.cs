...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition CHP_SmallMassDriverTurretLG => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "CHP_SmallMassDriverTurretLG", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Small Mass Driver Turret LG", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 135, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "CHP_SmallMassDriverShot", // Audio for firing.
		...
		WeaponDefinition CHP_SmallMassDriverTurretSG => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "CHP_SmallMassDriverTurretSG", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            HardPoint = new HardPointDef
            {
                PartName = "Small Mass Driver Turret SG", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
