...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition DoomsdayCannonLarge => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "DoomsdayCannonLarge", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Doomsday Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                DoomsdayGauss,
                DoomsdayGaussFrag,// Must list all primary, shrapnel, and pattern ammos.
            },
