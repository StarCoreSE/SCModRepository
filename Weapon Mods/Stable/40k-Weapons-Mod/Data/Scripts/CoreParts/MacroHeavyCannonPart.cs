...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HeavyMacroCannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "HeavyMacroCannon", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "HeavyMacroCannonElevation", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "HeavyMacroCannonAzimuth", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "HeavyMacroCannonElevation",// Your Elevating Subpart, that bit that moves up
            ...
            {
                PartName = "Heavy Macro Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    ReloadSound = "MacroReload", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
            ...
            Ammos = new[] {
                HeavyMacroCannonAmmo, // Must list all primary, shrapnel, and pattern ammos.
            },
