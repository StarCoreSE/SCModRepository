...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FluxArcLarge => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "FluxArcLarge", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "Elevationlarge", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "Azimuthlarge", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "Elevationlarge",// Your Elevating Subpart, that bit that moves up.
                ...
                Muzzles = new[] {
                    "muzzle01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                    "muzzle02",
                    "muzzle03",
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "muzzle02", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            Targeting = new TargetingDef
            {
                Threats = new[] {
                    Projectiles, Grids, Characters, // Types of threat to engage: Grids, Projectiles, Characters, Meteors, Neutrals, ScanRoid, ScanPlanet, ScanFriendlyCharacter, ScanFriendlyGrid, ScanEnemyCharacter, ScanEnemyGrid, ScanNeutralCharacter, ScanNeutralGrid, ScanUnOwnedGrid, ScanOwnersGrid
                },
                SubSystems = new[] {
            ...
            {
                PartName = "Gauss Flux Arc", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    MinElevation = -15,
                    MaxElevation = 50,
                    HomeAzimuth = -45, // Default resting rotation angle
                ...
                {
                    RateOfFire = 100, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                    ...
                    Cooldown = .40f, // Percentage of max heat to be under to start firing again after overheat; accepts 0 - 0.95
                    HeatSinkRate = 1800, // Amount of heat lost per second.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "NerconLightFire", // Audio for firing.
                    ...
                    FireSoundEndDelay = 220, // How long the firing audio should keep playing after firing stops. Measured in game ticks(6 = 100ms, 60 = 1 seconds, etc..).
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "NecronMuzzleFlashSmall", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                FluxArcammo,  // Must list all primary, shrapnel, and pattern ammos.
            },
