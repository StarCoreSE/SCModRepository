...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition MacroLightTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "MacroLightTurret", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "MacroLightTurretElevation", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "MacroLightTurretAzimuth", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "MacroLightTurretElevation",// Your Elevating Subpart, that bit that moves up
            ...
            {
                PartName = "Light Macro Cannon Turret", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
