...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition EarthshakerCannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "EarthshakerCannon", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Earthshaker Artillery Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "EarthshakerCannonFire", // Audio for firing.
            ...
            Ammos = new[] {
                EarthshakerCannonRound,  // Must list all primary, shrapnel, and pattern ammos.
            },
