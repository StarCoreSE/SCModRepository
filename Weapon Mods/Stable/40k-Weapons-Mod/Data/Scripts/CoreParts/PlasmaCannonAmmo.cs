...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef PlasmaCannonRound => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Plasma Cannon Round", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            DecayPerShot = 1000f, // Damage to the firing weapon itself. 
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 5f, //
                        Width = 2f, //
                        Color = Color(red: 12, green: 10, blue: 200f, alpha: 2), // RBG 255 is Neon Glowing, 100 is Quite Bright.
