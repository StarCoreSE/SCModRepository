...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition LightLightningArc => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "LightLightningArc", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            Ammos = new[] {
                LightNecronLightning,  // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = LightLightningArcAnimation,
