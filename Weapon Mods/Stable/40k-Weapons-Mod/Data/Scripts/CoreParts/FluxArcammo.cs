...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef FluxArcammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
 ...
 private AmmoDef FluxArcammo2 => new AmmoDef // Your ID, for slotting into the Weapon CS --- This ammo has been stripped to a minimal config as an example
        {
            AmmoMagazine = "Energy", 
            AmmoRound = "Ammo 2", 
            HybridRound = false, 
