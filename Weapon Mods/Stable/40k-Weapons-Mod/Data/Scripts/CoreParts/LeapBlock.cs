...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition NID_Leap => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NID_Leap", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Tyranid Leap", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                Leap_ammo,  // Must list all primary, shrapnel, and pattern ammos.
            },
