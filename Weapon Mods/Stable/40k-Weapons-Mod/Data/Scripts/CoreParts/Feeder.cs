...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition NID_Feeder => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NID_Feeder", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Feeder Tentacle", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                Feeder_ammo, // Must list all primary, shrapnel, and pattern ammos.
            },
