...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Lascannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Lascannon", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Lascannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    Offset = Vector(x: 0, y: 0, z: 30), // Offsets the aiming/firing line of the weapon, in metres.
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 80, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    MagsToLoad = 1, // Number of physical magazines to consume on reload.
                    DelayUntilFire = 0, // How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    HeatPerShot = 300, // Heat generated per shot.
                    MaxHeat = 1400, // Max heat before weapon enters cooldown (70% of max heat).
                    Cooldown = 0.2f, // Percentage of max heat to be under to start firing again after overheat; accepts 0 - 0.95
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "LascannonFire", // Audio for firing.
