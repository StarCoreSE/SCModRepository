...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition MonoWhip => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "MonoWhip", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "MonoElevation", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "MonoAzimuth", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "MonoElevation",// Your Elevating Subpart, that bit that moves up.
