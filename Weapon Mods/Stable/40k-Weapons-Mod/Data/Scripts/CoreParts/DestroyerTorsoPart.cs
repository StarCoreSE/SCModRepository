...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition DestroyerTorso => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        ...
                        MuzzlePartId = "ArmElevation", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "AzimuthTorso", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "ArmElevation",// Your Elevating Subpart, that bit that moves up.
            ...
            {
                PartName = "DestroyerHeavyGauss", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                HeavyGaussAmmo, // Must list all primary, shrapnel, and pattern ammos.
            },
