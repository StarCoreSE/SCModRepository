...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef EarthshakerCannonRound => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Earthshaker Cannon Round", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 4f, //
                        Width = 1f, //
                        Color = Color(red: 20, green: 10, blue: 10f, alpha: 2), // RBG 255 is Neon Glowing, 100 is Quite Bright.
