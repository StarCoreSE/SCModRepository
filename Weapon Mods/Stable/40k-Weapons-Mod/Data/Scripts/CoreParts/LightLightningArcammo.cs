...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef LightNecronLightning => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "LightNecronLightning", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            EnergyMagazineSize = 40, // For energy weapons, how many shots to fire before reloading.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 0.5f, //
                        Width = 0.25f, //
                        Color = Color(red: 15f, green: 55, blue: 15f, alpha: 0.1f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            Color = Color(red: 15, green: 55, blue: 15f, alpha: 0.1f),
                            WidthMultiplier = 1f,
                            Reverse = false,
            ...
            {
                TravelSound = "NecronTravel", // SubtypeID for your Sound File. Travel, is sound generated around your Projectile in flight
                HitSound = "NecronHitLight",
                ShotSound = "",
                ShieldHitSound = "",
                PlayerHitSound = "",
                VoxelHitSound = "",
