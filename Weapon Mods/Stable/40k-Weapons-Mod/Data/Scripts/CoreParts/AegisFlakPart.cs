...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AegisFlakTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "AegisFlakTurret", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "AegisFlakTurretElevation", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "AegisFlakTurretAzimuth", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "AegisFlakTurretElevation",// Your Elevating Subpart, that bit that moves up
                ...
                Muzzles = new[] {
                    "muzzle1", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                    "muzzle2",
                    "muzzle3",
                    "muzzle4",
                ...
                Ejector = "muzzle1", // Optional; empty from which to eject "shells" if specified.
                Scope = "muzzle1", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {   
                PartName = "Aegis Autocannon Flak Turret", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    HomeElevation = 30, // Default resting elevation
                    InventorySize = 1f, // Inventory capacity in kL.
                    IdlePower = 0.02f, // Constant base power draw in MW.
                    FixedOffset = false, // Deprecated.
                    Offset = Vector(x: 0f, y: 0f, z: 0), // Offsets the aiming/firing line of the weapon, in metres.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "AegisFlakFire", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "AegisFlakReload", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
