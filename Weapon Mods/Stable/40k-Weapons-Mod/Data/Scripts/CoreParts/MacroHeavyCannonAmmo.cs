...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef HeavyMacroCannonAmmo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 6f, //
                        Width = 2.5f, //
                        Color = Color(red: 300, green: 10, blue: 10f, alpha: 3), // RBG 255 is Neon Glowing, 100 is Quite Bright.
            ...
            {
                TravelSound = "MacroCannonWhistle", // SubtypeID for your Sound File. Travel, is sound generated around your Projectile in flight
                HitSound = "HeavyMacroHit",
                ShieldHitSound = "",
                PlayerHitSound = "",
                VoxelHitSound = "",
                FloatingHitSound = "",
