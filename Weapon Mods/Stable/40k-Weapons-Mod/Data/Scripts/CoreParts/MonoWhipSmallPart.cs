...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition MonoWhipSmall => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "MonoWhipSmall", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "MonoElevationSmall", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "MonoAzimuthSmall", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "MonoElevationSmall",// Your Elevating Subpart, that bit that moves up.
            ...
            Targeting = new TargetingDef
            {
                ...
                SubSystems = new[] {
                    Power, Thrust, Utility, Offense, Production, Any, // Subsystem targeting priority: Offense, Utility, Power, Production, Thrust, Jumping, Steering, Any
                },
            ...
            {
                PartName = "Particle Whip", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RotateRate = 5f, // Max traversal speed of azimuth subpart in radians per tick (0.1 is approximately 360 degrees per second).
                    ElevateRate = 5f, // Max traversal speed of elevation subpart in radians per tick.
                    MinAzimuth = -180,
                    MaxAzimuth = 180,
                    MinElevation = -45,
                    MaxElevation = 80,
                ...
                {
                    RateOfFire = 16, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                    BarrelsPerShot = 1, // How many muzzles will fire a projectile per fire event.
                    TrajectilesPerBarrel = 1, // Number of projectiles per muzzle per fire event.
                    SkipBarrels = 0, // Number of muzzles to skip after each fire event.
                    ReloadTime = 720, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    MagsToLoad = 1, // Number of physical magazines to consume on reload.
                    DelayUntilFire = 85, // How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                {
                    PreFiringSound = "NecronCharge", // Audio for warmup effect.
                    FiringSound = "NerconMonoFire", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "NecronMuzzleflash", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                MonoWhipAmmo1, 
                MonoWhipAmmo2, // Must list all primary, shrapnel, and pattern ammos.
            },
            //Animations = ParticleWhipAnimation,
