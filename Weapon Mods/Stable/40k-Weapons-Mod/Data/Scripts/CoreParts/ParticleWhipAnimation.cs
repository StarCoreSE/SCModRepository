...
{ // Don't edit above this line
    partial class Parts
    {
        private AnimationDef ParticleWhipAnimation => new AnimationDef
        {
                               ...
                               new RelMove
                                {
                                    ...
                                    LinearPoints = new[]
                                    {
                                        Transformation(0, 1.2, 0), //linear movement
                                    },
                                ...
                                new RelMove
                                {
                                    ...
                                    MovementType = Linear,
                                    LinearPoints = new XYZ[0],
                                    Rotation = Transformation(0, 360f, 0), //degrees
                                    RotAroundCenter = Transformation(0, 0, 0), //degrees
                                },
                                ...
                                new RelMove
                                {
                                    ...
                                    MovementType = Linear,
                                    LinearPoints = new XYZ[0],
                                    Rotation = Transformation(0, 1440f, 0), //degrees
                                    RotAroundCenter = Transformation(0, 0, 0), //degrees
                                },
