...
{ // Don't edit above this line
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 0, green: 5, blue: 0, alpha: 3),
                        FactionColor = DontUse, // DontUse, Foreground, Background.
                        Back = false,
                        CustomWidth = 0,
 ...
 private AmmoDef MonoWhipAmmo2 => new AmmoDef // Your ID, for slotting into the Weapon CS --- This ammo has been stripped to a minimal config as an example
        {
            AmmoMagazine = "Energy", 
            AmmoRound = "Ammo 2", 
            HybridRound = false, 
