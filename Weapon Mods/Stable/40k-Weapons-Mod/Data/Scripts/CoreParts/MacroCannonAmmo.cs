...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef MacroCannonAmmo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "MacroCannonAmmoMag", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Macro Cannon Round", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                {
                    Modifier = 4.5f, // Multiplier for damage against shields.
            ...
            {
                ModelName = "\\Models\\Ammo\\CannonRound.mwm", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 5f, //
                        Width = 2f, //
                        Color = Color(red: 100, green: 10, blue: 10f, alpha: 5), // RBG 255 is Neon Glowing, 100 is Quite Bright.
