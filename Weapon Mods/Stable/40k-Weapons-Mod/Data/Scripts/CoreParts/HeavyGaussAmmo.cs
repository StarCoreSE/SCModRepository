...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef HeavyGaussAmmo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                HealthHitModifier = 80, // How much Health to subtract from another projectile on hit; defaults to 1 if zero or less.
            ...
            AreaOfDamage = new AreaOfDamageDef // Note AOE is only applied to the Player/Grid it hit (and nearby projectiles) not nearby grids/players.
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    MaxAbsorb = 200f, // Soft cutoff for damage, except for pooled falloff.  If pooled falloff, limits max damage per block.
                    Falloff = Pooled, //.NoFalloff applies the same damage to all blocks in radius
                    //.Linear drops evenly by distance from center out to max radius
                    //.Curve drops off damage sharply as it approaches the max radius
                    //.InvCurve drops off sharply from the middle and tapers to max radius
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 5f, //
                        Width = 0.1f, //
                        Color = Color(red: 3, green: 10, blue: 1f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            Color = Color(red: 0, green: 10, blue: 0f, alpha: 1),
                            FactionColor = DontUse, // DontUse, Foreground, Background.
                            WidthMultiplier = 1f,
                            Reverse = false, 
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 0, green: 5, blue: 0, alpha: 2),
                        FactionColor = DontUse, // DontUse, Foreground, Background.
                        Back = false,
                        CustomWidth = 0.2f,
 ...
 private AmmoDef HeavyGaussAmmo2 => new AmmoDef // Your ID, for slotting into the Weapon CS --- This ammo has been stripped to a minimal config as an example
        {
            AmmoMagazine = "Energy", 
            AmmoRound = "Ammo 2", 
            HybridRound = false, 
