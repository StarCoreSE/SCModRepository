...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition DestroyerHead => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "DestroyerTorso", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "HeadElevation", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "Head", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "HeadElevation",// Your Elevating Subpart, that bit that moves up.
                ...
                Muzzles = new[] {
                    "muzzlehead", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "muzzlehead", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "DestroyerHead", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                NothingAmmo, // Must list all primary, shrapnel, and pattern ammos.
            },
            //Animations = LightningArcAnimation,
