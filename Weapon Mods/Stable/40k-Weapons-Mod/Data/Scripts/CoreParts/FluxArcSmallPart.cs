...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FluxArcSmall => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "FluxArcSmall", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "Elevationsmall", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "Azimuthsmall", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "Elevationsmall",// Your Elevating Subpart, that bit that moves up.
