...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition MacroCannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "MacroCannon", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "MacroBarrel", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "MacroAzimuth", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "MacroBarrel",// Your Elevating Subpart, that bit that moves up
            ...
            {
                PartName = "Macro Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 590, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "MacroFire", // Audio for firing.
