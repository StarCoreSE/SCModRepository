...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef LightParticleWhipAmmo1 => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            Color = Color(red: 0, green: 5, blue: 0f, alpha: 1),
                            FactionColor = DontUse, // DontUse, Foreground, Background.
                            WidthMultiplier = 1f,
                            Reverse = false, 
 ...
 private AmmoDef LightParticleWhipAmmo2 => new AmmoDef // Your ID, for slotting into the Weapon CS --- This ammo has been stripped to a minimal config as an example
        {
            AmmoMagazine = "Energy", 
            AmmoRound = "Ammo 2", 
            HybridRound = false, 
