...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition BattleCannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "BattleCannon", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Battle Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "BattleCannonFire", // Audio for firing.
            ...
            Ammos = new[] {
                BattleCannonRound,  // Must list all primary, shrapnel, and pattern ammos.
            },
