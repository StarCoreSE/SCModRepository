...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HeavyBolterSmall => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "HeavyBolterSmall", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Heavy Bolter", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
