...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef BattleCannonRound => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Battle Cannon Shell", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            Mass = 12f, // In kilograms; how much force the impact will apply to the target.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                GravityMultiplier = 40f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable. Natural Gravity Only.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 4f, //
                        Width = 0.5f, //
                        Color = Color(red: 20, green: 10, blue: 10f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
