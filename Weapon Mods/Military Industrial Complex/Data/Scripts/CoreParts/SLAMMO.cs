...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef SLAMMO => new AmmoDef // StarCore AMS I
        {
            AmmoMagazine = "SLAMMO", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "SLAMMO", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            ...
            Mass = 500000f, // In kilograms; how much force the impact will apply to the target.
            ...
            {
                AmmoRound = "SLAM Nuke Acceleration", // AmmoRound field of the ammo to spawn.
                ...
                TimedSpawns = new TimedSpawnDef // disables FragOnEnd in favor of info specified below
                {
                    ...
                    Interval = 300, // Time between spawning fragments, in ticks, 0 means every tick, 1 means every other
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = false,
                    ParticleScale = 1,
                    CustomParticle = "ArmorDestroyed_Large", // Particle SubtypeID, from your Particle SBC
                    CustomSound = "SLAMPipeHit", // SubtypeID from your Audio SBC, not a filename
                    Shape = Diamond, // Round or Diamond
                },
            },
            Ewar = new EwarDef
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 8420, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). Please have a value for this, It stops Bad things.
                ...
                Smarts = new SmartsDef
                {
                    ...
                    MaxTargets = 2000, // Number of targets allowed before ending, 0 = unlimited
                ...
                Approaches = new[] // These approaches move forward and backward in order, once the end condition of the last one is reached it will revert to default behavior. Cost level of 4+, or 5+ if used with steering.
                {
                    ...
                    new ApproachDef // GO IN! GO IN NOW
                    {
                        // Start/End behaviors 
                        ...
                        AlternateModel = "", // Define only if you want to switch to an alternate model in this phase
                        AlternateSound = "SLAMDedKiddo" // if blank it will use default, must be a default version for this to be useable. 
                    },
                },
                //FUCK OFF 
            ...
            {
                ModelName = "\\Models\\SLAM_Missile", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    {
                        Name = "SLAMARROWTRAIL", //ShipWelderArc
                        Offset = Vector(x: 0, y: 0, z: 0),
                        Extras = new ParticleOptionDef
                        {
                            Scale = 1,
                ...
                Lines = new LineDef
                {
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 100, green: 0, blue: 0, alpha: 1),
                        Back = false,
                        CustomWidth = 1f,
            ...
            {
                TravelSound = "SLAMTravel", // SubtypeID for your Sound File. Travel, is sound generated around your Projectile in flight
                HitSound = "",
                ShieldHitSound = "",
                PlayerHitSound = "",
                VoxelHitSound = "",
        ...
        private AmmoDef SLAM_NUKE_Acceleration => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "SLAM Nuke Acceleration", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "SLAM Nuke Terminal", // AmmoRound field of the ammo to spawn.
                Fragments = 1, // Number of projectiles to spawn.
                Degrees = 0, // Cone in which to randomize direction of spawned projectiles.
                Reverse = false, // Spawn projectiles backward instead of forward.
            ...
            AmmoAudio = new AmmoAudioDef
            {
                TravelSound = "SLAMTravelOffshoot", // SubtypeID for your Sound File. Travel, is sound generated around your Projectile in flight
                HitSound = "SLAMHit",
                ShieldHitSound = "SLAMHit",
                PlayerHitSound = "",
                VoxelHitSound = "",
                FloatingHitSound = "",
                HitPlayChance = 1f,
        ...
        private AmmoDef SLAM_NUKE_Terminal => new AmmoDef
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "SLAM Nuke Terminal", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.01f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "SLAM Nuke Frag", // AmmoRound field of the ammo to spawn.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = false,
                    ParticleScale = 1,
                    CustomParticle = "SLAMSignificant Fissionable Event", // Particle SubtypeID, from your Particle SBC
        ...
        private AmmoDef SLAM_NUKE_Frag => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "SLAM Nuke Frag", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.01f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
