...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SLAM => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "SLAM", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Project Pluto (SLAM)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    HeatPerShot = 10001, // Heat generated per shot.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "SLAMLaunch", // Audio for firing.
            ...
            Ammos = new[] {
                SLAMMO,
                SLAM_NUKE_Acceleration,
				SLAM_NUKE_Terminal,
                SLAM_NUKE_Frag,
            },

            Animations = SLAM_Animation,
