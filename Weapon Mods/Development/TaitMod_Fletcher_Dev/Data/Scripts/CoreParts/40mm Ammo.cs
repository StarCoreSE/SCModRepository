...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Bofor40mm => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "40mmClip", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "40mm Bofors", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            Pattern = new PatternDef
            {
                Patterns = new[] { // If enabled, set of multiple ammos to fire in order instead of the main ammo.
                    "40mm HET", "40mm APT", "40mm APT", "40mm HET", "40mm APT", "40mm APT",
                }, 
                Enable = true,
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                RangeVariance = Random(start: 100, end: 3000), // subtracts value from MaxTrajectory
            ...
            {
                ModelName = "\\Models\\40mmShell_Small.mwm",
                ...
                Lines = new LineDef
                {
                    ...
                    WidthVariance = Random(start: 0f, end: 0.07f), // adds random value to default width (negatives shrinks width)
                    Tracer = new TracerBaseDef
                    {
                        Enable = true,
                        Length = 5f,
                        Width = 0.05f,
                        Color = Color(red: 20.00f, green: 8.20f, blue: 1.6f, alpha: 0.8f),
                    },
                    Trail = new TrailDef
                    {
                        Enable = false,
            ...
            Ejection = new EjectionDef // Optional Component, allows generation of Particle or Item (Typically magazine), on firing, to simulate Tank shell ejection
            {
                ...
                {
                    ItemName = "40mmShellCaseEmpty", //InventoryComponent name
                    ItemLifeTime = 100, // how long item should exist in world
                    Delay = 30, // delay in ticks after shot before ejected
                }
            }, // Don't edit below this line
        };

        private AmmoDef Bofor40mmShrap => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "40mmShrap", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
        ...
        private AmmoDef Bofor40mmHET => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "40mmClip", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "40mm HET", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 5f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                DamageVoxels = false, // Whether to damage voxels.
                SelfDamage = false, // Whether to damage the weapon's own grid.
                HealthHitModifier = 120, // How much Health to subtract from another projectile on hit; defaults to 1 if zero or less.
                VoxelHitModifier = 1, // Voxel damage multiplier; defaults to 1 if zero or less.
                Characters = -1f, // Character damage multiplier; defaults to 1 if zero or less.
                // For the following modifier values: -1 = disabled (higher performance), 0 = no damage, 0.01f = 1% damage, 2 = 200% damage.
                FallOff = new FallOffDef
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    TracerMaterial = "ProjectileTrailLine", // WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                    ColorVariance = Random(start: 0.5f, end: 0.8f), // multiply the color by random values within range.
                    WidthVariance = Random(start: 0f, end: 0.06f), // adds random value to default width (negatives shrinks width)
                    Tracer = new TracerBaseDef
                    {
                        Enable = true,
                        Length = 6f,
        ...
        private AmmoDef Bofor40mmAPT => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "40mmClip", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "40mm APT", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 5f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 6f,
                        Width = 0.05f,
                        Color = Color(red: 20.0f, green: 10.0f, blue: 10.0f, alpha: 0.8f),
                    },
                    Trail = new TrailDef
                    {
                        Enable = false,
