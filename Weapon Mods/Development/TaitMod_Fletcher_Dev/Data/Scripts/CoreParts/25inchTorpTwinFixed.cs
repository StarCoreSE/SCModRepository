    ...
    partial class Parts {
        ...
        WeaponDefinition Torpedo635mm => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef //Unguided 10km Torpedo
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "TorpTestBuidl", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "Muzzle_1", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                    "Muzzle_2",
                },
            ...
            Targeting = new TargetingDef
            {
                ...
                MaximumDiameter = 5000, // Maximum radius of threat to engage; 0 = unlimited.
            ...
            {
                PartName = "Torpedo Twin Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    MaxHeat = 30, // Max heat before weapon enters cooldown (70% of max heat).
