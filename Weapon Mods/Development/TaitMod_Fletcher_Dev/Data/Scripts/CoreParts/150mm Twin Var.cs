...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FA15CmCATwinNR => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "15cmSKC28NR",  // Block Subtypeid. Your Cubeblocks contain this information
            ...
            HardPoint = new HardPointDef
            {
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "15CmFire", // Audio for firing.
