...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FA15CmSingle => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "15cmTbtsKC36",  // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "15Cm Tbts KC36T", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 350, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "6InchFire", // Audio for firing.
