...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef HEShell203 => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "8HEInchShell", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "8InchHE", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                AmmoRound = "203mmShrap", // AmmoRound field of the ammo to spawn.
    ...
    private AmmoDef HEShrap203 => new AmmoDef // Your ID, for slotting into the Weapon CS
{
