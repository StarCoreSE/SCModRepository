...
{ // Don't edit above this line
    ...
    {
            // 3 emitters
        private AmmoDef CarronadeSubMunition => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "AutoShellAmmo", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Heavy Carronade Submunitions", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            Pattern = new PatternDef
            {
                Patterns = new[] { // If enabled, set of multiple ammos to fire in order instead of the main ammo.
                    "Heavy Carronade 2 Emitters", "Heavy Carronade 2 Emitters", "Heavy Carronade 2 Emitters",
                },
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    Damage = 25000f,
                    Depth = 0f, // Max depth of AOE effect, in meters. 0=disabled, and AOE effect will reach to a depth of the radius value
                    MaxAbsorb = 3500f, // Soft cutoff for damage, except for pooled falloff.  If pooled falloff, limits max damage per block.
                    ...
                    NoSound = true,
                    ParticleScale = 1f,
                    CustomParticle = "K_SA_Explosion_III_3E", // Particle SubtypeID, from your Particle SBC
            ...
            // 2 emitters
        private AmmoDef CarronadeSubMunition2E => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Heavy Carronade 2 Emitters", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1000f, // Direct damage; one steel plate is worth 100.
            Mass = 50f, // In kilograms; how much force the impact will apply to the target.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Shields = new ShieldDef
                {
                    Modifier = 8f, // Multiplier for damage against shields.
                    Type = Default, // Damage vs healing against shields; Default, Heal
                    BypassModifier = -1.4f, // If greater than zero, the percentage of damage that will penetrate the shield.
                },
                DamageType = new DamageTypes // Damage type of each element of the projectile's damage; Kinetic, Energy
                {
                    Base = Energy, // Base Damage uses this
            ...
            Ejection = new EjectionDef // Optional Component, allows generation of Particle or Item (Typically magazine), on firing, to simulate Tank shell ejection
            {
      	   ...
      	   // fires in a 1 to 3 ratio, to reduce emitter useage. 29 emitters used per shot eep. (a 50% reduction from previous setup!)   		
