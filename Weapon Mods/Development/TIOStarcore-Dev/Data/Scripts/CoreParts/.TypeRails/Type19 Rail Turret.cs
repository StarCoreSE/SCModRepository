...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition MagDriver_Type19 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Type19_Driver", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "muzzle_projectile_4", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                    
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "muzzle_projectile_4", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            Targeting = new TargetingDef
            {
                ...
                SubSystems = new[] {
                    Steering, Utility, Power, Offense, Thrust, Production, Any, // Subsystem targeting priority: Offense, Utility, Power, Production, Thrust, Jumping, Steering, Any
                },
            ...
            {
                PartName = "Type 19 Electromagnetic Driver", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0.0f, // Projectile inaccuracy in degrees.
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 2.7f, // Inventory capacity in kL.
                    IdlePower = 20f, // Constant base power draw in MW.
                ...
                {
                    RateOfFire = 190, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                    BarrelsPerShot = 1, // How many muzzles will fire a projectile per fire event.
                    TrajectilesPerBarrel = 1, // Number of projectiles per muzzle per fire event.
                    SkipBarrels = 0, // Number of muzzles to skip after each fire event.
                    ReloadTime = 1440, //280 Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    MagsToLoad = 7, // Number of physical magazines to consume on reload.
                    DelayUntilFire = 91, // How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    HeatPerShot = 80, //100 Heat generated per shot.
                    MaxHeat = 105, // Max heat before weapon enters cooldown (70% of max heat).
                    Cooldown = .95f, // Percentage of max heat to be under to start firing again after overheat; accepts 0 - 0.95
                    HeatSinkRate = 21, // Amount of heat lost per second.
                    ...
                    DelayAfterBurst = 240, // How long to spend "reloading" after each burst. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                {
                    PreFiringSound = "RailgunPreFire", // Audio for warmup effect.
                    ...
                    FireSoundEndDelay = 480, // How long the firing audio should keep playing after firing stops. Measured in game ticks(6 = 100ms, 60 = 1 seconds, etc..).
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "KillerB_Muzzle_Flash_LargeCalibre", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                Standard_MagDrivenDart_Ammo,
                Standard_MagDrivenDart_Shrap,
                 // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = MK1Railgun_AdvancedAnimation,
