...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition MagDriver_Type22 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Type22_Driver", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "muzzle_projectile_1",
                    "muzzle_projectile_2", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
            ...
            {
                Threats = new[] {
                    Grids, Meteors, Neutrals, // Types of threat to engage: Grids, Projectiles, Characters, Meteors, Neutrals, ScanRoid, ScanPlanet, ScanFriendlyCharacter, ScanFriendlyGrid, ScanEnemyCharacter, ScanEnemyGrid, ScanNeutralCharacter, ScanNeutralGrid, ScanUnOwnedGrid, ScanOwnersGrid
                },
                SubSystems = new[] {
                    Steering, Utility, Offense, Power, Thrust, Production, Any, // Subsystem targeting priority: Offense, Utility, Power, Production, Thrust, Jumping, Steering, Any
                },
            ...
            {
                PartName = "Type 22 Electromagnetic Driver", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    IdlePower = 40f, // Constant base power draw in MW.
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 745, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    MagsToLoad = 8, // Number of physical magazines to consume on reload.
                    DelayUntilFire = 99, // How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    HeatPerShot = 60, // Heat generated per shot.
                    MaxHeat = 80, // Max heat before weapon enters cooldown (70% of max heat).
                    Cooldown = 0.05f, // Percentage of max heat to be under to start firing again after overheat; accepts 0 - 0.95
                    ...
                    DelayAfterBurst = 220, // How long to spend "reloading" after each burst. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                {
                    PreFiringSound = "RailgunPreFireMedium", // Audio for warmup effect.
