...
{ // Don't edit above this line
    partial class Parts
    {
       ...
       // Type Bofor Flak
        private AmmoDef BoforFlak_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            AmmoRound = "Flak Shell", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 64f, //
                        Width = 1f, //
                        Color = Color(red: 4f, green: 3f, blue: 2f, alpha: 0.75f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
