        ...
        WeaponDefinition HAS_Thanatos => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 600, // 20 seconds Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    ...
                    HeatSinkRate = 5, // 24 seconds, takes 4 seconds to fire, cools off under 10%, thus heat doesnt restrict gun, just a reload counter. //Amount of heat lost per second.
