...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Spinal_AutoCoil_Base_A => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            EnergyCost = .6f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            BackKickForce = 1.6E+04f, // Recoil. This is applied to the Parent Grid.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                HealthHitModifier = 1001, // why?? //How much Health to subtract from another projectile on hit; defaults to 1 if zero or less.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxTrajectory = 7000, // Max Distance the projectile or beam can Travel.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Decals = new DecalDef
                {
                    ...
                    Map = new[]
                    {
                        ...
                        {
                            HitMaterial = "Metal",
                            DecalMaterial = "SA_Shatter_Big_Decal",
                        },
                    },
                },
                Particles = new AmmoParticleDef
                {
                    ...
                    {
                        Name = "AutoCoil_ZapsReduced_3", //ShipWelderArc
                ...
                Lines = new LineDef
                {
                    ColorVariance = Random(start: 0f, end: 100f), // multiply the color by random values within range.
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 10f, //
                        Width = 0.15f, //
                        Color = Color(red: 30, green: 20, blue: 1f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 30, green: 20, blue: 7, alpha: 1),
                        Back = false,
                        CustomWidth = 0,
            ...
            {
                TravelSound = "Monopole_Shell_Pass", // SubtypeID for your Sound File. Travel, is sound generated around your Projectile in flight
                HitSound = "",
                ShotSound = "",
                ShieldHitSound = "",
                PlayerHitSound = "",
        ...
        private AmmoDef Spinal_AutoCoil_Shrap => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "AutoCoil_Shrap", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            BaseDamage = 11055, // Direct damage; one steel plate is worth 100.
            Mass = 0, // In kilograms; how much force the impact will apply to the target.
            Health = 0, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxTrajectory = 20, // Max Distance the projectile or beam can Travel.
                DeaccelTime = 0, // 0 is disabled, a value causes the projectile to come to rest overtime, (Measured in game ticks, 60 = 1 second)
                GravityMultiplier = 0f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable. Natural Gravity Only.
                SpeedVariance = Random(start: 0, end: 0), // subtracts value from DesiredSpeed. Be warned, you can make your projectile go backwards.
                RangeVariance = Random(start: 0, end: 0), // subtracts value from MaxTrajectory
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 15f, //
                        Width = 0.45f, //
                        Color = Color(red: 30, green: 10, blue: 1f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 1, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 30, green: 10, blue: 7, alpha: 1),
                        Back = false,
                        CustomWidth = 0,
                        UseWidthVariance = false,
                        UseColorFade = true,
        ...
        private AmmoDef Spinal_AutoCoil_VFX1 => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "AutoCoil_VFX1", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 200f,
                        Width = 0.45f,
                        Color = Color(red: 0, green: 20, blue: 40, alpha: 1),
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            SegmentGap = 0f, // Uses Tracer textures and values
                            Speed = 1f, // meters per second
                            Color = Color(red: 1, green: 2, blue: 4f, alpha: 1),
                            WidthMultiplier = 1f,
                            Reverse = false,
                            UseLineVariance = true,
                            WidthVariance = Random(start: 0f, end: 0f),
        ...
        private AmmoDef Spinal_AutoCoil_VFX2 => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "AutoCoil_VFX2", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.0825f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
        ...
        private AmmoDef Spinal_AutoCoil_VFX3 => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "AutoCoil_VFX3", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.0825f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
