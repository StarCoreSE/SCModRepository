...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef K_SA_MHI_PGBC_A => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            EnergyCost = 0.2769f, //899MW Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            {
                Patterns = new[] { // If enabled, set of multiple ammos to fire after the main ammo. live is 1:1.  Season 3 was 1:3.
                    "Charon_Fake_Shot",
                },
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                {
                    Enable = true,
                    Radius = 6f, //16 blocks hit on the first layer if round, will test for diamond. probably 12 blocks. //Radius of AOE effect, in meters.
                    Damage = 60000f,
                    Depth = 0f, // Max depth of AOE effect, in meters. 0=disabled, and AOE effect will reach to a depth of the radius value
                    MaxAbsorb = 5000f, //armor damage reduced so max absorb increased to solve it // Soft cutoff for damage, except for pooled falloff.  If pooled falloff, limits max damage per block.
                    Falloff = Pooled, //.NoFalloff applies the same damage to all blocks in radius
                    //.Linear drops evenly by distance from center out to max radius
                    //.Curve drops off damage sharply as it approaches the max radius
                    //.InvCurve drops off sharply from the middle and tapers to max radius
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 32f, //
                        Width = 0.8f, //
                        Color = Color(red: 10.6f, green: 8.75f, blue: 2.75f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 10.6f, green: 8.75f, blue: 2.75f, alpha: 0.5f),
                        Back = false,
                        CustomWidth = 0,
            ...
            AmmoAudio = new AmmoAudioDef
            {
                ...
                ShieldHitSound = "K_SA_Charon_Impact",
                PlayerHitSound = "",
                VoxelHitSound = "",
                FloatingHitSound = "",
                HitPlayChance = 1f,
        ...
        private AmmoDef K_SA_MHI_PGBC_A_Bounce => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "K_GaussPrototypeBlitzCase", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Charon_Shot_Bounce", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = false,
                    ParticleScale = 1,
                    CustomParticle = "Exp_Spark_HYDRA", // Particle SubtypeID, from your Particle SBC
        ...
        private AmmoDef Charon_Fake => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Charon_Fake_Shot", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.2f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
