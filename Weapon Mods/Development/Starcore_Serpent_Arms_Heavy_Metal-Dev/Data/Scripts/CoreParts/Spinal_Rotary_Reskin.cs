...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SA_HeavyMetal_Spinal_Rotary_Reskin => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_SA_HeavyMetal_Spinal_Rotary_Reskin", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "muzzle_projectile_002", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "Scope_Rotary", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "Magnetic Monopole Compression Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0.45f, // Projectile inaccuracy in degrees.
                ...
                {
                    PreFiringSound = "Monopole_Charge_1", // Audio for warmup effect.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "K_SA_GaussFire_rotary_Flash_2", // SubtypeId of muzzle particle effect.
            ...
            Animations = SA_HeavyMetal_Spinal_Rotary_Animation,
