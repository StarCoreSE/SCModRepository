...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SA_HeavyMetal_Spinal_Rotary => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_SA_HeavyMetal_Spinal_Rotary", // Block Subtypeid. Your Cubeblocks contain this information
