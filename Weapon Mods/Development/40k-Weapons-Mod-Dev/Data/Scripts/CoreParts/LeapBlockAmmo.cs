...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Leap_ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Leap_ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            BackKickForce = 40000000000f, // Recoil. This is applied to the Parent Grid.
