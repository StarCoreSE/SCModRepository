...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition NID_Pyroacid => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NID_Pyroacid", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            Ammos = new[] {
                Pyroacid_ammo, 
                Pyroacid_guided_ammo,
                Pyroacid_splash_ammo,
                Pyroacid_splash2_ammo, // Must list all primary, shrapnel, and pattern ammos.
            },
