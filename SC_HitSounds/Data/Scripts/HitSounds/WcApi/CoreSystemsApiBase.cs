...
namespace CoreSystems.Api
{
    ...
    public partial class WcApi
    {
        ...
        /// <summary>
        /// Multiplier for <paramref name="block"/>'s base Rate of Fire. Only works if called from server.
        /// </summary>
        ...
        /// <summary>
        /// BaseDamage multiplier for all projectiles from <paramref name="block"/>. Only works if called from server.
        /// </summary>
        /// <param name="block"></param>
        ...
        /// <summary>
        /// AreaDamage multiplier for all projectiles from <paramref name="block"/>. Only works if called from server.
        /// </summary>
        /// <param name="block"></param>
        /// <param name="multiplier"></param>
        ...
        /// <summary>
        /// AreaRadius multiplier for all projectiles from <paramref name="block"/>. Only works if called from server.
        /// </summary>
        /// <param name="block"></param>
        /// <param name="multiplier"></param>
        ...
        /// <summary>
        /// Velocity multiplier for all projectiles from <paramref name="block"/>. Avoid setting this to zero. Only works if called from server.
        /// </summary>
        /// <param name="block"></param>
        /// <param name="multiplier"></param>
        ...
        /// <summary>
        /// Toggles whether <paramref name="block"/> is allowed to shoot. Only works if called from server.
        /// </summary>
        /// <param name="block"></param>
        /// <param name="multiplier"></param>
