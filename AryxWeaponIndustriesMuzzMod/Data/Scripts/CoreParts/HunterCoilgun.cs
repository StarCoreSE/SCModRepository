    ...
    partial class Parts {
        ...
        WeaponDefinition AryxLightCoilgun => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXLightCoilgun", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Hunter 405mm Coilgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    IdlePower = 38f, // Constant base power draw in MW.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "ArcWepShipARYXLightCoilgunFire", // Audio for firing.
            ...
            Ammos = new[] {
                AryxLightCoilgunAmmoWC,
                AryxLightCoilgunAmmoShrapWC,
                AryxLightCoilgunAmmoWC_L,
                AryxLightCoilgunAmmoWC_U,
                AryxLightCoilgunAmmoWC_U_Branch,
                AryxLightCoilgunAmmoWC_U_Effect1,
                AryxLightCoilgunAmmoWC_U_Effect2,// Must list all primary, shrapnel, and pattern ammos.
            },
