...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef AryxGaussAmmoWC => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            {
                MaxObjectsHit = 21, // Limits the number of entities (grids, players, projectiles) the projectile can penetrate; 0 = unlimited.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Armor = new ArmorDef
                {
                    Armor = 0.08f, // Multiplier for damage against all armor. This is multiplied with the specific armor type multiplier (light, heavy).
                    Light = -1f, // Multiplier for damage against light armor.
                    Heavy = -1f, // Multiplier for damage against heavy armor.
                    NonArmor = 0.07f, // Multiplier for damage against every else.
                },
                Shields = new ShieldDef
                {
                    Modifier = 1f, // Shield mult. Do not exceed 1 for byblockhit weapons, modify everything else down and use base damage instead.
        ...
        private AmmoDef AryxGaussAmmoBONK => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "GaussAmmoMagDef", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            ...
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.0018334f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 660000f, // Direct damage; one steel plate is worth 100.
            Mass = 1f, // In kilograms; how much force the impact will apply to the target.
            Health = 0, // How much damage the proj ectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 5E8f, // Recoil. This is applied to the Parent Grid.
            DecayPerShot = 0f, // Damage to the firing weapon itself.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                FallOff = new FallOffDef
                {
                    Distance = 20000f, // Distance at which damage begins falling off.
                    MinMultipler = 1f, // Value from 0.0001f to 1f where 0.1f would be a min damage of 10% of base damage.
                },
                Grids = new GridSizeDef
                {
                ...
                Shields = new ShieldDef
                {
                    Modifier = 25f, // Multiplier for damage against shields.
                    Type = Default, // Damage vs healing against shields; Default, Heal
                    BypassModifier = -1f, // If greater than zero, the percentage of damage that will penetrate the shield.
                },
                DamageType = new DamageTypes // Damage type of each element of the projectile's damage; Kinetic, Energy
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 100f, //
                        Width = 1f, //
                        Color = Color(red: 45, green: 20, blue: 90f, alpha: 10), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 20, green: 12, blue: 50, alpha: 1),
                        Back = false,
                        CustomWidth = 2,
                        UseWidthVariance = false,
                        UseColorFade = true,
        ...
        private AmmoDef AryxGaussAmmoDamage => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            EnergyCost = 0.0018334f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 660000f, // Direct damage; one steel plate is worth 100.
            Mass = 3.44E7f, // In kilograms; how much force the impact will apply to the target.
            Health = 0, // How much damage the proj ectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 5E8f, // Recoil. This is applied to the Parent Grid.
            DecayPerShot = 0f, // Damage to the firing weapon itself.
            HardPointUsable = false, // Whether this is a primary ammo type fired directly by the turret. Set to false if this is a shrapnel ammoType and you don't want the turret to be able to select it directly.
