...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxFocusLance => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXFocusLance", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Focus Beam", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "ArcWepShipARYXFocusBeamFire", // Audio for firing.
