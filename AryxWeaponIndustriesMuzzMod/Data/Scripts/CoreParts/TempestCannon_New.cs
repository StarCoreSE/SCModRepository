...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxTempestCannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXTempestCannon", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Tempest", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "TempestMuzzleFlash", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                AryxTyphoonAmmoWC,
                AryxTyphoonAmmoWC_Frag,
                AryxTyphoonAmmoWC_Contact,// Must list all primary, shrapnel, and pattern ammos.
            },
