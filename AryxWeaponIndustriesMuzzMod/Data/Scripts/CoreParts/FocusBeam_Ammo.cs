...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef AryxSmallFocusBeamLanceAmmo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
        ...
        private AmmoDef AryxSmallFocusPulseLanceAmmo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
