...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition K_SA_LoW_CapitalSpinalA => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_SA_LoW_CapitalSpinalA", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Scope = "scope_CSA", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            HardPoint = new HardPointDef
            {
                ...
                Loading = new LoadingDef
                {
                    ...
                    HeatPerShot = 12150, // Heat generated per shot.
                    MaxHeat = 48600, // Max heat before weapon enters cooldown (70% of max heat).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Hydra_Fire", // Audio for firing.
