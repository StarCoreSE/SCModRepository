...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HakkeroProjectile => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "HakkeroProjectile", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Arcane Octagon (Projectile)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0f, // Projectile inaccuracy in degrees.
                AimingTolerance = 360f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                ...
                Loading = new LoadingDef
                {
                    ...
                    DelayAfterBurst = 720, // How long to spend "reloading" after each burst. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                {
                    PreFiringSound = "zapgunfiring", // Audio for warmup effect.
                    FiringSound = "rocklaunch", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "powerup", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "biogunmuzzle", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                RockStage1,
                RockStage2,
                RockStageFinal,  // Must list all primary, shrapnel, and pattern ammos.

                HakkeroSquarePortalStage0Dummy,
                HakkeroSquarePortalStage1Beam,
                HakkeroSquarePortalStage2Smart,
                HakkeroSquarePortalStage3Final,
                HealingOrrery,
                HealingOrreryStage2,
                HealingOrreryStage3HealPulse,
                octagon_telegraph_shot_dummy,
                octagon_telegraph_shot_Main,
                octagon_telegraph_shot_beam,
                octagon_telegraph_shot_proj,
            },
            Animations = Octagon_Animation,
            //Upgrades = UpgradeModules,
        };
        // Don't edit below this line.

        // Don't edit above this line
        WeaponDefinition HakkeroProjectileMini => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "HakkeroProjectileMini", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "GatlingBarrel", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "None", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "None", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "None",// Your Elevating Subpart, that bit that moves up.
            ...
            HardPoint = new HardPointDef
            {
                PartName = "Arcane Octagon Compact (Projectile)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0f, // Projectile inaccuracy in degrees.
                AimingTolerance = 360f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                AimLeadingPrediction = Off, // Level of turret aim prediction; Off, Basic, Accurate, Advanced
                DelayCeaseFire = 0, // Measured in game ticks (6 = 100ms, 60 = 1 second, etc..). Length of time the weapon continues firing after trigger is released - while a target is available.
