...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition LargeGatlingTurretSC => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "LargeGatlingTurret_SC", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Gatling Turret 2.0", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "MyShipGatlingShot", // Audio for firing.
                    ...
                    BarrelRotationSound = "ShipGatlingRotation",
                ...
                Graphics = new HardPointParticleDef
                {
                    Effect1 = new ParticleDef
                    {
                        ...
                        Extras = new ParticleOptionDef
                        {
                            ...
                            MaxDuration = 3, // How many ticks the effect should be ended after, if it's still running.
                            Scale = 4f, // Scale of effect.
                        },
                    },
