...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FaTwin100MM1945Remodel => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "100mm55Main",  // Block Subtypeid. Your Cubeblocks contain this information
            ...
            Targeting = new TargetingDef
            {
                ...
                MaxTargetDistance = 2300, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
            ...
            {
                PartName = "100mm/45 MLE 1931 Twin Remodel", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "100mmFire", // Audio for firing.
            ...
            Ammos = new[] {
                MLE100mmShell, // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = FA100mmTwinRecoil,
