...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FaTwin100MMRemodel => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "100mmTwinMain",  // Block Subtypeid. Your Cubeblocks contain this information
            ...
            Targeting = new TargetingDef
            {
                ...
                MaxTargetDistance = 3800, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
