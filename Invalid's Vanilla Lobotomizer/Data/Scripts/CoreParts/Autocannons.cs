...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AutoCannonTurretSC => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "AutoCannonTurret_SC", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            Targeting = new TargetingDef
            {
                ...
                CycleBlocks = 2, // Number of blocks to "cycle" per acquire attempt.                StopTrackingSpeed = 1000, // Do not track threats traveling faster than this speed; 0 = unlimited.
                StopTrackingSpeed = 0, // Do not track threats traveling faster than this speed; 0 = unlimited.

            },
            HardPoint = new HardPointDef
            {
                PartName = "Autocannon Turret 2.0", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "ShipAutocannonShot", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "ShipGatlingNoAmmo",
                    HardPointRotationSound = "TurretGatlingRotate", // Audio played when turret is moving.
                    BarrelRotationSound = "",
            ...
            Ammos = new[] {
                AutocannonTShell, // Must list all primary, shrapnel, and pattern ammos.
            },
