...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition LargeBlockAssaultCannonTurretSC => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "LargeBlockMediumCalibreTurret_SC", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Assault Cannon Autoloader 2.0", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "MyMediumCalibreShot", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "MyMediumCalibreReload", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
