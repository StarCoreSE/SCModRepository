    ...
    class PointAdditions : MySessionComponentBase
    {
        public override void Init(MyObjectBuilder_SessionComponent sessionComponent)
        {
            MyAPIGateway.Utilities.SendModMessage(2546247, MyAPIGateway.Utilities.SerializeToBinary(@"
				...
				AQD_LG_HydroThrusterL_ArmoredSlope@300;
				AQD_LG_HydroThrusterL_Armored@300;
				...
				LargeBlockLargeHydrogenThrust@300;
				LargeBlockSmallHydrogenThrust@50;
				LargeBlockLargeHydrogenThrustIndustrial@300;
				LargeBlockSmallHydrogenThrustIndustrial@50;
