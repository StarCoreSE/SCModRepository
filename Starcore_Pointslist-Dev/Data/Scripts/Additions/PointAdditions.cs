    ...
    class PointAdditions : MySessionComponentBase
    {
        public override void Init(MyObjectBuilder_SessionComponent sessionComponent)
        {
            MyAPIGateway.Utilities.SendModMessage(2546247, MyAPIGateway.Utilities.SerializeToBinary(@"
				...
				AQD_LG_HydroThrusterL_ArmoredSlope@40;
				AQD_LG_HydroThrusterL_Armored@40;
				AQD_LG_HydroThrusterS_ArmoredSlope@8;
				AQD_LG_HydroThrusterS_Armored@8;
				AWGFocusDrive@100;
				IonHeavyCovered@100;
				...
				LargeBlockLargeHydrogenThrust@40;
				LargeBlockSmallHydrogenThrust@8;
				LargeBlockLargeHydrogenThrustIndustrial@40;
				LargeBlockSmallHydrogenThrustIndustrial@8;
				HugeHydrogenThruster@150;
