...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef HAS_MammonMK2_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "MammonMK2 Beam", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            EnergyMagazineSize = 500, // For energy weapons, how many shots to fire before reloading.
