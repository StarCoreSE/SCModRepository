...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HAS_MammonMK2B1 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        ...
                        MuzzlePartId = "MammonMK2Elevation1", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "Azimuth1", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "MammonMK2Elevation1",// Your Elevating Subpart, that bit that moves up
                ...
                Muzzles = new[] {
                    "MammonMK2Barrel1", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "MammonMK2Barrel1", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "MammonBarrel1", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                DelayCeaseFire = 240, // Measured in game ticks (6 = 100ms, 60 = 1 second, etc..). Length of time the weapon continues firing after trigger is released.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "HAS_Mammon_Release", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    Effect1 = new ParticleDef
                    {
                        ...
                        Color = Color(red: 11, green: 11, blue: 11, alpha: 1), // Deprecated, set color in particle sbc.
            ...
            Ammos = new[] {
                HAS_MammonMK2_Ammo,  // Must list all primary, shrapnel, and pattern ammos.
            },
            //Animations = SA_HMI_ERGaussRF_Animation,
            //Upgrades = UpgradeModules,
        };

        WeaponDefinition HAS_MammonMK2B2 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "HAS_MammonMK2", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "MammonMK2Elevation2", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "Azimuth2", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "MammonMK2Elevation2",// Your Elevating Subpart, that bit that moves up
                        DurabilityMod = 0.25f, // GeneralDamageMultiplier, 0.25f = 25% damage taken.
                        IconName = "" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },
                ...
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "MammonMK2Barrel2", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            Targeting = new TargetingDef
            {
                Threats = new[] {
            ...
            HardPoint = new HardPointDef
            {
                PartName = "MammonBarrel2", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0f, // Projectile inaccuracy in degrees.
                AimingTolerance = 45f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                AimLeadingPrediction = Accurate, // Level of turret aim prediction; Off, Basic, Accurate, Advanced
                DelayCeaseFire = 240, // Measured in game ticks (6 = 100ms, 60 = 1 second, etc..). Length of time the weapon continues firing after trigger is released.
        ...
        WeaponDefinition HAS_MammonMK2B3 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "HAS_MammonMK2", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "MammonMK2Elevation3", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "Azimuth3", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "MammonMK2Elevation3",// Your Elevating Subpart, that bit that moves up
                        DurabilityMod = 0.25f, // GeneralDamageMultiplier, 0.25f = 25% damage taken.
                        IconName = "" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },
                ...
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "MammonMK2Barrel3", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            Targeting = new TargetingDef
            {
                Threats = new[] {
            ...
            HardPoint = new HardPointDef
            {
                PartName = "MammonBarrel3", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0f, // Projectile inaccuracy in degrees.
                AimingTolerance = 45f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                AimLeadingPrediction = Accurate, // Level of turret aim prediction; Off, Basic, Accurate, Advanced
                DelayCeaseFire = 240, // Measured in game ticks (6 = 100ms, 60 = 1 second, etc..). Length of time the weapon continues firing after trigger is released.
        ...
        WeaponDefinition HAS_MammonMK2B4 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "HAS_MammonMK2", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "MammonMK2Elevation4", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "Azimuth4", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "MammonMK2Elevation4",// Your Elevating Subpart, that bit that moves up
                        DurabilityMod = 0.25f, // GeneralDamageMultiplier, 0.25f = 25% damage taken.
                        IconName = "" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },
                ...
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "MammonMK2Barrel4", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            Targeting = new TargetingDef
            {
                Threats = new[] {
            ...
            HardPoint = new HardPointDef
            {
                PartName = "MammonBarrel4", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0f, // Projectile inaccuracy in degrees.
                AimingTolerance = 45f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                AimLeadingPrediction = Accurate, // Level of turret aim prediction; Off, Basic, Accurate, Advanced
                DelayCeaseFire = 240, // Measured in game ticks (6 = 100ms, 60 = 1 second, etc..). Length of time the weapon continues firing after trigger is released.
        ...
        WeaponDefinition HAS_MammonMK2B5 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                ...
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "MammonMK2Barrel5", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            Targeting = new TargetingDef
            {
                Threats = new[] {
            ...
            HardPoint = new HardPointDef
            {
                PartName = "MammonBarrel5", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0f, // Projectile inaccuracy in degrees.
                AimingTolerance = 45f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                AimLeadingPrediction = Accurate, // Level of turret aim prediction; Off, Basic, Accurate, Advanced
                DelayCeaseFire = 240, // Measured in game ticks (6 = 100ms, 60 = 1 second, etc..). Length of time the weapon continues firing after trigger is released.
