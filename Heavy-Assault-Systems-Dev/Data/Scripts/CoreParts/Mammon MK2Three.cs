...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HAS_MammonMK23 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                ...
                Muzzles = new[] {
                    "MammonBarrel3", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "MammonBarrel3", // Where line of sight checks are performed from. Must be clear of block collision.
            },
