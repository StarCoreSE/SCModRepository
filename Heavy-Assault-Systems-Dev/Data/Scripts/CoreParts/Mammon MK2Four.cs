...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HAS_MammonMK24 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                ...
                Muzzles = new[] {
                    "MammonBarrel4", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "MammonBarrel4", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "Mammon Mk2", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
