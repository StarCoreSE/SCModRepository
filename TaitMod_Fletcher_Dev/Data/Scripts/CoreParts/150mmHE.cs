...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef FA15CmShell => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "15cmShell", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "15 Cm Shell", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                AmmoRound = "15CmShrap", // AmmoRound field of the ammo to spawn.
                Fragments = 15, // Number of projectiles to spawn.
                Degrees = 30, // Cone in which to randomise direction of spawned projectiles.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                {
                    Modifier = 5.5f, // Multiplier for damage against shields.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxTrajectory = 2750f, // Max Distance the projectile or beam can Travel.
        ...
        private AmmoDef FA15CmShrap => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                ...
                Degrees = 25, // Cone in which to randomise direction of spawned projectiles.
                Reverse = false, // Spawn projectiles backward instead of forward.
                DropVelocity = false, // fragments will not inherit velocity from parent.
                Offset = 0f, // Offsets the fragment spawn by this amount, in meters (positive forward, negative for backwards).
            },
