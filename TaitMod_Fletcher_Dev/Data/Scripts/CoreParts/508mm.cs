...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition twin508 => new WeaponDefinition
        {
            ...
            {
                PartName = "20 Inch Twin", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 12, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
