...
# |  Mk3_RailgunElevator
# |  |  Mk3_RailgunAZ
# |  |  |  Mk3_RailgunElevation
# |  |  |  |  Mk3_RailgunCamera
# |  |  |  |  Mk3_RailgunBarrels

#Declarations of subparts and dummies in the model
using Elevator as SubPart("Mk3_RailgunElevator")
using CannonAZ as SubPart("Mk3_RailgunAZ") parent Elevator
using CannonEL as Subpart("Mk3_RailgunElevation") parent CannonAZ
using Barrel as Subpart("Mk3_RailgunBarrels") parent CannonEL
using Camera as Subpart("Mk3_RailgunCamera") parent CannonEL
using LeftDoor as Subpart("Mk3RailgunLeftDoor")
using RightDoor as Subpart("Mk3RailgunRightDoor")
using BackDoor as Subpart("Mk3RailgunBackDoor")
using FrontDoor as Subpart("Mk3RailgunFrontDoor")
