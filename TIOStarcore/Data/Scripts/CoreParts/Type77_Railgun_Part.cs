...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Type77_Railgun_Block => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Type77_Railgun_Block", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Type 77 Railgun Turret", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    DelayUntilFire = 80, // How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
            ...
            Animations = Type77_Railgun_AdvancedAnimation,
