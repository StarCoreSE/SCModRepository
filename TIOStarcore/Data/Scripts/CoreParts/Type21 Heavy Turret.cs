    ...
    partial class Parts {
        ...
        WeaponDefinition MK2_Battleship_Block => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Type21_Artillery", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "MK2EL", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "MKAZ", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "MK2EL",// Your Elevating Subpart, that bit that moves up
            ...
            {
                PartName = "Type 21 Heavy Turret", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    ElevateRate = 0.0035f, // Max traversal speed of elevation subpart in radians per tick.
                    MinAzimuth = -180,
                    MaxAzimuth = 180,
                    MinElevation = -10,
                    MaxElevation = 70,
                    ...
                    IdlePower = 36f, // Constant base power draw in MW.
