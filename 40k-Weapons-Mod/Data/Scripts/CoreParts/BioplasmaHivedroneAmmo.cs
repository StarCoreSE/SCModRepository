...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef BioplasmaHivedrone_ammo_launch => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Bioplasma_Hivedrone_ammo_launch", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                AmmoRound = "Bioplasma_Hivedrone_ammo", // AmmoRound field of the ammo to spawn.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                Smarts = new SmartsDef
                {
                    ...
                    OffsetRatio = 1f, // The ratio to offset the random direction (0 to 1) 
                    OffsetTime = 300, // how often to offset degree, measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..)
            ...
            {
                ModelName = "\\Models\\Ammo\\BioplasmaHivedroneLaunch.mwm", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
        ...
        private AmmoDef BioplasmaHivedrone_ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Bioplasma_Hivedrone_ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "BioplasmaHivedrone_ammo_lunge", // AmmoRound field of the ammo to spawn.
                Fragments = 1, // Number of projectiles to spawn.
            ...
            {
                Patterns = new[] { // If enabled, set of multiple ammos to fire in order instead of the main ammo.
                    "BioplasmaHivedrone_ammo_plasma","BioplasmaHivedrone_ammo_plasma","BioplasmaHivedrone_ammo_plasma","BioplasmaHivedrone_ammo_plasma",
                    "BioplasmaHivedrone_ammo_plasma","BioplasmaHivedrone_ammo_plasma","BioplasmaHivedrone_ammo_plasma","BioplasmaHivedrone_ammo_plasma",
                    "BioplasmaHivedrone_ammo_plasma","BioplasmaHivedrone_ammo_plasma","BioplasmaHivedrone_ammo_plasma","BioplasmaHivedrone_ammo_plasma",
                    "BioplasmaHivedrone_ammo_plasma","BioplasmaHivedrone_ammo_plasma"
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    CustomSound = "Screech", // SubtypeID from your Audio SBC, not a filename
                    Shape = Diamond, // Round or Diamond shape.  Diamond is more performance friendly.
                },
            },
            Ewar = new EwarDef
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 14400, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). time begins at 0 and time must EXCEED this value to trigger "time > maxValue". Please have a value for this, It stops Bad things.
                ...
                Smarts = new SmartsDef
                {
                    ...
                    Inaccuracy = 120f, // 0 is perfect, hit accuracy will be a random num of meters between 0 and this value.
                    Aggressiveness = 15f, // controls how responsive tracking is.
                    MaxLateralThrust = 1f, // controls how sharp the trajectile may turn
                    NavAcceleration = 0.5, // helps influence how the projectile steers.
                    ...
                    OffsetRatio = 1f, // The ratio to offset the random direction (0 to 1) 
                    OffsetTime = 50, // how often to offset degree, measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..)
                    FocusOnly = true, // only target the constructs Ai's focus target
                    FocusEviction = false, // If FocusOnly and this to true will force smarts to lose target when there is no focus target
                },
                Mines = new MinesDef  // Note: This is being investigated. Please report to Github, any issues.
            ...
            AmmoGraphics = new GraphicDef
            {
                ModelName = "\\Models\\Ammo\\BioplasmaHivedrone.mwm", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
                VisualProbability = 1f, // %
                ShieldHitDraw = true,
                Particles = new AmmoParticleDef
                {
        ...
        private AmmoDef BioplasmaHivedrone_ammo_lunge => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "BioplasmaHivedrone_ammo_lunge", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 200000f, // Direct damage; one steel plate is worth 100.
            Mass = 4000f, // In kilograms; how much force the impact will apply to the target.
                    ...
                    Types = new[] // List of blocks to apply custom damage multipliers to.
{
        ...
        private AmmoDef BioplasmaHivedrone_ammo_plasma => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "BioplasmaHivedrone_ammo_plasma", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
                    ...
                    Types = new[] // List of blocks to apply custom damage multipliers to.
{
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 2f, //
                        Width = 1.2f, //
                        Color = Color(red: 0, green: 40, blue: 5f, alpha: 1f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "WeaponLaser", // Please always have this Line set, if this Section is enabled.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 10, // In Ticks. 1 = 1 Additional Tracer generated per motion, 33 is 33 lines drawn per projectile. Keep this number low.
                        Color = Color(red: 0, green: 40, blue: 5, alpha: 1),
                        Back = false,
                        CustomWidth = 1f,
                        UseWidthVariance = false,
                        UseColorFade = true,
            ...
            AmmoAudio = new AmmoAudioDef
            {
                TravelSound = "Bioplasma_Fire", // SubtypeID for your Sound File. Travel, is sound generated around your Projectile in flight
                HitSound = "Pyroacid_Impact",
                ShotSound = "",
                ShieldHitSound = "",
                PlayerHitSound = "",
                VoxelHitSound = "",
