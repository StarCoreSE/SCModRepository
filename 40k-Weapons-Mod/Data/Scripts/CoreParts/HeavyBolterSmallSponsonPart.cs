...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HeavyBolterSmallSponson => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "HeavyBolterSmallSponson", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                Threats = new[] {
                    Grids, Characters, // Types of threat to engage: Grids, Projectiles, Characters, Meteors, Neutrals, ScanRoid, ScanPlanet, ScanFriendlyCharacter, ScanFriendlyGrid, ScanEnemyCharacter, ScanEnemyGrid, ScanNeutralCharacter, ScanNeutralGrid, ScanUnOwnedGrid, ScanOwnersGrid
                },
                SubSystems = new[] {
            ...
            {
                PartName = "Heavy Bolter Sponson", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "BolterFire", // Audio for firing.
            ...
            Ammos = new[] {
                BoltRound,  // Must list all primary, shrapnel, and pattern ammos.
            },
