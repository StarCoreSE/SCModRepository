...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition NID_Bioplasma => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NID_Bioplasma", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "GatlingTurretBarrels", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "GatlingTurretBase1", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "GatlingTurretBarrels",// Your Elevating Subpart, that bit that moves up.
                ...
                Muzzles = new[] {
                    "Bioplasma_Muzzle_01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "Bioplasma_Muzzle_01", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "Bio-plasma Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Bioplasma_Fire", // Audio for firing.
            ...
            Ammos = new[] {
                Bioplasma_ammo, 
                Bioplasma_ammo_splash, // Must list all primary, shrapnel, and pattern ammos.
            },
