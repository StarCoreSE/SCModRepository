...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition NID_BioplasmaHivedrone => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NID_BioplasmaHivedrone", // Block Subtypeid. Your Cubeblocks contain this information
                        ...
                        IconName = "None" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },
            ...
            Targeting = new TargetingDef
            {
                ...
                MinimumDiameter = 3, // Minimum radius of threat to engage.
            ...
            {
                PartName = "Bio-plasma Hivedrone Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    ElevateRate = 01f, // Max traversal speed of elevation subpart in radians per tick.
                    MinAzimuth = -0,
                    MaxAzimuth = 0,
                    MinElevation = -0,
                    MaxElevation = 0,
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 10800, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "ExhaustSmokeReactor", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                BioplasmaHivedrone_ammo_launch, 
                BioplasmaHivedrone_ammo,
                BioplasmaHivedrone_ammo_plasma,
                BioplasmaHivedrone_ammo_lunge, // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = BioplasmaHivedroneLauncherAnimation,
