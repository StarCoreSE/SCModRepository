...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition NID_Hivedrone => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NID_HiveDrone", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Strangler Hivedrone Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                Hivedrone_ammo_launch, 
                Hivedrone_ammo,
                Hivedrone_ammo_half,
                Hivedrone_ammo_quarter,
                Hivedrone_ammo_eighth,
                Hivedrone_ammo_sixteenth,
                Hivedrone_ammo_lunge, // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = HivedroneLauncherAnimation,
