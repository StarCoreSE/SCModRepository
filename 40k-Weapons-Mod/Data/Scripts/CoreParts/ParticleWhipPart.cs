...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition ParticleWhip => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ParticleWhip", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "ParticleWhip", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "NerconFire", // Audio for firing.
            ...
            Ammos = new[] {
                ParticleWhipAmmo1, 
                ParticleWhipAmmo2, // Must list all primary, shrapnel, and pattern ammos.
            },
