...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition NID_HeavyPyroacid => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "NID_HeavyPyroacid", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "PyroAcidCannon_Barrels", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "PyroAcidCannon_Base", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "PyroAcidCannon_Barrels",// Your Elevating Subpart, that bit that moves up.
                ...
                Muzzles = new[] {
                    "muzzle_tyranid_01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "muzzle_tyranid_01", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "Pyro-acid Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RotateRate = 0.002f, // Max traversal speed of azimuth subpart in radians per tick (0.1 is approximately 360 degrees per second).
                    ElevateRate = 0.002f, // Max traversal speed of elevation subpart in radians per tick.
                    MinAzimuth = -10,
                    MaxAzimuth = 10,
                    MinElevation = -10,
                    MaxElevation = 10,
                ...
                {
                    RateOfFire = 50, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Pyroacid_Fire2", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "Blood_Tyranid", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                HeavyPyroacid_ammo, 
                HeavyPyroacid_guided_ammo,
                HeavyPyroacid_splash_ammo,
                HeavyPyroacid_splash2_ammo, // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = PyroacidAnimation,
