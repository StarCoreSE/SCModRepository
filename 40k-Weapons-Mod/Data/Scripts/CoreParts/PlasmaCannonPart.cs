...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition PlasmaCannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "PlasmaCannon", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Plasma Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    Cooldown = .70f, // Percentage of max heat to be under to start firing again after overheat; accepts 0 - 0.95
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "PlasmaCannonFire", // Audio for firing.
            ...
            Ammos = new[] {
                PlasmaCannonRound,  // Must list all primary, shrapnel, and pattern ammos.
            },
