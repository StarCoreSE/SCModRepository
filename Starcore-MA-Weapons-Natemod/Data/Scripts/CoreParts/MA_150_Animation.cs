...
//////// Tiger 30mm		
		private AnimationDef MA_Tiger_30_Animation => new AnimationDef
        {
			HeatingEmissiveParts = new[]
            {
                "barrel_30"
            ...
            AnimationSets = new[]
            {
                               ...
                               new RelMove
                                {
                                    ...
                                    LinearPoints = new[]
                                    {
                                        Transformation(0, 0, 0.03), //linear movement
                                    },
                                    Rotation = Transformation(0, 0, 0), //degrees
                                    RotAroundCenter = Transformation(0, 0, 0), //degrees
                                },
                ...
                new PartAnimationSetDef()
                {
                    SubpartId = Names("mag_30"),
                    BarrelId = "", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 0,
                    AnimationDelays = Delays(FiringDelay : 0, ReloadingDelay: 270, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0, StopFiringDelay: 0, StopTrackingDelay:0, InitDelay:0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(),
                    EventMoveSets = new Dictionary<PartAnimationSetDef.EventTriggers, RelMove[]>
                    {
                               ...
                               new RelMove
                                {
                                    ...
                                    LinearPoints = new[]
                                    {
                                        Transformation(0, 0, 0.16), //linear movement
                                    },
                                    Rotation = Transformation(0, 0, 0), //degrees
                                    RotAroundCenter = Transformation(0, 0, 0), //degrees
                                },
                               ...
                               new RelMove
                                {
                                    ...
                                    LinearPoints = new[]
                                    {
                                        Transformation(0, 0, -0.08), //linear movement
                                    },
                                    Rotation = Transformation(0, 0, 0), //degrees
                                    RotAroundCenter = Transformation(0, 0, 0), //degrees
                                },
