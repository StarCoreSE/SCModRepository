...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef MA_Laser_1 => new AmmoDef  //T1 red pulse gimbal, pdx. No missile daamge.
        {
           ...
           AreaOfDamage = new AreaOfDamageDef
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    {
                        Name = "", //ShipWelderArc
                        ////ShrinkByDistance = false, - this never did anything and frankly I'm happy it's dead
        ...
        private AmmoDef MA_Laser_1_PD => new AmmoDef  //T1 red pulse with missile damage
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f,
                        Width = 0.1f,
                        Color = Color(red: 20, green: 0, blue: 0, alpha: .9f),
                        VisualFadeStart = 45, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 60, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "WeaponLaser",
       ...
       private AmmoDef MA_Laser_2 => new AmmoDef  //T3 continuous amber gladius laser 960
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "MA_Laser_2", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
       ...
       private AmmoDef MA_Ion_1 => new AmmoDef  //gladius and EMP ion
        ...
        private AmmoDef MA_Laser_3 => new AmmoDef  //purple pulse low power for PDT
        {
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Grids = new GridSizeDef
                {
                    Large = 0f, // Multiplier for damage against large grids.
                    Small = 0f, // Multiplier for damage against small grids.
                },
                Armor = new ArmorDef
                {
                    Armor = -1f,
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Width = 0.25f,
                        Color = Color(red: 10, green: 1, blue: 0, alpha: .9f),
                        VisualFadeStart = 100, // Number of ticks the weapon has been firing before projectiles begin to fade their color
       ...
       private AmmoDef MA_Laser_T4 => new AmmoDef  //T4 continuous beam (using pattern to reduce partcles and decals, any damage tweaks do to both)
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "MA_Laser_T4", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = .294f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
...
//                },
       ...
       private AmmoDef MA_Laser_T4_Particles => new AmmoDef  //T4 continuous beam
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
